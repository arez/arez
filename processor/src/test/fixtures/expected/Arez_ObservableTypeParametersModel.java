...
public final class Arez_ObservableTypeParametersModel<T extends Integer> extends ObservableTypeParametersModel<T> implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  @Override
  public final void setTime(final T time) {
    if ( Arez.shouldCheckApiInvariants() ) {
