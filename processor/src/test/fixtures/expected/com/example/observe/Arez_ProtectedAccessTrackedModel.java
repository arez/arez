...
final class Arez_ProtectedAccessTrackedModel extends ProtectedAccessTrackedModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_ProtectedAccessTrackedModel() {
    super();
