...
final class Suppressed1ProtectedAccessPostInverseAddModel_Arez_Element extends Suppressed1ProtectedAccessPostInverseAddModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  @Nullable
  private Suppressed1ProtectedAccessPostInverseAddModel $$arezr$$_other;

  Suppressed1ProtectedAccessPostInverseAddModel_Arez_Element() {
    super();
  ...
  public void verify() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      Guards.apiInvariant( () -> this == $$arezi$$_locator().findById( Suppressed1ProtectedAccessPostInverseAddModel.Element.class, $$arezi$$_id() ), () -> "Attempted to lookup self in Locator with type Suppressed1ProtectedAccessPostInverseAddModel.Element and id '" + $$arezi$$_id() + "' but unable to locate self. Actual value: " + $$arezi$$_locator().findById( Suppressed1ProtectedAccessPostInverseAddModel.Element.class, $$arezi$$_id() ) );
      final int $$arezv$$_otherId = this.getOtherId();
      final Suppressed1ProtectedAccessPostInverseAddModel $$arezv$$_other = this.$$arezi$$_locator().findById( Suppressed1ProtectedAccessPostInverseAddModel.class, $$arezv$$_otherId );
      Guards.apiInvariant( () -> null != $$arezv$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.post_inverse_add.Suppressed1ProtectedAccessPostInverseAddModel and id = " + getOtherId() );
    }
  }

  @Override
  Suppressed1ProtectedAccessPostInverseAddModel getOther() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  private void $$arezi$$_link_other() {
    ...
    this.$$arezr$$_other = this.$$arezi$$_locator().findById( Suppressed1ProtectedAccessPostInverseAddModel.class, id );
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.post_inverse_add.Suppressed1ProtectedAccessPostInverseAddModel and id = " + getOtherId() );
    }
    ( (Arez_Suppressed1ProtectedAccessPostInverseAddModel) this.$$arezr$$_other ).$$arezir$$_elements_add( this );
  }

  void $$arezi$$_delink_other() {
    if ( null != $$arezr$$_other && Disposable.isNotDisposed( $$arezr$$_other ) ) {
      ( (Arez_Suppressed1ProtectedAccessPostInverseAddModel) this.$$arezr$$_other ).$$arezir$$_elements_remove( this );
    }
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Suppressed1ProtectedAccessPostInverseAddModel_Arez_Element ) {
        final Suppressed1ProtectedAccessPostInverseAddModel_Arez_Element that = (Suppressed1ProtectedAccessPostInverseAddModel_Arez_Element) o;
