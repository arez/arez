...
final class Arez_Suppressed2ProtectedAccessPostInverseAddModel extends Suppressed2ProtectedAccessPostInverseAddModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  @Nonnull
  private final ObservableValue<Collection<Suppressed2ProtectedAccessPostInverseAddModel.Element>> $$arez$$_elements;

  private Collection<Suppressed2ProtectedAccessPostInverseAddModel.Element> $$arezd$$_elements;

  private Collection<Suppressed2ProtectedAccessPostInverseAddModel.Element> $$arezd$$_$$cache$$_elements;

  Arez_Suppressed2ProtectedAccessPostInverseAddModel() {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ++$$arezi$$_nextId;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "Suppressed2ProtectedAccessPostInverseAddModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "Suppressed2ProtectedAccessPostInverseAddModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  final Locator $$arezi$$_locator() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named '$$arezi$$_locator' invoked on uninitialized component of type 'Suppressed2ProtectedAccessPostInverseAddModel'" );
    }
  ...
  private void $$arezi$$_preDispose() {
    for ( final Suppressed2ProtectedAccessPostInverseAddModel.Element other : new ArrayList<>( $$arezd$$_elements ) ) {
      ( (Suppressed2ProtectedAccessPostInverseAddModel_Arez_Element) other ).$$arezi$$_delink_other();
    }
  }
  ...
  @Override
  final Collection<Suppressed2ProtectedAccessPostInverseAddModel.Element> getElements() {
    if ( Arez.shouldCheckApiInvariants() ) {
    ...
    if ( Arez.areCollectionsPropertiesUnmodifiable() ) {
      final Collection<Suppressed2ProtectedAccessPostInverseAddModel.Element> $$ar$$_result = this.$$arezd$$_elements;
  ...
  void $$arezir$$_elements_add(
      @Nonnull final Suppressed2ProtectedAccessPostInverseAddModel.Element element) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_Suppressed2ProtectedAccessPostInverseAddModel ) {
        final Arez_Suppressed2ProtectedAccessPostInverseAddModel that = (Arez_Suppressed2ProtectedAccessPostInverseAddModel) o;
