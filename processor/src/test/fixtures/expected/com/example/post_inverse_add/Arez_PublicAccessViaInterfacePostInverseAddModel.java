...
final class Arez_PublicAccessViaInterfacePostInverseAddModel extends PublicAccessViaInterfacePostInverseAddModel implements Disposable,
  ...
  @Nonnull
  private final ObservableValue<Collection<PublicAccessViaInterfacePostInverseAddModel.Element>> $$arez$$_elements;
  ...
  Arez_PublicAccessViaInterfacePostInverseAddModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "com_example_post_inverse_add_PublicAccessViaInterfacePostInverseAddModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "com_example_post_inverse_add_PublicAccessViaInterfacePostInverseAddModel", $$arezv$$_id, $$arezv$$_name, this::$$arezi$$_nativeComponentPreDispose ) : null;
  ...
  private Locator $$arezi$$_locator() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named '$$arezi$$_locator' invoked on uninitialized component of type 'com_example_post_inverse_add_PublicAccessViaInterfacePostInverseAddModel'" );
    }
  ...
  public Integer getArezId() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'getArezId' invoked on uninitialized component of type 'com_example_post_inverse_add_PublicAccessViaInterfacePostInverseAddModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  private void $$arezi$$_preDispose() {
    for ( final PublicAccessViaInterfacePostInverseAddModel.Element other : new ArrayList<>( $$arezd$$_elements ) ) {
  ...
  public void addOnDisposeListener(@Nonnull final Object key, @Nonnull final SafeProcedure action,
    ...
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'addOnDisposeListener' invoked on uninitialized component of type 'com_example_post_inverse_add_PublicAccessViaInterfacePostInverseAddModel'" );
    }
  ...
  public void removeOnDisposeListener(@Nonnull final Object key, final boolean errorIfMissing) {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'removeOnDisposeListener' invoked on uninitialized component of type 'com_example_post_inverse_add_PublicAccessViaInterfacePostInverseAddModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public boolean isDisposed() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'isDisposed' invoked on uninitialized component of type 'com_example_post_inverse_add_PublicAccessViaInterfacePostInverseAddModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void dispose() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'dispose' invoked on uninitialized component of type 'com_example_post_inverse_add_PublicAccessViaInterfacePostInverseAddModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void verify() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'verify' invoked on uninitialized component of type 'com_example_post_inverse_add_PublicAccessViaInterfacePostInverseAddModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      Guards.apiInvariant( () -> this == $$arezi$$_locator().findById( PublicAccessViaInterfacePostInverseAddModel.class, $$arezi$$_id() ), () -> "Attempted to lookup self in Locator with type PublicAccessViaInterfacePostInverseAddModel and id '" + $$arezi$$_id() + "' but unable to locate self. Actual value: " + $$arezi$$_locator().findById( PublicAccessViaInterfacePostInverseAddModel.class, $$arezi$$_id() ) );
      for( final PublicAccessViaInterfacePostInverseAddModel.Element element : this.$$arezd$$_elements ) {
        if ( Arez.shouldCheckApiInvariants() ) {
  ...
  Collection<PublicAccessViaInterfacePostInverseAddModel.Element> getElements() {
    ...
    if ( Arez.areCollectionsPropertiesUnmodifiable() ) {
      final Collection<PublicAccessViaInterfacePostInverseAddModel.Element> $$ar$$_result = this.$$arezd$$_elements;
