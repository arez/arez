...
final class Arez_PublicAccessViaInterfacePostInverseAddModel extends PublicAccessViaInterfacePostInverseAddModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  ...
  Arez_PublicAccessViaInterfacePostInverseAddModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "PublicAccessViaInterfacePostInverseAddModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  final Collection<PublicAccessViaInterfacePostInverseAddModel.Element> getElements() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_PublicAccessViaInterfacePostInverseAddModel ) {
        final Arez_PublicAccessViaInterfacePostInverseAddModel that = (Arez_PublicAccessViaInterfacePostInverseAddModel) o;
