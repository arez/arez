...
final class Arez_MultiPostInverseAddModel extends MultiPostInverseAddModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  ...
  Arez_MultiPostInverseAddModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "MultiPostInverseAddModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  final Collection<MultiPostInverseAddModel.Element> getElements() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_MultiPostInverseAddModel ) {
        final Arez_MultiPostInverseAddModel that = (Arez_MultiPostInverseAddModel) o;
