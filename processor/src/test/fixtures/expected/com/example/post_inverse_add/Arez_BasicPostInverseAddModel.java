...
final class Arez_BasicPostInverseAddModel extends BasicPostInverseAddModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  ...
  Arez_BasicPostInverseAddModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicPostInverseAddModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  final Collection<BasicPostInverseAddModel.Element> getElements() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_BasicPostInverseAddModel ) {
        final Arez_BasicPostInverseAddModel that = (Arez_BasicPostInverseAddModel) o;
