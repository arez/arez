...
final class Arez_WriteOutsideTransactionFromEnabledDefaultObservableModel extends WriteOutsideTransactionFromEnabledDefaultObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_WriteOutsideTransactionFromEnabledDefaultObservableModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "WriteOutsideTransactionFromEnabledDefaultObservableModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
