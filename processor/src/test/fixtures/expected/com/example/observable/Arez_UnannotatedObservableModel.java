...
final class Arez_UnannotatedObservableModel extends UnannotatedObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_UnannotatedObservableModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "UnannotatedObservableModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  final void setTime(final long value) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_UnannotatedObservableModel ) {
        final Arez_UnannotatedObservableModel that = (Arez_UnannotatedObservableModel) o;
