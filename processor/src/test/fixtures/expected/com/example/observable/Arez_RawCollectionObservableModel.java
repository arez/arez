...
final class Arez_RawCollectionObservableModel extends RawCollectionObservableModel implements Disposable, DisposeNotifier {
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_RawCollectionObservableModel ) {
        final Arez_RawCollectionObservableModel that = (Arez_RawCollectionObservableModel) o;
