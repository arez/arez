...
final class Arez_AbstractPrimitiveObservablesWithInitializerModel extends AbstractPrimitiveObservablesWithInitializerModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_AbstractPrimitiveObservablesWithInitializerModel(final long time) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "AbstractPrimitiveObservablesWithInitializerModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
