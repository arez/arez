...
final class Arez_ReadOutsideTransactionEnabledObservableModel extends ReadOutsideTransactionEnabledObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_ReadOutsideTransactionEnabledObservableModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ReadOutsideTransactionEnabledObservableModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
