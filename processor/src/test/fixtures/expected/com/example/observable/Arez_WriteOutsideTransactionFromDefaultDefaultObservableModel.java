...
final class Arez_WriteOutsideTransactionFromDefaultDefaultObservableModel extends WriteOutsideTransactionFromDefaultDefaultObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_WriteOutsideTransactionFromDefaultDefaultObservableModel ) {
        final Arez_WriteOutsideTransactionFromDefaultDefaultObservableModel that = (Arez_WriteOutsideTransactionFromDefaultDefaultObservableModel) o;
