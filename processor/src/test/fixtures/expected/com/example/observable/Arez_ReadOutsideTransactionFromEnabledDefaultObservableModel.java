...
final class Arez_ReadOutsideTransactionFromEnabledDefaultObservableModel extends ReadOutsideTransactionFromEnabledDefaultObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_ReadOutsideTransactionFromEnabledDefaultObservableModel ) {
        final Arez_ReadOutsideTransactionFromEnabledDefaultObservableModel that = (Arez_ReadOutsideTransactionFromEnabledDefaultObservableModel) o;
