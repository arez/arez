...
final class Arez_ReadOutsideTransactionFromEnabledDefaultObservableModel extends ReadOutsideTransactionFromEnabledDefaultObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_ReadOutsideTransactionFromEnabledDefaultObservableModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ReadOutsideTransactionFromEnabledDefaultObservableModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
