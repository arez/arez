...
final class Arez_WriteOutsideTransactionFromDisabledDefaultObservableModel extends WriteOutsideTransactionFromDisabledDefaultObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_WriteOutsideTransactionFromDisabledDefaultObservableModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "WriteOutsideTransactionFromDisabledDefaultObservableModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
