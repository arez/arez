...
final class Arez_ReadOutsideTransactionFromDefaultDefaultObservableModel extends ReadOutsideTransactionFromDefaultDefaultObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_ReadOutsideTransactionFromDefaultDefaultObservableModel ) {
        final Arez_ReadOutsideTransactionFromDefaultDefaultObservableModel that = (Arez_ReadOutsideTransactionFromDefaultDefaultObservableModel) o;
