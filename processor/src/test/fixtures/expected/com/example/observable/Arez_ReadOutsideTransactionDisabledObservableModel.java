...
final class Arez_ReadOutsideTransactionDisabledObservableModel extends ReadOutsideTransactionDisabledObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_ReadOutsideTransactionDisabledObservableModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ReadOutsideTransactionDisabledObservableModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
