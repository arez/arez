...
public final class Arez_PublicAccessViaInterfaceComponentIdRefModel extends PublicAccessViaInterfaceComponentIdRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  public Arez_PublicAccessViaInterfaceComponentIdRefModel() {
    super();
