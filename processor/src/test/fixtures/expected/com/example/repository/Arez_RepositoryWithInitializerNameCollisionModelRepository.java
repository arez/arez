...
final class Arez_RepositoryWithInitializerNameCollisionModelRepository extends RepositoryWithInitializerNameCollisionModelRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithInitializerNameCollisionModelRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithInitializerNameCollisionModelRepository." + $$arezv$$_id : null;
  ...
  RepositoryWithInitializerNameCollisionModel create(final int time, final long $$arezip$$_time) {
    ...
    return this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".create_time" : null, () -> super.create( time, $$arezip$$_time ), ActionFlags.READ_WRITE | ActionFlags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { time, $$arezip$$_time } : null );
  }
