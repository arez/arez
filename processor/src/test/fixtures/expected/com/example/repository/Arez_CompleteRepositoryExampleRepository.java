...
final class Arez_CompleteRepositoryExampleRepository extends CompleteRepositoryExampleRepository implements Disposable, Identifiable<Integer> {
  ...
  @Override
  @Nonnull
  public final Stream<CompleteRepositoryExample> entities() {
  ...
  @Override
  public final void destroy(@Nonnull final CompleteRepositoryExample entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  @Nonnull
  public final CompleteRepositoryExample create(@Nonnull final String packageName,
