...
final class Arez_RepositoryWithMultipleInitializersModelRepository extends RepositoryWithMultipleInitializersModelRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithMultipleInitializersModelRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithMultipleInitializersModelRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  public final Stream<RepositoryWithMultipleInitializersModel> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<RepositoryWithMultipleInitializersModel>> getEntitiesObservableValue(
      ) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  final RepositoryWithMultipleInitializersModel create(final long time, final long value) {
    ...
    return this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".create" : null, () -> super.create( time, value ), ActionFlags.READ_WRITE | ActionFlags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { time, value } : null );
  }
