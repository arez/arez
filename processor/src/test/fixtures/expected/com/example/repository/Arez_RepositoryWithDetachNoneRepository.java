...
final class Arez_RepositoryWithDetachNoneRepository extends RepositoryWithDetachNoneRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithDetachNoneRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithDetachNoneRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  public final Stream<RepositoryWithDetachNone> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<RepositoryWithDetachNone>> getEntitiesObservableValue() {
    if ( Arez.shouldCheckApiInvariants() ) {
