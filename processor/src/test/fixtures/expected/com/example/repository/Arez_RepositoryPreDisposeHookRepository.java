...
final class Arez_RepositoryPreDisposeHookRepository extends RepositoryPreDisposeHookRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryPreDisposeHookRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryPreDisposeHookRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  public final Stream<RepositoryPreDisposeHook> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<RepositoryPreDisposeHook>> getEntitiesObservableValue() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  protected final void destroy(@Nonnull final RepositoryPreDisposeHook entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  @Nonnull
  final RepositoryPreDisposeHook create(@Nonnull final String name) {
    if ( Arez.shouldCheckApiInvariants() ) {
