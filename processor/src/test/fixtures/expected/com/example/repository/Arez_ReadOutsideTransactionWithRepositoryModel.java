...
final class Arez_ReadOutsideTransactionWithRepositoryModel extends ReadOutsideTransactionWithRepositoryModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeNotifier {
  ...
  Arez_ReadOutsideTransactionWithRepositoryModel(@Nonnull final String name) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "ReadOutsideTransactionWithRepositoryModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ReadOutsideTransactionWithRepositoryModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public String getName() {
    ...
    this.$$arez$$_name.reportObservedIfTrackingTransactionActive();
  ...
  public boolean equals(final Object o) {
    if ( o instanceof Arez_ReadOutsideTransactionWithRepositoryModel ) {
      final Arez_ReadOutsideTransactionWithRepositoryModel that = (Arez_ReadOutsideTransactionWithRepositoryModel) o;
