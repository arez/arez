...
final class Arez_RepositoryWithProtectedConstructorRepository extends RepositoryWithProtectedConstructorRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithProtectedConstructorRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithProtectedConstructorRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<RepositoryWithProtectedConstructor>> getEntitiesObservableValue(
      ) {
    if ( Arez.shouldCheckApiInvariants() ) {
