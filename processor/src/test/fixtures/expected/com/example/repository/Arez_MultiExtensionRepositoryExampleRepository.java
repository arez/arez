...
final class Arez_MultiExtensionRepositoryExampleRepository extends MultiExtensionRepositoryExampleRepository implements Disposable, Identifiable<Integer> {
  ...
  @Nonnull
  private final ObservableValue<Stream<MultiExtensionRepositoryExample>> $$arez$$_entities;

  @Inject
  Arez_MultiExtensionRepositoryExampleRepository() {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ( Arez.areNamesEnabled() || Arez.areRegistriesEnabled() || Arez.areNativeComponentsEnabled() ) ? ++$$arezi$$_nextId : 0;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "MultiExtensionRepositoryExampleRepository." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "MultiExtensionRepositoryExampleRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
  ...
  @Override
  @Nonnull
  public final Stream<MultiExtensionRepositoryExample> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<MultiExtensionRepositoryExample>> getEntitiesObservableValue(
      ) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_MultiExtensionRepositoryExampleRepository ) {
        final Arez_MultiExtensionRepositoryExampleRepository that = (Arez_MultiExtensionRepositoryExampleRepository) o;
