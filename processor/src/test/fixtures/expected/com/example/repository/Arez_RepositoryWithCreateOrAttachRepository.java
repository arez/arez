...
final class Arez_RepositoryWithCreateOrAttachRepository extends RepositoryWithCreateOrAttachRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithCreateOrAttachRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithCreateOrAttachRepository." + $$arezv$$_id : null;
  ...
  protected void attach(@Nonnull final RepositoryWithCreateOrAttach entity) {
    ...
    this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".attach" : null, () -> super.attach( entity ), ActionFlags.READ_WRITE | ActionFlags.VERIFY_ACTION_REQUIRED, null );
  }
