...
final class Arez_RepositoryWithDetachOnlyRepository extends RepositoryWithDetachOnlyRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithDetachOnlyRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithDetachOnlyRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  public final Stream<RepositoryWithDetachOnly> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<RepositoryWithDetachOnly>> getEntitiesObservableValue() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  protected final void detach(@Nonnull final RepositoryWithDetachOnly entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
    ...
    this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".detach" : null, () -> super.detach( entity ), ActionFlags.READ_WRITE | ActionFlags.VERIFY_ACTION_REQUIRED, null );
  }

  @Override
  @Nonnull
  final RepositoryWithDetachOnly create(@Nonnull final String name) {
    if ( Arez.shouldCheckApiInvariants() ) {
