...
final class Arez_DaggerEnabledRepositoryRepository extends DaggerEnabledRepositoryRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_DaggerEnabledRepositoryRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "DaggerEnabledRepositoryRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  public final Stream<DaggerEnabledRepository> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<DaggerEnabledRepository>> getEntitiesObservableValue() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  public final void destroy(@Nonnull final DaggerEnabledRepository entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  @Nonnull
  public final DaggerEnabledRepository create(@Nonnull final String name) {
    if ( Arez.shouldCheckApiInvariants() ) {
