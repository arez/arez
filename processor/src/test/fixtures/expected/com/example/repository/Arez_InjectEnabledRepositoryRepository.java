...
final class Arez_InjectEnabledRepositoryRepository extends InjectEnabledRepositoryRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_InjectEnabledRepositoryRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "InjectEnabledRepositoryRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  public final Stream<InjectEnabledRepository> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<InjectEnabledRepository>> getEntitiesObservableValue() {
    if ( Arez.shouldCheckApiInvariants() ) {
