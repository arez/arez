...
final class Arez_RepositoryWithExplicitIdRepository extends RepositoryWithExplicitIdRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithExplicitIdRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithExplicitIdRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  public final Stream<RepositoryWithExplicitId> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<RepositoryWithExplicitId>> getEntitiesObservableValue() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  protected final void destroy(@Nonnull final RepositoryWithExplicitId entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  @Nonnull
  final RepositoryWithExplicitId create(@Nonnull final String packageName,
