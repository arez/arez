...
final class Arez_RepositoryWithInitializerModelRepository extends RepositoryWithInitializerModelRepository implements Disposable, Identifiable<Integer> {
  ...
  @Override
  @Nonnull
  public final Stream<RepositoryWithInitializerModel> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<RepositoryWithInitializerModel>> getEntitiesObservableValue(
      ) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  protected final void destroy(@Nonnull final RepositoryWithInitializerModel entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  @Nonnull
  final RepositoryWithInitializerModel create(final long time) {
    if ( Arez.shouldCheckApiInvariants() ) {
    ...
    return this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".create" : null, () -> super.create( time ), ActionFlags.READ_WRITE | ActionFlags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { time } : null );
  }
