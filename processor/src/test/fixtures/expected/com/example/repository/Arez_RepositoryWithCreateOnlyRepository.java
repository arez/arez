...
final class Arez_RepositoryWithCreateOnlyRepository extends RepositoryWithCreateOnlyRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithCreateOnlyRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithCreateOnlyRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<RepositoryWithCreateOnly>> getEntitiesObservableValue() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  protected final void destroy(@Nonnull final RepositoryWithCreateOnly entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  @Nonnull
  final RepositoryWithCreateOnly create(@Nonnull final String name) {
    if ( Arez.shouldCheckApiInvariants() ) {
