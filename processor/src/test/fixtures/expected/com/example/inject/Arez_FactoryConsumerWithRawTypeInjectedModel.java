...
@Singleton
public final class Arez_FactoryConsumerWithRawTypeInjectedModel extends FactoryConsumerWithRawTypeInjectedModel implements Disposable, Identifiable<Integer> {
  ...
  private Arez_FactoryConsumerWithRawTypeInjectedModel(final int count, final Callable action) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "FactoryConsumerWithRawTypeInjectedModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "FactoryConsumerWithRawTypeInjectedModel", $$arezv$$_id, $$arezv$$_name ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_FactoryConsumerWithRawTypeInjectedModel ) {
        final Arez_FactoryConsumerWithRawTypeInjectedModel that = (Arez_FactoryConsumerWithRawTypeInjectedModel) o;
  ...
  public static final class Factory {
    ...
    @Nonnull
    public final Arez_FactoryConsumerWithRawTypeInjectedModel create(final int count) {
      return new Arez_FactoryConsumerWithRawTypeInjectedModel( count, action );
    }
  }
}
