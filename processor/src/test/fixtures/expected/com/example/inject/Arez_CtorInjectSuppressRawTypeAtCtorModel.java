...
@Singleton
final class Arez_CtorInjectSuppressRawTypeAtCtorModel extends CtorInjectSuppressRawTypeAtCtorModel implements Disposable, Identifiable<Integer> {
  ...
  Arez_CtorInjectSuppressRawTypeAtCtorModel(@Nonnull final Callable action) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "CtorInjectSuppressRawTypeAtCtorModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "CtorInjectSuppressRawTypeAtCtorModel", $$arezv$$_id, $$arezv$$_name ) : null;
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_CtorInjectSuppressRawTypeAtCtorModel ) {
        final Arez_CtorInjectSuppressRawTypeAtCtorModel that = (Arez_CtorInjectSuppressRawTypeAtCtorModel) o;
