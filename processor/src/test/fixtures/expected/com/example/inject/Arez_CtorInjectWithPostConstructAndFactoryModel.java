...
@Singleton
public final class Arez_CtorInjectWithPostConstructAndFactoryModel extends CtorInjectWithPostConstructAndFactoryModel implements Disposable, Identifiable<Integer> {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  private Arez_CtorInjectWithPostConstructAndFactoryModel(@Nonnull final Runnable action,
      final int count) {
    super(action,count);
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_CtorInjectWithPostConstructAndFactoryModel ) {
        final Arez_CtorInjectWithPostConstructAndFactoryModel that = (Arez_CtorInjectWithPostConstructAndFactoryModel) o;
  ...
  public static final class Factory {
    ...
    @Nonnull
    public final Arez_CtorInjectWithPostConstructAndFactoryModel create(final int count) {
      return new Arez_CtorInjectWithPostConstructAndFactoryModel( action, count );
    }
  }
}
