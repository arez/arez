...
@Singleton
public final class Arez_FactoryConsumer1Model extends FactoryConsumer1Model implements Disposable, Identifiable<Integer> {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  private Arez_FactoryConsumer1Model(final int count, @Nonnull final Enhancer $$arezi$$_enhancer) {
    super(count);
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ( Arez.areRegistriesEnabled() || Arez.areNativeComponentsEnabled() ) ? ++$$arezi$$_nextId : 0;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "FactoryConsumer1Model" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "FactoryConsumer1Model", $$arezv$$_id, $$arezv$$_name ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_FactoryConsumer1Model ) {
        final Arez_FactoryConsumer1Model that = (Arez_FactoryConsumer1Model) o;
  ...
  public static final class Factory {
    ...
    @Nonnull
    public final Arez_FactoryConsumer1Model create(final int count) {
      return new Arez_FactoryConsumer1Model( count, $$arezi$$_enhancer );
    }
  }

  interface Enhancer {
    void enhance(Arez_FactoryConsumer1Model component);
  }
}
