...
@Singleton
public final class Arez_FactoryConsumer8Model extends FactoryConsumer8Model implements Disposable, Identifiable<Integer> {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  private Arez_FactoryConsumer8Model(final int count,
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "FactoryConsumer8Model" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "FactoryConsumer8Model", $$arezv$$_id, $$arezv$$_name ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_FactoryConsumer8Model ) {
        final Arez_FactoryConsumer8Model that = (Arez_FactoryConsumer8Model) o;
  ...
  public static final class Factory {
    ...
    @Nonnull
    public final Arez_FactoryConsumer8Model create(final int count) {
      return new Arez_FactoryConsumer8Model( count, action );
    }
  }
}
