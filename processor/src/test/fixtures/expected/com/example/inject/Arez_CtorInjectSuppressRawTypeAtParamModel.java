...
@Singleton
final class Arez_CtorInjectSuppressRawTypeAtParamModel extends CtorInjectSuppressRawTypeAtParamModel implements Disposable, Identifiable<Integer> {
  ...
  Arez_CtorInjectSuppressRawTypeAtParamModel(@Nonnull final Callable action) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "CtorInjectSuppressRawTypeAtParamModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "CtorInjectSuppressRawTypeAtParamModel", $$arezv$$_id, $$arezv$$_name ) : null;
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_CtorInjectSuppressRawTypeAtParamModel ) {
        final Arez_CtorInjectSuppressRawTypeAtParamModel that = (Arez_CtorInjectSuppressRawTypeAtParamModel) o;
