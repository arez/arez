...
final class Arez_ProtectedAccessFromBaseObservableValueRefModel extends ProtectedAccessFromBaseObservableValueRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_ProtectedAccessFromBaseObservableValueRefModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ProtectedAccessFromBaseObservableValueRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_ProtectedAccessFromBaseObservableValueRefModel ) {
        final Arez_ProtectedAccessFromBaseObservableValueRefModel that = (Arez_ProtectedAccessFromBaseObservableValueRefModel) o;
