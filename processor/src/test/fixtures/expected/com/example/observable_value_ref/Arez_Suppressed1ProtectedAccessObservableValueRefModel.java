...
final class Arez_Suppressed1ProtectedAccessObservableValueRefModel extends Suppressed1ProtectedAccessObservableValueRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_Suppressed1ProtectedAccessObservableValueRefModel() {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ( Arez.areNamesEnabled() || Arez.areRegistriesEnabled() || Arez.areNativeComponentsEnabled() ) ? ++$$arezi$$_nextId : 0;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "Suppressed1ProtectedAccessObservableValueRefModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "Suppressed1ProtectedAccessObservableValueRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Long> getTimeObservableValue() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_Suppressed1ProtectedAccessObservableValueRefModel ) {
        final Arez_Suppressed1ProtectedAccessObservableValueRefModel that = (Arez_Suppressed1ProtectedAccessObservableValueRefModel) o;
