...
public final class Arez_RawComputableValueRefModel extends RawComputableValueRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public Arez_RawComputableValueRefModel() {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ( Arez.areNamesEnabled() || Arez.areRegistriesEnabled() || Arez.areNativeComponentsEnabled() ) ? ++$$arezi$$_nextId : 0;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RawComputableValueRefModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RawComputableValueRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_RawComputableValueRefModel ) {
        final Arez_RawComputableValueRefModel that = (Arez_RawComputableValueRefModel) o;
