...
public final class Arez_PublicAccessViaInterfaceComputableValueRefModel extends PublicAccessViaInterfaceComputableValueRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public Arez_PublicAccessViaInterfaceComputableValueRefModel() {
    super();
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "PublicAccessViaInterfaceComputableValueRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_PublicAccessViaInterfaceComputableValueRefModel ) {
        final Arez_PublicAccessViaInterfaceComputableValueRefModel that = (Arez_PublicAccessViaInterfaceComputableValueRefModel) o;
