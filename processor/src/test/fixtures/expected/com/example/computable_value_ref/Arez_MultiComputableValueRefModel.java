...
final class Arez_MultiComputableValueRefModel extends MultiComputableValueRefModel implements Disposable, DisposeNotifier {
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_MultiComputableValueRefModel ) {
        final Arez_MultiComputableValueRefModel that = (Arez_MultiComputableValueRefModel) o;
