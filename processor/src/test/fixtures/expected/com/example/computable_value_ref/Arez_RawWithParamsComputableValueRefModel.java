...
public final class Arez_RawWithParamsComputableValueRefModel extends RawWithParamsComputableValueRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public Arez_RawWithParamsComputableValueRefModel() {
    super();
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RawWithParamsComputableValueRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_RawWithParamsComputableValueRefModel ) {
        final Arez_RawWithParamsComputableValueRefModel that = (Arez_RawWithParamsComputableValueRefModel) o;
