...
public final class Arez_PackageAccessComputableValueRefModel extends PackageAccessComputableValueRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public Arez_PackageAccessComputableValueRefModel() {
    super();
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "PackageAccessComputableValueRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_PackageAccessComputableValueRefModel ) {
        final Arez_PackageAccessComputableValueRefModel that = (Arez_PackageAccessComputableValueRefModel) o;
