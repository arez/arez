...
final class Arez_ZeroOrOneMultiplicityInverseModel extends ZeroOrOneMultiplicityInverseModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  ...
  Arez_ZeroOrOneMultiplicityInverseModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ZeroOrOneMultiplicityInverseModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
