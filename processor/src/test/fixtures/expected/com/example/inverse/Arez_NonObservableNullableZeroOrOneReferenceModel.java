...
final class Arez_NonObservableNullableZeroOrOneReferenceModel extends NonObservableNullableZeroOrOneReferenceModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  ...
  Arez_NonObservableNullableZeroOrOneReferenceModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "NonObservableNullableZeroOrOneReferenceModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
