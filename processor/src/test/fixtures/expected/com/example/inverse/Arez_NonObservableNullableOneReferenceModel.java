...
final class Arez_NonObservableNullableOneReferenceModel extends NonObservableNullableOneReferenceModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  ...
  Arez_NonObservableNullableOneReferenceModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "NonObservableNullableOneReferenceModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
