...
final class Arez_BasicOnDepsChangeModel extends BasicOnDepsChangeModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_BasicOnDepsChangeModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicOnDepsChangeModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
