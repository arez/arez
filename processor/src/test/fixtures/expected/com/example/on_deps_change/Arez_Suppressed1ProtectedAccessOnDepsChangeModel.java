...
final class Arez_Suppressed1ProtectedAccessOnDepsChangeModel extends Suppressed1ProtectedAccessOnDepsChangeModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_Suppressed1ProtectedAccessOnDepsChangeModel() {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ( Arez.areNamesEnabled() || Arez.areRegistriesEnabled() || Arez.areNativeComponentsEnabled() ) ? ++$$arezi$$_nextId : 0;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "Suppressed1ProtectedAccessOnDepsChangeModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "Suppressed1ProtectedAccessOnDepsChangeModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_Suppressed1ProtectedAccessOnDepsChangeModel ) {
        final Arez_Suppressed1ProtectedAccessOnDepsChangeModel that = (Arez_Suppressed1ProtectedAccessOnDepsChangeModel) o;
