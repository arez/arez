...
final class Arez_PackageAccessOnDepsChangeModel extends PackageAccessOnDepsChangeModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_PackageAccessOnDepsChangeModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "PackageAccessOnDepsChangeModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
