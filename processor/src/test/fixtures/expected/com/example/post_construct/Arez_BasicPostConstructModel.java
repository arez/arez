...
final class Arez_BasicPostConstructModel extends BasicPostConstructModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_BasicPostConstructModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicPostConstructModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
