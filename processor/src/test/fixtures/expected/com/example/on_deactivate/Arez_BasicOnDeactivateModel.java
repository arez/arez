...
final class Arez_BasicOnDeactivateModel extends BasicOnDeactivateModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_BasicOnDeactivateModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicOnDeactivateModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
