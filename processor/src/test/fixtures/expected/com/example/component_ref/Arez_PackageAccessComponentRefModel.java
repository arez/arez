...
final class Arez_PackageAccessComponentRefModel extends PackageAccessComponentRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_PackageAccessComponentRefModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "PackageAccessComponentRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
