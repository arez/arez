...
final class Arez_BasicComponentRefModel extends BasicComponentRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_BasicComponentRefModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicComponentRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
