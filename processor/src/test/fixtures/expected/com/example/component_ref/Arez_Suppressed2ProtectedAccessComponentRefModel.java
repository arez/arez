...
final class Arez_Suppressed2ProtectedAccessComponentRefModel extends Suppressed2ProtectedAccessComponentRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  Arez_Suppressed2ProtectedAccessComponentRefModel() {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ( Arez.areNamesEnabled() || Arez.areRegistriesEnabled() || Arez.areNativeComponentsEnabled() ) ? ++$$arezi$$_nextId : 0;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "Suppressed2ProtectedAccessComponentRefModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "Suppressed2ProtectedAccessComponentRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  protected Component getComponent() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'getComponent' invoked on uninitialized component of type 'Suppressed2ProtectedAccessComponentRefModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_Suppressed2ProtectedAccessComponentRefModel ) {
        final Arez_Suppressed2ProtectedAccessComponentRefModel that = (Arez_Suppressed2ProtectedAccessComponentRefModel) o;
