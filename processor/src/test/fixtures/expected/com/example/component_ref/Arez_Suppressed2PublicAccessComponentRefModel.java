...
final class Arez_Suppressed2PublicAccessComponentRefModel extends Suppressed2PublicAccessComponentRefModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  Arez_Suppressed2PublicAccessComponentRefModel() {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ( Arez.areNamesEnabled() || Arez.areRegistriesEnabled() || Arez.areNativeComponentsEnabled() ) ? ++$$arezi$$_nextId : 0;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "Suppressed2PublicAccessComponentRefModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "Suppressed2PublicAccessComponentRefModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final Component getComponent() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'getComponent' invoked on uninitialized component of type 'Suppressed2PublicAccessComponentRefModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_Suppressed2PublicAccessComponentRefModel ) {
        final Arez_Suppressed2PublicAccessComponentRefModel that = (Arez_Suppressed2PublicAccessComponentRefModel) o;
