...
public final class Arez_Element extends Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier, Linkable {
  ...
  public void link() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'link' invoked on uninitialized component of type 'Element'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
