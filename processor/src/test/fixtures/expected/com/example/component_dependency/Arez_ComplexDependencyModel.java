...
final class Arez_ComplexDependencyModel extends ComplexDependencyModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_ComplexDependencyModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "com_example_component_dependency_ComplexDependencyModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "com_example_component_dependency_ComplexDependencyModel", $$arezv$$_id, $$arezv$$_name, this::$$arezi$$_nativeComponentPreDispose ) : null;
    ...
    this.$$arez_dk$$_getValue1 = Arez_ComplexDependencyModel.class.getName() + $$arezv$$_id + '.' + "getValue1";
    final DisposeNotifier $$arezv$$_getValue1_dependency = super.getValue1();
    if ( null != $$arezv$$_getValue1_dependency ) {
      DisposeNotifier.asDisposeNotifier( super.getValue1() ).addOnDisposeListener( $$arez_dk$$_getValue1, this::dispose, true );
    }
    final DisposeNotifier $$arezv$$_getValue3_dependency = super.getValue3();
    if ( null != $$arezv$$_getValue3_dependency ) {
      DisposeNotifier.asDisposeNotifier( super.getValue3() ).addOnDisposeListener( $$arez$$_value3, () -> setValue3( null ), true );
    }
  ...
  public Integer getArezId() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'getArezId' invoked on uninitialized component of type 'com_example_component_dependency_ComplexDependencyModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  private void $$arezi$$_preDispose() {
    final DisposeNotifier $$arezv$$_getValue1_dependency = super.getValue1();
    if ( null != $$arezv$$_getValue1_dependency ) {
      DisposeNotifier.asDisposeNotifier( $$arezv$$_getValue1_dependency ).removeOnDisposeListener( $$arez_dk$$_getValue1, true );
    }
    final DisposeNotifier $$arezv$$_getValue3_dependency = super.getValue3();
    if ( null != $$arezv$$_getValue3_dependency ) {
      DisposeNotifier.asDisposeNotifier( $$arezv$$_getValue3_dependency ).removeOnDisposeListener( $$arez$$_value3, true );
    }
  }
  ...
  public void addOnDisposeListener(@Nonnull final Object key, @Nonnull final SafeProcedure action,
    ...
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'addOnDisposeListener' invoked on uninitialized component of type 'com_example_component_dependency_ComplexDependencyModel'" );
    }
  ...
  public void removeOnDisposeListener(@Nonnull final Object key, final boolean errorIfMissing) {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'removeOnDisposeListener' invoked on uninitialized component of type 'com_example_component_dependency_ComplexDependencyModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public boolean isDisposed() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'isDisposed' invoked on uninitialized component of type 'com_example_component_dependency_ComplexDependencyModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void dispose() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'dispose' invoked on uninitialized component of type 'com_example_component_dependency_ComplexDependencyModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  void setValue3(final DisposeNotifier value) {
    ...
    if ( !Objects.equals( value, $$arezv$$_currentValue ) ) {
      if ( null != $$arezv$$_currentValue ) {
        DisposeNotifier.asDisposeNotifier( $$arezv$$_currentValue ).removeOnDisposeListener( $$arez$$_value3, true );
      }
      super.setValue3( value );
      if ( null != value ) {
        DisposeNotifier.asDisposeNotifier( value ).addOnDisposeListener( $$arez$$_value3, () -> setValue3( null ), true );
      }
