...
final class Arez_NonCascadeObservableDependency extends NonCascadeObservableDependency implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_NonCascadeObservableDependency(final DisposeNotifier value) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "com_example_component_dependency_NonCascadeObservableDependency." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "com_example_component_dependency_NonCascadeObservableDependency", $$arezv$$_id, $$arezv$$_name, this::$$arezi$$_nativeComponentPreDispose ) : null;
    ...
    if ( null != $$arezv$$_getValue_dependency ) {
      DisposeNotifier.asDisposeNotifier( $$arezd$$_value ).addOnDisposeListener( this, () -> setValue( null ), true );
    }
  ...
  public Integer getArezId() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'getArezId' invoked on uninitialized component of type 'com_example_component_dependency_NonCascadeObservableDependency'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void addOnDisposeListener(@Nonnull final Object key, @Nonnull final SafeProcedure action,
    ...
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'addOnDisposeListener' invoked on uninitialized component of type 'com_example_component_dependency_NonCascadeObservableDependency'" );
    }
  ...
  public void removeOnDisposeListener(@Nonnull final Object key, final boolean errorIfMissing) {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'removeOnDisposeListener' invoked on uninitialized component of type 'com_example_component_dependency_NonCascadeObservableDependency'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public boolean isDisposed() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'isDisposed' invoked on uninitialized component of type 'com_example_component_dependency_NonCascadeObservableDependency'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void dispose() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'dispose' invoked on uninitialized component of type 'com_example_component_dependency_NonCascadeObservableDependency'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  void setValue(final DisposeNotifier value) {
    ...
    if ( !Objects.equals( value, $$arezv$$_currentValue ) ) {
      ...
      this.$$arezd$$_value = value;
      if ( null != value ) {
        DisposeNotifier.asDisposeNotifier( value ).addOnDisposeListener( this, () -> setValue( null ), true );
      }
