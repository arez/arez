...
final class Arez_ComponentFieldDependencyModel extends ComponentFieldDependencyModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_ComponentFieldDependencyModel() {
    ...
    if ( null != this.foo ) {
      DisposeNotifier.asDisposeNotifier( this.foo ).addOnDisposeListener( this, this::dispose, true );
    }
  ...
  private void $$arezi$$_preDispose() {
    if ( null != this.foo ) {
      DisposeNotifier.asDisposeNotifier( this.foo ).removeOnDisposeListener( this, true );
    }
  }
