...
final class Arez_PartiallyResolvedParameterizedFieldDependencyInParentModel<T extends DisposeNotifier> extends PartiallyResolvedParameterizedFieldDependencyInParentModel<T> implements Disposable, DisposeNotifier {
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_PartiallyResolvedParameterizedFieldDependencyInParentModel ) {
        final Arez_PartiallyResolvedParameterizedFieldDependencyInParentModel<T> that = (Arez_PartiallyResolvedParameterizedFieldDependencyInParentModel<T>) o;
