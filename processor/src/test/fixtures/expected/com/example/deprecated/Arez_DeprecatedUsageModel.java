...
public final class Arez_DeprecatedUsageModel extends DeprecatedUsageModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeNotifier {
  ...
  public Arez_DeprecatedUsageModel(final MyDeprecatedEntity myEntity,
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "DeprecatedUsageModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  @SuppressWarnings("deprecation")
  public final void doStuff(@Nonnull final MyDeprecatedEntity entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( o instanceof Arez_DeprecatedUsageModel ) {
      final Arez_DeprecatedUsageModel that = (Arez_DeprecatedUsageModel) o;
