...
final class Arez_ProtectedAccessContextRefModel
  extends ProtectedAccessContextRefModel
  implements Disposable, Identifiable<Integer>, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  Arez_ProtectedAccessContextRefModel() {
    super();
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_ProtectedAccessContextRefModel ) {
        final Arez_ProtectedAccessContextRefModel that = (Arez_ProtectedAccessContextRefModel) o;
