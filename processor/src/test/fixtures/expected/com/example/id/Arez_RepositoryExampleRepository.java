...
final class Arez_RepositoryExampleRepository extends RepositoryExampleRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryExampleRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryExampleRepository." + $$arezv$$_id : null;
  ...
  @Override
  @Nonnull
  public final Stream<RepositoryExample> entities() {
  ...
  @Override
  @Nonnull
  protected final ObservableValue<Stream<RepositoryExample>> getEntitiesObservableValue() {
    if ( Arez.shouldCheckApiInvariants() ) {
