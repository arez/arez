...
final class Arez_Suppressed2ProtectedAccessPreInverseRemoveModel extends Suppressed2ProtectedAccessPreInverseRemoveModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  @Nonnull
  private final ObservableValue<Collection<Suppressed2ProtectedAccessPreInverseRemoveModel.Element>> $$arez$$_elements;

  private Collection<Suppressed2ProtectedAccessPreInverseRemoveModel.Element> $$arezd$$_elements;

  private Collection<Suppressed2ProtectedAccessPreInverseRemoveModel.Element> $$arezd$$_$$cache$$_elements;

  Arez_Suppressed2ProtectedAccessPreInverseRemoveModel() {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ++$$arezi$$_nextId;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "Suppressed2ProtectedAccessPreInverseRemoveModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "Suppressed2ProtectedAccessPreInverseRemoveModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  final Locator $$arezi$$_locator() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named '$$arezi$$_locator' invoked on uninitialized component of type 'Suppressed2ProtectedAccessPreInverseRemoveModel'" );
    }
  ...
  private void $$arezi$$_preDispose() {
    for ( final Suppressed2ProtectedAccessPreInverseRemoveModel.Element other : new ArrayList<>( $$arezd$$_elements ) ) {
      ( (Suppressed2ProtectedAccessPreInverseRemoveModel_Arez_Element) other ).$$arezi$$_delink_other();
    }
  }
  ...
  public void verify() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      Guards.apiInvariant( () -> this == $$arezi$$_locator().findById( Suppressed2ProtectedAccessPreInverseRemoveModel.class, $$arezi$$_id() ), () -> "Attempted to lookup self in Locator with type Suppressed2ProtectedAccessPreInverseRemoveModel and id '" + $$arezi$$_id() + "' but unable to locate self. Actual value: " + $$arezi$$_locator().findById( Suppressed2ProtectedAccessPreInverseRemoveModel.class, $$arezi$$_id() ) );
      for( final Suppressed2ProtectedAccessPreInverseRemoveModel.Element element : this.$$arezd$$_elements ) {
        if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  final Collection<Suppressed2ProtectedAccessPreInverseRemoveModel.Element> getElements() {
    if ( Arez.shouldCheckApiInvariants() ) {
    ...
    if ( Arez.areCollectionsPropertiesUnmodifiable() ) {
      final Collection<Suppressed2ProtectedAccessPreInverseRemoveModel.Element> $$ar$$_result = this.$$arezd$$_elements;
  ...
  void $$arezir$$_elements_add(
      @Nonnull final Suppressed2ProtectedAccessPreInverseRemoveModel.Element element) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_Suppressed2ProtectedAccessPreInverseRemoveModel ) {
        final Arez_Suppressed2ProtectedAccessPreInverseRemoveModel that = (Arez_Suppressed2ProtectedAccessPreInverseRemoveModel) o;
