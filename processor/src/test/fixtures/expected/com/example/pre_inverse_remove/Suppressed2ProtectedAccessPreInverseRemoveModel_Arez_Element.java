...
final class Suppressed2ProtectedAccessPreInverseRemoveModel_Arez_Element extends Suppressed2ProtectedAccessPreInverseRemoveModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  @Nullable
  private Suppressed2ProtectedAccessPreInverseRemoveModel $$arezr$$_other;

  Suppressed2ProtectedAccessPreInverseRemoveModel_Arez_Element() {
    super();
  ...
  public final void verify() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      Guards.apiInvariant( () -> this == $$arezi$$_locator().findById( Suppressed2ProtectedAccessPreInverseRemoveModel.Element.class, $$arezi$$_id() ), () -> "Attempted to lookup self in Locator with type Suppressed2ProtectedAccessPreInverseRemoveModel.Element and id '" + $$arezi$$_id() + "' but unable to locate self. Actual value: " + $$arezi$$_locator().findById( Suppressed2ProtectedAccessPreInverseRemoveModel.Element.class, $$arezi$$_id() ) );
      final int $$arezv$$_otherId = this.getOtherId();
      final Suppressed2ProtectedAccessPreInverseRemoveModel $$arezv$$_other = this.$$arezi$$_locator().findById( Suppressed2ProtectedAccessPreInverseRemoveModel.class, $$arezv$$_otherId );
      Guards.apiInvariant( () -> null != $$arezv$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.pre_inverse_remove.Suppressed2ProtectedAccessPreInverseRemoveModel and id = " + getOtherId() );
    }
  }

  @Override
  Suppressed2ProtectedAccessPreInverseRemoveModel getOther() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  private void $$arezi$$_link_other() {
    ...
    this.$$arezr$$_other = this.$$arezi$$_locator().findById( Suppressed2ProtectedAccessPreInverseRemoveModel.class, id );
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.pre_inverse_remove.Suppressed2ProtectedAccessPreInverseRemoveModel and id = " + getOtherId() );
    }
    ( (Arez_Suppressed2ProtectedAccessPreInverseRemoveModel) this.$$arezr$$_other ).$$arezir$$_elements_add( this );
  }

  void $$arezi$$_delink_other() {
    if ( null != $$arezr$$_other && Disposable.isNotDisposed( $$arezr$$_other ) ) {
      ( (Arez_Suppressed2ProtectedAccessPreInverseRemoveModel) this.$$arezr$$_other ).$$arezir$$_elements_remove( this );
    }
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Suppressed2ProtectedAccessPreInverseRemoveModel_Arez_Element ) {
        final Suppressed2ProtectedAccessPreInverseRemoveModel_Arez_Element that = (Suppressed2ProtectedAccessPreInverseRemoveModel_Arez_Element) o;
