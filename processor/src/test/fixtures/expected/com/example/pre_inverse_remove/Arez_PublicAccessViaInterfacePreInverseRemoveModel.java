...
final class Arez_PublicAccessViaInterfacePreInverseRemoveModel extends PublicAccessViaInterfacePreInverseRemoveModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  ...
  Arez_PublicAccessViaInterfacePreInverseRemoveModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "PublicAccessViaInterfacePreInverseRemoveModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  final Collection<PublicAccessViaInterfacePreInverseRemoveModel.Element> getElements() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_PublicAccessViaInterfacePreInverseRemoveModel ) {
        final Arez_PublicAccessViaInterfacePreInverseRemoveModel that = (Arez_PublicAccessViaInterfacePreInverseRemoveModel) o;
