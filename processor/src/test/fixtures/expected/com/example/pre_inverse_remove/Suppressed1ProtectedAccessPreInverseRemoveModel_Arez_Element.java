...
final class Suppressed1ProtectedAccessPreInverseRemoveModel_Arez_Element extends Suppressed1ProtectedAccessPreInverseRemoveModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  @Nullable
  private Suppressed1ProtectedAccessPreInverseRemoveModel $$arezr$$_other;

  Suppressed1ProtectedAccessPreInverseRemoveModel_Arez_Element() {
    super();
  ...
  public void verify() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      Guards.apiInvariant( () -> this == $$arezi$$_locator().findById( Suppressed1ProtectedAccessPreInverseRemoveModel.Element.class, $$arezi$$_id() ), () -> "Attempted to lookup self in Locator with type Suppressed1ProtectedAccessPreInverseRemoveModel.Element and id '" + $$arezi$$_id() + "' but unable to locate self. Actual value: " + $$arezi$$_locator().findById( Suppressed1ProtectedAccessPreInverseRemoveModel.Element.class, $$arezi$$_id() ) );
      final int $$arezv$$_otherId = this.getOtherId();
      final Suppressed1ProtectedAccessPreInverseRemoveModel $$arezv$$_other = this.$$arezi$$_locator().findById( Suppressed1ProtectedAccessPreInverseRemoveModel.class, $$arezv$$_otherId );
      Guards.apiInvariant( () -> null != $$arezv$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.pre_inverse_remove.Suppressed1ProtectedAccessPreInverseRemoveModel and id = " + getOtherId() );
    }
  }

  @Override
  Suppressed1ProtectedAccessPreInverseRemoveModel getOther() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  private void $$arezi$$_link_other() {
    ...
    this.$$arezr$$_other = this.$$arezi$$_locator().findById( Suppressed1ProtectedAccessPreInverseRemoveModel.class, id );
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.pre_inverse_remove.Suppressed1ProtectedAccessPreInverseRemoveModel and id = " + getOtherId() );
    }
    ( (Arez_Suppressed1ProtectedAccessPreInverseRemoveModel) this.$$arezr$$_other ).$$arezir$$_elements_add( this );
  }

  void $$arezi$$_delink_other() {
    if ( null != $$arezr$$_other && Disposable.isNotDisposed( $$arezr$$_other ) ) {
      ( (Arez_Suppressed1ProtectedAccessPreInverseRemoveModel) this.$$arezr$$_other ).$$arezir$$_elements_remove( this );
    }
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Suppressed1ProtectedAccessPreInverseRemoveModel_Arez_Element ) {
        final Suppressed1ProtectedAccessPreInverseRemoveModel_Arez_Element that = (Suppressed1ProtectedAccessPreInverseRemoveModel_Arez_Element) o;
