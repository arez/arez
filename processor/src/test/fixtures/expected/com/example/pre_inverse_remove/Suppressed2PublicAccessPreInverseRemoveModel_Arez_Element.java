...
final class Suppressed2PublicAccessPreInverseRemoveModel_Arez_Element extends Suppressed2PublicAccessPreInverseRemoveModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  @Nullable
  private Suppressed2PublicAccessPreInverseRemoveModel $$arezr$$_other;

  Suppressed2PublicAccessPreInverseRemoveModel_Arez_Element() {
    super();
  ...
  public void verify() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      Guards.apiInvariant( () -> this == $$arezi$$_locator().findById( Suppressed2PublicAccessPreInverseRemoveModel.Element.class, $$arezi$$_id() ), () -> "Attempted to lookup self in Locator with type Suppressed2PublicAccessPreInverseRemoveModel.Element and id '" + $$arezi$$_id() + "' but unable to locate self. Actual value: " + $$arezi$$_locator().findById( Suppressed2PublicAccessPreInverseRemoveModel.Element.class, $$arezi$$_id() ) );
      final int $$arezv$$_otherId = this.getOtherId();
      final Suppressed2PublicAccessPreInverseRemoveModel $$arezv$$_other = this.$$arezi$$_locator().findById( Suppressed2PublicAccessPreInverseRemoveModel.class, $$arezv$$_otherId );
      Guards.apiInvariant( () -> null != $$arezv$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.pre_inverse_remove.Suppressed2PublicAccessPreInverseRemoveModel and id = " + getOtherId() );
    }
  }

  @Override
  Suppressed2PublicAccessPreInverseRemoveModel getOther() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  private void $$arezi$$_link_other() {
    ...
    this.$$arezr$$_other = this.$$arezi$$_locator().findById( Suppressed2PublicAccessPreInverseRemoveModel.class, id );
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.pre_inverse_remove.Suppressed2PublicAccessPreInverseRemoveModel and id = " + getOtherId() );
    }
    ( (Arez_Suppressed2PublicAccessPreInverseRemoveModel) this.$$arezr$$_other ).$$arezir$$_elements_add( this );
  }

  void $$arezi$$_delink_other() {
    if ( null != $$arezr$$_other && Disposable.isNotDisposed( $$arezr$$_other ) ) {
      ( (Arez_Suppressed2PublicAccessPreInverseRemoveModel) this.$$arezr$$_other ).$$arezir$$_elements_remove( this );
    }
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Suppressed2PublicAccessPreInverseRemoveModel_Arez_Element ) {
        final Suppressed2PublicAccessPreInverseRemoveModel_Arez_Element that = (Suppressed2PublicAccessPreInverseRemoveModel_Arez_Element) o;
