...
final class Arez_BasicPreInverseRemoveModel extends BasicPreInverseRemoveModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  ...
  Arez_BasicPreInverseRemoveModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicPreInverseRemoveModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  final Collection<BasicPreInverseRemoveModel.Element> getElements() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_BasicPreInverseRemoveModel ) {
        final Arez_BasicPreInverseRemoveModel that = (Arez_BasicPreInverseRemoveModel) o;
