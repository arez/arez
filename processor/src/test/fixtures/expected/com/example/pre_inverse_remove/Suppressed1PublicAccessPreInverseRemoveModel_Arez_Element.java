...
final class Suppressed1PublicAccessPreInverseRemoveModel_Arez_Element extends Suppressed1PublicAccessPreInverseRemoveModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  @Nullable
  private Suppressed1PublicAccessPreInverseRemoveModel $$arezr$$_other;

  Suppressed1PublicAccessPreInverseRemoveModel_Arez_Element() {
    super();
  ...
  public void verify() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      ...
      final Suppressed1PublicAccessPreInverseRemoveModel $$arezv$$_other = this.$$arezi$$_locator().findById( Suppressed1PublicAccessPreInverseRemoveModel.class, $$arezv$$_otherId );
      Guards.apiInvariant( () -> null != $$arezv$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.pre_inverse_remove.Suppressed1PublicAccessPreInverseRemoveModel and id = " + getOtherId() );
    }
  }

  @Override
  Suppressed1PublicAccessPreInverseRemoveModel getOther() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  private void $$arezi$$_link_other() {
    ...
    this.$$arezr$$_other = this.$$arezi$$_locator().findById( Suppressed1PublicAccessPreInverseRemoveModel.class, id );
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_other, () -> "Reference named 'other' on component named '" + this.$$arezi$$_kernel.getName() + "' is unable to resolve entity of type com.example.pre_inverse_remove.Suppressed1PublicAccessPreInverseRemoveModel and id = " + getOtherId() );
    }
    ( (Arez_Suppressed1PublicAccessPreInverseRemoveModel) this.$$arezr$$_other ).$$arezir$$_elements_add( this );
  }

  void $$arezi$$_delink_other() {
    if ( null != $$arezr$$_other && Disposable.isNotDisposed( $$arezr$$_other ) ) {
      ( (Arez_Suppressed1PublicAccessPreInverseRemoveModel) this.$$arezr$$_other ).$$arezir$$_elements_remove( this );
    }
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Suppressed1PublicAccessPreInverseRemoveModel_Arez_Element ) {
        final Suppressed1PublicAccessPreInverseRemoveModel_Arez_Element that = (Suppressed1PublicAccessPreInverseRemoveModel_Arez_Element) o;
