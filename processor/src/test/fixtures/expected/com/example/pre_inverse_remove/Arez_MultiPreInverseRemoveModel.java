...
final class Arez_MultiPreInverseRemoveModel extends MultiPreInverseRemoveModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeNotifier {
  ...
  Arez_MultiPreInverseRemoveModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "MultiPreInverseRemoveModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  final Collection<MultiPreInverseRemoveModel.Element> getElements() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_MultiPreInverseRemoveModel ) {
        final Arez_MultiPreInverseRemoveModel that = (Arez_MultiPreInverseRemoveModel) o;
