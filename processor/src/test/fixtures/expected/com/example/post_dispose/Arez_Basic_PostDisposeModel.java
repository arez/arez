...
final class Arez_Basic_PostDisposeModel
  extends BasicPostDisposeModel
  implements Disposable, Identifiable<Integer>, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  Arez_Basic_PostDisposeModel() {
    super();
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_Basic_PostDisposeModel ) {
        final Arez_Basic_PostDisposeModel that = (Arez_Basic_PostDisposeModel) o;
