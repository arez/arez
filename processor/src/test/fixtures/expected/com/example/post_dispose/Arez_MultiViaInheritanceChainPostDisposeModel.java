...
final class Arez_MultiViaInheritanceChainPostDisposeModel extends MultiViaInheritanceChainPostDisposeModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_MultiViaInheritanceChainPostDisposeModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "MultiViaInheritanceChainPostDisposeModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose(),  this::$$arezi$$_postDispose ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_MultiViaInheritanceChainPostDisposeModel ) {
        final Arez_MultiViaInheritanceChainPostDisposeModel that = (Arez_MultiViaInheritanceChainPostDisposeModel) o;
