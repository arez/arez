...
public final class Arez_PostDisposeWithDisabledDisposeNotifierModel extends PostDisposeWithDisabledDisposeNotifierModel implements Disposable, Identifiable<Integer> {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  public Arez_PostDisposeWithDisabledDisposeNotifierModel() {
    super();
