...
final class Arez_MultiPostDisposeModel extends MultiPostDisposeModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_MultiPostDisposeModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "MultiPostDisposeModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose(),  this::$$arezi$$_postDispose ) : null;
