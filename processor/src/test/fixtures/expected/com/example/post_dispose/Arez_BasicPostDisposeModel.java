...
final class Arez_BasicPostDisposeModel extends BasicPostDisposeModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_BasicPostDisposeModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicPostDisposeModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose(),  () -> super.postDispose() ) : null;
