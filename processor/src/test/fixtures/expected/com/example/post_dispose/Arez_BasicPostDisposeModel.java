...
final class Arez_BasicPostDisposeModel extends BasicPostDisposeModel implements Disposable, DisposeNotifier {
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_BasicPostDisposeModel ) {
        final Arez_BasicPostDisposeModel that = (Arez_BasicPostDisposeModel) o;
