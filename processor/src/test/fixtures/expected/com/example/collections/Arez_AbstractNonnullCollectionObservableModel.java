...
final class Arez_AbstractNonnullCollectionObservableModel extends AbstractNonnullCollectionObservableModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_AbstractNonnullCollectionObservableModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "com_example_collections_AbstractNonnullCollectionObservableModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "com_example_collections_AbstractNonnullCollectionObservableModel", $$arezv$$_id, $$arezv$$_name, this::$$arezi$$_nativeComponentPreDispose ) : null;
  ...
  public Integer getArezId() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'getArezId' invoked on uninitialized component of type 'com_example_collections_AbstractNonnullCollectionObservableModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void addOnDisposeListener(@Nonnull final Object key, @Nonnull final SafeProcedure action) {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'addOnDisposeListener' invoked on uninitialized component of type 'com_example_collections_AbstractNonnullCollectionObservableModel'" );
    }
  ...
  public void removeOnDisposeListener(@Nonnull final Object key) {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'removeOnDisposeListener' invoked on uninitialized component of type 'com_example_collections_AbstractNonnullCollectionObservableModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public boolean isDisposed() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'isDisposed' invoked on uninitialized component of type 'com_example_collections_AbstractNonnullCollectionObservableModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void dispose() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'dispose' invoked on uninitialized component of type 'com_example_collections_AbstractNonnullCollectionObservableModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
