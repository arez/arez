...
final class Arez_MemoizeKeepAliveListModel extends MemoizeKeepAliveListModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_MemoizeKeepAliveListModel() {
    ...
    this.$$arez$$_myValue = Arez.areCollectionsPropertiesUnmodifiable() ? $$arezv$$_context.computable( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".myValue" : null, () -> $$arezi$$_memoize_myValue(), Arez.areCollectionsPropertiesUnmodifiable() ? this::$$arezi$$_onActivate_myValue : null, ComputableValue.Flags.AREZ_DEPENDENCIES | ComputableValue.Flags.RUN_LATER | ComputableValue.Flags.KEEPALIVE ) : $$arezv$$_context.computable( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".myValue" : null, () -> super.getMyValue(), ComputableValue.Flags.AREZ_DEPENDENCIES | ComputableValue.Flags.RUN_LATER | ComputableValue.Flags.KEEPALIVE );
