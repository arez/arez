...
final class Arez_BasicStingModel extends BasicStingModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_BasicStingModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicStingModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_BasicStingModel ) {
        final Arez_BasicStingModel that = (Arez_BasicStingModel) o;
