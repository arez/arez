...
final class Arez_NamedArgStingModel extends NamedArgStingModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  Arez_NamedArgStingModel(final int port) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "NamedArgStingModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
