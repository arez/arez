...
final class Arez_ServiceViaNamedStingModel extends ServiceViaNamedStingModel implements Disposable, Identifiable<Integer> {
  ...
  Arez_ServiceViaNamedStingModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "com_example_sting_ServiceViaNamedStingModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "com_example_sting_ServiceViaNamedStingModel", $$arezv$$_id, $$arezv$$_name ) : null;
  ...
  public Integer getArezId() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'getArezId' invoked on uninitialized component of type 'com_example_sting_ServiceViaNamedStingModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public boolean isDisposed() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'isDisposed' invoked on uninitialized component of type 'com_example_sting_ServiceViaNamedStingModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void dispose() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'dispose' invoked on uninitialized component of type 'com_example_sting_ServiceViaNamedStingModel'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
