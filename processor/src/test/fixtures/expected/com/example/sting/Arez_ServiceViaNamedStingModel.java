...
final class Arez_ServiceViaNamedStingModel extends ServiceViaNamedStingModel implements Disposable {
  ...
  public boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_ServiceViaNamedStingModel ) {
        final Arez_ServiceViaNamedStingModel that = (Arez_ServiceViaNamedStingModel) o;
