...
public final class Arez_DifferentObservableTypesModel extends DifferentObservableTypesModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public Arez_DifferentObservableTypesModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "DifferentObservableTypesModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  @Override
  public final void setV1(final boolean v1) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  public final void setV2(final byte v2) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  public final void setV3(final char v3) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  public final void setV4(final short v4) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  public final void setV5(final int v5) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  public final void setV6(final long v6) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  public final void setV7(final float v7) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  public final void setV8(final double v8) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  @Override
  public final void setV9(final Object v9) {
    if ( Arez.shouldCheckApiInvariants() ) {
