    ...
    return new Object[][]
      {
        ...
        new Object[]{ "OnDisposeNoComputedModel",
                      "@OnDispose exists but there is no corresponding @Computed" },
        new Object[]{ "OnDisposeBadNameModel",
                      "@OnDispose as does not match on[Name]Dispose pattern. Please specify name." },
        new Object[]{ "OnDisposePrivateModel", "@OnDispose target must not be private" },
        new Object[]{ "OnDisposeStaticModel", "@OnDispose target must not be static" },
        new Object[]{ "OnDisposeParametersModel", "@OnDispose target must not have any parameters" },
        new Object[]{ "OnDisposeReturnValueModel", "@OnDispose target must not return a value" },
        new Object[]{ "OnDisposeThrowsExceptionModel", "@OnDispose target must not throw any exceptions" },
        new Object[]{ "OnDisposeDuplicateModel", "@OnDispose target duplicates existing method named foo" },
        ...
        new Object[]{ "VoidComputedModel", "@Computed target must return a value" },
        new Object[]{ "ParameterizedComputedModel", "@Computed target must not have any parameters" },
        ...
        new Object[]{ "ComputedThrowsExceptionModel", "@Computed target must not throw any exceptions" },
        new Object[]{ "EmptyContainerModel",
                      "@Container target has no methods annotated with @Action, @Computed, @Observable, @Tracked or @Autorun" },
        ...
        new Object[]{ "TrackedDuplicatedModel", "@Tracked target duplicates existing method named render" },
        new Object[]{ "TrackedFinalModel", "@Tracked target must not be final" },
        new Object[]{ "TrackedNotStaticModel", "@Tracked target must not be static" },
        new Object[]{ "TrackedNotPrivateModel", "@Tracked target must not be private" },
        new Object[]{ "TrackedBadNameModel", "Method annotated with @Tracked specified invalid name -ace" },
        new Object[]{ "OnDepsUpdatedDuplicatedModel",
                      "@OnDepsUpdated target duplicates existing method named onRenderDepsUpdated" },
        new Object[]{ "OnDepsUpdatedNotStaticModel", "@OnDepsUpdated target must not be static" },
        new Object[]{ "OnDepsUpdatedNotPrivateModel", "@OnDepsUpdated target must not be private" },
        new Object[]{ "OnDepsUpdatedMustNotHaveParametersModel", "@OnDepsUpdated target must not have any parameters" },
        new Object[]{ "OnDepsUpdatedMustNotReturnValueModel", "@OnDepsUpdated target must not return a value" },
        new Object[]{ "OnDepsUpdatedThrowsExceptionModel", "@OnDepsUpdated target must not throw any exceptions" },
        new Object[]{ "OnDepsUpdatedBadName", "Method annotated with @OnDepsUpdated specified invalid name -ace" },
        ...
        new Object[]{ "PostConstructNotPrivateModel", "@PostConstruct target must not be private" },
        ...
        new Object[]{ "ActionAndAutorunMethodModel", "Method can not be annotated with both @Action and @Autorun" },
