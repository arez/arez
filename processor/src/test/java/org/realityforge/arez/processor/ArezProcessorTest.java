    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.component_id.ComponentIdOnSingletonModel",
                      "@ComponentId must not exist if @ArezComponent is a singleton" },
        ...
        new Object[]{ "com.example.component_name.ComponentNameOnSingletonModel",
                      "@ComponentName must not exist if @ArezComponent is a singleton" },
        ...
        new Object[]{ "com.example.observable_ref.BadNameModel", "Method annotated with @ObservableRef specified invalid name -ace" },
        new Object[]{ "com.example.observable_ref.BadReturnTypeModel", "Method annotated with @ObservableRef must return an instance of org.realityforge.arez.Observable" },
        new Object[]{ "com.example.observable_ref.DuplicateRefMethodModel", "Method annotated with @ObservableRef defines duplicate ref accessor for observable named time" },
        new Object[]{ "com.example.observable_ref.FinalModel", "@ObservableRef target must not be final" },
        new Object[]{ "com.example.observable_ref.NonAlignedNameModel", "Method annotated with @ObservableRef should specify name or be named according to the convention get[Name]Observable" },
        new Object[]{ "com.example.observable_ref.NoObservableModel", "@ObservableRef target unable to associated with an Observable property" },
        new Object[]{ "com.example.observable_ref.ParametersModel", "@ObservableRef target must not have any parameters" },
        ...
        new Object[]{ "com.example.observable_ref.ThrowsExceptionModel", "@ObservableRef target must not throw any exceptions" },
        ...
        new Object[]{ "com.example.pre_dispose.PreDisposeNotDisposableModel",
                      "@PreDispose must not exist if @ArezComponent set disposable to false" },
        ...
        new Object[]{ "com.example.post_dispose.PostDisposeNotDisposableModel",
                      "@PostDispose must not exist if @ArezComponent set disposable to false" },
        ...
        new Object[]{ "com.example.tracked.TrackedMissingOnDepsUpdated",
                      "@Track target has no corresponding @OnDepsUpdated that could be automatically determined" },
        new Object[]{ "com.example.tracked.TrackedBadNameModel",
                      "Method annotated with @Track specified invalid name -ace" },
        new Object[]{ "com.example.on_deps_updated.OnDepsUpdatedDuplicatedModel",
                      "@OnDepsUpdated target duplicates existing method named onRenderDepsUpdated" },
        new Object[]{ "com.example.on_deps_updated.OnDepsUpdatedNotStaticModel",
                      "@OnDepsUpdated target must not be static" },
        new Object[]{ "com.example.on_deps_updated.OnDepsUpdatedNotPrivateModel",
                      "@OnDepsUpdated target must not be private" },
        new Object[]{ "com.example.on_deps_updated.OnDepsUpdatedMustNotHaveParametersModel",
                      "@OnDepsUpdated target must not have any parameters" },
        new Object[]{ "com.example.on_deps_updated.OnDepsUpdatedMustNotReturnValueModel",
                      "@OnDepsUpdated target must not return a value" },
        new Object[]{ "com.example.on_deps_updated.OnDepsUpdatedThrowsExceptionModel",
                      "@OnDepsUpdated target must not throw any exceptions" },
        new Object[]{ "com.example.on_deps_updated.OnDepsUpdatedBadName",
                      "Method annotated with @OnDepsUpdated specified invalid name -ace" },
        new Object[]{ "com.example.on_deps_updated.OnDepsUpdatedNoTracked",
                      "@OnDepsUpdated target has no corresponding @Track that could be automatically determined" },
