    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.component.EmptyComponent",
                      "@ArezComponent target has no methods annotated with @Action, @Computed, @Observable, @Tracked or @Autorun" },
        ...
        new Object[]{ "com.example.tracked.TrackedDuplicatedModel",
                      "@Tracked target duplicates existing method named render" },
        new Object[]{ "com.example.tracked.TrackedFinalModel", "@Tracked target must not be final" },
        new Object[]{ "com.example.tracked.TrackedNotStaticModel", "@Tracked target must not be static" },
        new Object[]{ "com.example.tracked.TrackedNotPrivateModel", "@Tracked target must not be private" },
        new Object[]{ "com.example.tracked.TrackedMissingOnDepsUpdated",
                      "@Tracked target has no corresponding @OnDepsUpdated that could be automatically determined" },
        new Object[]{ "com.example.tracked.TrackedBadNameModel",
                      "Method annotated with @Tracked specified invalid name -ace" },
        ...
        new Object[]{ "com.example.on_deps_updated.OnDepsUpdatedNoTracked",
                      "@OnDepsUpdated target has no corresponding @Tracked that could be automatically determined" },
