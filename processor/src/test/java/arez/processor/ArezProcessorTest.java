    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.computable_value_ref.DefaultRefNameModel", false, false, false },
        new Object[]{ "com.example.computable_value_ref.NonStandardNameModel", false, false, false },
        new Object[]{ "com.example.computable_value_ref.RawComputableValueModel", false, false, false },
        ...
        new Object[]{ "com.example.observe.DeriveFinalOnDepsChangeModel", false, false, false },
        new Object[]{ "com.example.observe.DeriveOnDepsChangeModel", false, false, false },
        ...
        new Object[]{ "com.example.observer_ref.CustomNameRefOnObserveModel1", false, false, false },
        new Object[]{ "com.example.observer_ref.CustomNameRefOnObserveModel2", false, false, false },
        new Object[]{ "com.example.observer_ref.RefOnObserveModel1", false, false, false },
        new Object[]{ "com.example.observer_ref.RefOnBothModel", false, false, false },
        new Object[]{ "com.example.observer_ref.RefOnObserveModel2", false, false, false },
    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.component.NonEmptyComponent",
                      "@ArezComponent target has specified allowEmpty = true but has methods annotated with @Action, @CascadeDispose, @Computed, @Observable, @Inverse, @Reference, @ComponentDependency or @Observe" },
        ...
        new Object[]{ "com.example.component.EmptyComponent",
                      "@ArezComponent target has no methods annotated with @Action, @CascadeDispose, @Computed, @Observable, @Inverse, @Reference, @ComponentDependency or @Observe" },
        ...
        new Object[]{ "com.example.computed.BadDepTypeMemoizeModel",
                      "@Computed target specified an invalid depType od AREZ_OR_EXTERNAL." },
        ...
        new Object[]{ "com.example.computed.MissingComputableValueRefModel",
                      "@Computed target specified depType = AREZ_OR_EXTERNAL but there is no associated @ComputableValueRef method." },
        ...
        new Object[]{ "com.example.computed_value_ref.BadReturnType2Model",
                      "@ComputableValueRef target has a type parameter of ? but @Computed method returns type of long" },
        new Object[]{ "com.example.computed_value_ref.BadReturnType3Model",
                      "@ComputableValueRef target has a type parameter of java.lang.String but @Computed method returns type of long" },
        ...
        new Object[]{ "com.example.computed_value_ref.FinalModel", "@ComputableValueRef target must not be final" },
        new Object[]{ "com.example.computed_value_ref.NoComputedValueModel",
                      "@ComputableValueRef exists but there is no corresponding @Computed" },
        ...
        new Object[]{ "com.example.computed_value_ref.ParametersModel",
                      "@ComputableValueRef target must not have any parameters" },
        new Object[]{ "com.example.computed_value_ref.PrivateModel", "@ComputableValueRef target must not be private" },
        new Object[]{ "com.example.computed_value_ref.StaticModel", "@ComputableValueRef target must not be static" },
        ...
        new Object[]{ "com.example.name_duplicates.ComputedAndObserveMethodModel",
