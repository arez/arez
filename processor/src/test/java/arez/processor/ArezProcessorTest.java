    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.observed.NonArezDependenciesButNoObserverRefModel",
                      "@Observed target with parameter arezOnlyDependencies=false has not defined an @ObserverRef method and thus can not invoke reportStale()." },
        ...
        new Object[]{ "com.example.computed.MissingComputedValueRefModel",
                      "@Computed target specified arezOnlyDependencies = false but there is no associated @ComputedValueRef method." },
