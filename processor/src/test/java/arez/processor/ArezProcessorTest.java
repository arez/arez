    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.observe.ObservedAbstractModel", "@Observe target must not be abstract" },
        new Object[]{ "com.example.observe.ObservedBadNameModel",
                      "@Observe target specified an invalid name '-ace'. The name must be a valid java identifier." },
        new Object[]{ "com.example.observe.ObservedBadNameModel2",
                      "@Observe target specified an invalid name 'float'. The name must not be a java keyword." },
        new Object[]{ "com.example.observe.ObservedDuplicateModel",
                      "@Observe target duplicates existing method named foo" },
        new Object[]{ "com.example.observe.ObservedDuplicateModel2",
                      "Method annotated with @Computed specified name doStuff that duplicates @Observe defined by method foo" },
        new Object[]{ "com.example.observe.ObservedFinalModel", "@Observe target must not be final" },
        new Object[]{ "com.example.observe.ObservedParametersModel", "@Observe target must not have any parameters" },
        new Object[]{ "com.example.observe.ObservedPrivateModel", "@Observe target must not be private" },
        new Object[]{ "com.example.observe.ObservedPublicModel", "@Observe target must not be public" },
        new Object[]{ "com.example.observe.ObservedReturnsValueModel", "@Observe target must not return a value" },
        new Object[]{ "com.example.observe.ObservedStaticModel", "@Observe target must not be static" },
        new Object[]{ "com.example.observe.ObservedThrowsExceptionModel",
