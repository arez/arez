    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.priority_override.BadNameModel", "@PriorityOverride target specified an invalid name '-ace'. The name must be a valid java identifier." },
        new Object[]{ "com.example.priority_override.BadNameModel2", "@PriorityOverride target specified an invalid name 'int'. The name must not be a java keyword." },
        new Object[]{ "com.example.priority_override.BadNameModel3", "Method annotated with @PriorityOverride should specify name or be named according to the convention [name]Priority" },
        new Object[]{ "com.example.priority_override.BadParameterModel", "@PriorityOverride target must have no parameters or a single int parameter" },
        new Object[]{ "com.example.priority_override.BadReturnTypeModel", "@PriorityOverride target must return an int value" },
        new Object[]{ "com.example.priority_override.MultipleParametersModel", "@PriorityOverride target must have no parameters or a single int parameter" },
        new Object[]{ "com.example.priority_override.NoAssociatedModel", "@PriorityOverride target has no corresponding @Memoize or @Observe methods" },
