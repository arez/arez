    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.computable_value_ref.RawComputableValueWithParamsModel",
                      false,
                      false,
                      false,
                      false },
    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.cascade_dispose.AbstractMethodComponent",
                      "@CascadeDispose target must not be abstract unless the method is also annotated with the @Observable annotation." },
        ...
        new Object[]{ "com.example.cascade_dispose.ConcreteObservableMethodComponent",
                      "@CascadeDispose target must be abstract if the method is also annotated with the @Observable annotation." },
