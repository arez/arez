    ...
    return new Object[][]
      {
        ...
        new Object[]{ "com.example.observe.ApplicationExecutorButNoOnDepsChangedModel",
                      "@Observe target defined parameter executor=APPLICATION but does not specify an @OnDepsChanged method." },
        new Object[]{ "com.example.observe.ArezExecutorOnDepsChangedButNoObserverRefModel",
