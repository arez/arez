...
public final class Arez_ImplicitSingletonModel extends ImplicitSingletonModel implements Disposable, Identifiable<Integer> {
  ...
  public Arez_ImplicitSingletonModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "ImplicitSingletonModel" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ImplicitSingletonModel", $$arezv$$_id, $$arezv$$_name ) : null;
