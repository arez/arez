...
public final class Arez_ObservableTypeParametersModel<T extends Integer> extends ObservableTypeParametersModel<T> implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method invoked on uninitialized component of type 'ObservableTypeParametersModel'" );
    }
