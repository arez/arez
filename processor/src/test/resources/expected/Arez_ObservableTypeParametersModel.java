...
public final class Arez_ObservableTypeParametersModel<T extends Integer> extends ObservableTypeParametersModel<T> implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ObservableTypeParametersModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservableTypeParametersModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
