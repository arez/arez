...
public final class Arez_ObservableTypeParametersModel<T extends Integer> extends ObservableTypeParametersModel<T> implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ObservableTypeParametersModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "ObservableTypeParametersModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'ObservableTypeParametersModel'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'ObservableTypeParametersModel'" );
    }
    return "ObservableTypeParametersModel." + $$arezi$$_id();
  }
  ...
  private void $$arezi$$_setTime(final T time) {
    if ( Arez.shouldCheckApiInvariants() ) {
