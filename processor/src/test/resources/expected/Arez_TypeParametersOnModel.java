...
public final class Arez_TypeParametersOnModel<T extends Integer> extends TypeParametersOnModel<T> implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_TypeParametersOnModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "TypeParametersOnModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
