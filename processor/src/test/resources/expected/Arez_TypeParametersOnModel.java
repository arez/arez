...
public final class Arez_TypeParametersOnModel<T extends Integer> extends TypeParametersOnModel<T> implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_TypeParametersOnModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "TypeParametersOnModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
