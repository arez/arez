...
public final class Arez_ObservableModelWithUnconventionalNames extends ObservableModelWithUnconventionalNames implements Disposable {
  ...
  public Arez_ObservableModelWithUnconventionalNames() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "ObservableModelWithUnconventionalNames", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
    ...
    this.$$arez$$_time = $$arez$$_context().createObservable( Arez.areNativeComponentsEnabled() ? this.$$arez$$_component : null, Arez.areNamesEnabled() ? $$arez$$_name() + ".time" : null, Arez.arePropertyIntrospectorsEnabled() ? () -> super.time() : null, Arez.arePropertyIntrospectorsEnabled() ? v -> super.time( v ) : null );
