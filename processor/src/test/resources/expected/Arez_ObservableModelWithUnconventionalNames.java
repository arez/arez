...
public final class Arez_ObservableModelWithUnconventionalNames extends ObservableModelWithUnconventionalNames implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_ObservableModelWithUnconventionalNames() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservableModelWithUnconventionalNames", $$arezi$$_id(), $$arezi$$_name() ) : null;
