...
public final class Arez_ObservableWithCtorModel extends ObservableWithCtorModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ObservableWithCtorModel(final long time) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ObservableWithCtorModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
