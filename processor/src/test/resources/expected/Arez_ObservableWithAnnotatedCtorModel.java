...
public final class Arez_ObservableWithAnnotatedCtorModel extends ObservableWithAnnotatedCtorModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ObservableWithAnnotatedCtorModel(@Nonnegative final long time, final long other,
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservableWithAnnotatedCtorModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
