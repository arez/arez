...
@Singleton
public final class Arez_SingletonWithIdModel extends SingletonWithIdModel implements Disposable {
  ...
  public Arez_SingletonWithIdModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "SingletonWithIdModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
    ...
    this.$$arez$$_myAutorun = $$arez$$_context().autorun( Arez.areNativeComponentsEnabled() ? this.$$arez$$_component : null, Arez.areNamesEnabled() ? $$arez$$_name() + ".myAutorun" : null, true, () -> super.myAutorun(), false );
  ...
  String $$arez$$_name() {
    return "SingletonWithIdModel." + $$arez$$_id();
  }
  ...
  public void myAutorun() {
    Guards.invariant( () -> !this.$$arez$$_disposed, () -> "Method invoked on invalid component '" + $$arez$$_name() + "'" );
    $$arez$$_context().safeAction( Arez.areNamesEnabled() ? $$arez$$_name() + ".myAutorun" : null, true, () -> super.myAutorun() );
  }
