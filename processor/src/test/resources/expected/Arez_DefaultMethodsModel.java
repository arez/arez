...
public final class Arez_DefaultMethodsModel extends DefaultMethodsModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_DefaultMethodsModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "DefaultMethodsModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
