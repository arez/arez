...
public final class Arez_OverrideNamesInModel extends OverrideNamesInModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_OverrideNamesInModel() {
    ...
    this.$$arez$$_myComputed = $$arezi$$_context().computed( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".myComputed" : null, () -> super.compute(), Options.DEFER_REACT );
    this.$$arez$$_zzzzzz = $$arezi$$_context().observer( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".zzzzzz" : null, () -> super.zapZap(), Options.DEFER_REACT );
    this.$$arez$$_XX = $$arezi$$_context().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".XX" : null, () -> super.onRenderDepsChanged(), Options.DEFER_REACT );
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void doAction() {
    ...
    try {
      $$arezi$$_context().safeAction(Arez.areNamesEnabled() ? $$arezi$$_name() + ".myAction" : null, true, false, false, () -> super.doAction() );
