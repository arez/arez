...
public final class Arez_OverrideNamesInModel extends OverrideNamesInModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_OverrideNamesInModel() {
    ...
    this.$$arez$$_myComputed = $$arezi$$_context().computed( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".myComputed" : null, () -> super.compute(), Flags.RUN_LATER | Flags.AREZ_DEPENDENCIES );
