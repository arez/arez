...
final class Arez_ObservableReferenceModel extends ObservableReferenceModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  private void $$arezi$$_link_myEntity() {
    ...
    if ( null == this.$$arezr$$_myEntity ) {
      ...
      this.$$arezr$$_myEntity = this.$$arezi$$_locator().getById( ObservableReferenceModel.MyEntity.class, id );
      if ( Arez.shouldCheckApiInvariants() ) {
