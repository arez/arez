...
final class Arez_EagerLoadObservableReferenceModel extends EagerLoadObservableReferenceModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  public void verify() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      ...
      Guards.apiInvariant( () -> null != $$arezv$$_myEntity, () -> "Reference named 'myEntity' on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type com.example.reference.EagerLoadObservableReferenceModel.MyEntity and id = " + getMyEntityId() );
    }
  }
  ...
  private void $$arezi$$_link_myEntity() {
    ...
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_myEntity, () -> "Reference named 'myEntity' on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type com.example.reference.EagerLoadObservableReferenceModel.MyEntity and id = " + getMyEntityId() );
    }
  }
