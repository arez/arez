...
final class Arez_LazyLoadReferenceModel extends LazyLoadReferenceModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_LazyLoadReferenceModel(@Nonnull final Locator locator) {
    super();
  ...
  private void $$arezi$$_link_myEntity() {
    ...
    if ( null == this.$$arezr$$_myEntity ) {
      ...
      this.$$arezr$$_myEntity = this.$$arezi$$_locator().getById( LazyLoadReferenceModel.MyEntity.class, id );
      if ( Arez.shouldCheckApiInvariants() ) {
