...
final class Arez_Lazy_ObservableReadOutsideTransactionReferenceModel
  extends LazyObservableReadOutsideTransactionReferenceModel
  implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_Lazy_ObservableReadOutsideTransactionReferenceModel( @Nonnull final Locator locator) {
    super();
  ...
  private void $$arezi$$_link_myEntity() {
    ...
    if ( null == this.$$arezr$$_myEntity ) {
      ...
      this.$$arezr$$_myEntity = this.$$arezi$$_locator().getById( LazyObservableReadOutsideTransactionReferenceModel.MyEntity.class, id );
      if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( this == o ) {
        return true;
      } else if ( null == o || !(o instanceof Arez_Lazy_ObservableReadOutsideTransactionReferenceModel ) ) {
        return false;
      } else {
        final Arez_Lazy_ObservableReadOutsideTransactionReferenceModel
          that = (Arez_Lazy_ObservableReadOutsideTransactionReferenceModel) o;;
