...
final class Arez_LazyObservableReadOutsideTransactionReferenceModel extends LazyObservableReadOutsideTransactionReferenceModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  Arez_LazyObservableReadOutsideTransactionReferenceModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "LazyObservableReadOutsideTransactionReferenceModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'LazyObservableReadOutsideTransactionReferenceModel'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'LazyObservableReadOutsideTransactionReferenceModel'" );
    }
    return "LazyObservableReadOutsideTransactionReferenceModel." + $$arezi$$_id();
  }
  ...
  public void verify() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      ...
      Guards.apiInvariant( () -> null != $$arezv$$_myEntity, () -> "Reference named 'myEntity' on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type com.example.reference.LazyObservableReadOutsideTransactionReferenceModel.MyEntity and id = " + getMyEntityId() );
    }
  }
  ...
  private void $$arezi$$_link_myEntity() {
    ...
    if ( null == this.$$arezr$$_myEntity ) {
      ...
      if ( Arez.shouldCheckApiInvariants() ) {
        Guards.apiInvariant( () -> null != $$arezr$$_myEntity, () -> "Reference named 'myEntity' on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type com.example.reference.LazyObservableReadOutsideTransactionReferenceModel.MyEntity and id = " + getMyEntityId() );
      }
    }
  }
