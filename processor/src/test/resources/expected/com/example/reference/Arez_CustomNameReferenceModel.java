...
final class Arez_CustomNameReferenceModel extends CustomNameReferenceModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  public void verify() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.isVerifyEnabled() ) {
      ...
      Guards.apiInvariant( () -> null != $$arezv$$_Blah, () -> "Reference named 'Blah' on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type com.example.reference.CustomNameReferenceModel.MyEntity and id = " + getMyEntityId() );
    }
  }
  ...
  private void $$arezi$$_link_Blah() {
    ...
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_Blah, () -> "Reference method named 'getMyEntity' invoked on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type com.example.reference.CustomNameReferenceModel.MyEntity and id = " + getMyEntityId() );
    }
  }
