...
final class Arez_NonnullLazyLoadReferenceModel extends NonnullLazyLoadReferenceModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  Arez_NonnullLazyLoadReferenceModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "NonnullLazyLoadReferenceModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
