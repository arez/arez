...
final class Arez_NonnullLazyLoadReferenceModel extends NonnullLazyLoadReferenceModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_NonnullLazyLoadReferenceModel(@Nonnull final Locator locator) {
    super();
  ...
  private void $$arezi$$_link_myEntity() {
    ...
    if ( null == this.$$arezr$$_myEntity ) {
      ...
      this.$$arezr$$_myEntity = this.$$arezi$$_locator().getById( NonnullLazyLoadReferenceModel.MyEntity.class, id );
      if ( Arez.shouldCheckApiInvariants() ) {
