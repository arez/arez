...
final class Arez_EagerLoadNulableObservableReferenceModel extends EagerLoadNulableObservableReferenceModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  Arez_EagerLoadNulableObservableReferenceModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "EagerLoadNulableObservableReferenceModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
