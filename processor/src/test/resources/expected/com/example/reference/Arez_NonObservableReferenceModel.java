...
final class Arez_NonObservableReferenceModel extends NonObservableReferenceModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  Arez_NonObservableReferenceModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "NonObservableReferenceModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_NonObservableReferenceModel ) {
