...
final class Arez_NonObservableReferenceModel extends NonObservableReferenceModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_NonObservableReferenceModel(@Nonnull final Locator locator) {
    super();
  ...
  private void $$arezi$$_link_myEntity() {
    ...
    if ( null == this.$$arezr$$_myEntity ) {
      ...
      this.$$arezr$$_myEntity = this.$$arezi$$_locator().getById( NonObservableReferenceModel.MyEntity.class, id );
      if ( Arez.shouldCheckApiInvariants() ) {
