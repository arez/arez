...
final class Arez_LazyLoadObservableReferenceModel extends LazyLoadObservableReferenceModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_LazyLoadObservableReferenceModel(@Nonnull final Locator locator) {
    super();
  ...
  private void $$arezi$$_link_myEntity() {
    ...
    if ( null == this.$$arezr$$_myEntity ) {
      ...
      this.$$arezr$$_myEntity = this.$$arezi$$_locator().getById( LazyLoadObservableReferenceModel.MyEntity.class, id );
      if ( Arez.shouldCheckApiInvariants() ) {
