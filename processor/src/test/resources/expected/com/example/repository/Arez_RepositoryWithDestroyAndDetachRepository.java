...
@Singleton
final class Arez_RepositoryWithDestroyAndDetachRepository extends RepositoryWithDestroyAndDetachRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithDestroyAndDetachRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithDestroyAndDetachRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> super.preDispose() ) : null;
