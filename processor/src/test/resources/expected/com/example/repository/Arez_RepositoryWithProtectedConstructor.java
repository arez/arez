...
final class Arez_RepositoryWithProtectedConstructor extends RepositoryWithProtectedConstructor implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_RepositoryWithProtectedConstructor(@Nonnull final String name) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithProtectedConstructor." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithProtectedConstructor", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
