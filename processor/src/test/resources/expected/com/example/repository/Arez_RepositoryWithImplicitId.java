...
final class Arez_RepositoryWithImplicitId extends RepositoryWithImplicitId implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_RepositoryWithImplicitId(@Nonnull final String packageName, @Nonnull final String name) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithImplicitId", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
