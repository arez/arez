...
final class Arez_RepositoryWithAttachOnly extends RepositoryWithAttachOnly implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_RepositoryWithAttachOnly(@Nonnull final String name) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "RepositoryWithAttachOnly", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
