...
@Singleton
final class Arez_RepositoryWithDetachNoneRepository extends RepositoryWithDetachNoneRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithDetachNoneRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithDetachNoneRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> super.preDispose() ) : null;
