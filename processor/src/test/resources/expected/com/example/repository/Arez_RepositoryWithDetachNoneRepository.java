...
@Singleton
final class Arez_RepositoryWithDetachNoneRepository extends RepositoryWithDetachNoneRepository implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  Arez_RepositoryWithDetachNoneRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithDetachNoneRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getContainerName() : null, () -> super.preDispose() ) : null;
  ...
  protected final String getContainerName() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getContainerName' invoked on uninitialized component of type 'RepositoryWithDetachNoneRepository'" );
    }
