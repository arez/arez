...
final class Arez_InjectEnabledRepository extends InjectEnabledRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeNotifier {
  ...
  Arez_InjectEnabledRepository(@Nonnull final String name) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "InjectEnabledRepository", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
