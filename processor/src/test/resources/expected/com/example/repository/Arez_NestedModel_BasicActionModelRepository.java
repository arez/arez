...
@Singleton
final class Arez_NestedModel_BasicActionModelRepository extends NestedModel_BasicActionModelRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_NestedModel_BasicActionModelRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "NestedModel_BasicActionModelRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> super.preDispose() ) : null;
