...
final class Arez_RepositoryWithAttachOnlyRepository extends RepositoryWithAttachOnlyRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithAttachOnlyRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithAttachOnlyRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithAttachOnlyRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
