...
public final class Arez_RepositoryWithImplicitIdRepository extends RepositoryWithImplicitIdRepository implements Disposable {
  ...
  Arez_RepositoryWithImplicitIdRepository() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "RepositoryWithImplicitIdRepository", $$arez$$_id(), $$arez$$_name(), () -> super.preDispose(), null ) : null;
