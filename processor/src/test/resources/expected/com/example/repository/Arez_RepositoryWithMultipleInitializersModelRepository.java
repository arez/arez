...
final class Arez_RepositoryWithMultipleInitializersModelRepository extends RepositoryWithMultipleInitializersModelRepository implements Disposable, Identifiable<Integer> {
  ...
  public RepositoryWithMultipleInitializersModel create(final long time, final long value) {
    ...
    try {
      return this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".create" : null, () -> super.create( time, value ), Flags.READ_WRITE | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { time, value } : null );
    } catch( final RuntimeException | Error $$arez_exception$$ ) {
      throw $$arez_exception$$;
    } catch( final Throwable $$arez_exception$$ ) {
      throw new IllegalStateException( $$arez_exception$$ );
