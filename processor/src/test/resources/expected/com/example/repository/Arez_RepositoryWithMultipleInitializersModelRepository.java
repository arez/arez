...
final class Arez_RepositoryWithMultipleInitializersModelRepository extends RepositoryWithMultipleInitializersModelRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithMultipleInitializersModelRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithMultipleInitializersModelRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithMultipleInitializersModelRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
  ...
  public RepositoryWithMultipleInitializersModel create(final long time, final long value) {
    ...
    return this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".create" : null, () -> super.create( time, value ), Flags.READ_WRITE | Flags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { time, value } : null );
  }
