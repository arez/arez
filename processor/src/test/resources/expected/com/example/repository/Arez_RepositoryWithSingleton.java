...
public final class Arez_RepositoryWithSingleton extends RepositoryWithSingleton implements Disposable {
  ...
  Arez_RepositoryWithSingleton(@Nonnull final String name) {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "RepositoryWithSingleton", $$arez$$_id(), $$arez$$_name(), () -> $$arez$$_preDispose(), null ) : null;
