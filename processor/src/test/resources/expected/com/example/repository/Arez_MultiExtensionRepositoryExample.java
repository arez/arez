...
final class Arez_MultiExtensionRepositoryExample extends MultiExtensionRepositoryExample implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeNotifier {
  ...
  Arez_MultiExtensionRepositoryExample(@Nonnull final String name) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "MultiExtensionRepositoryExample." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "MultiExtensionRepositoryExample", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( o instanceof Arez_MultiExtensionRepositoryExample ) {
      final Arez_MultiExtensionRepositoryExample that = (Arez_MultiExtensionRepositoryExample) o;
