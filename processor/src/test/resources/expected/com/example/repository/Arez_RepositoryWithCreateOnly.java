...
final class Arez_RepositoryWithCreateOnly extends RepositoryWithCreateOnly implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_RepositoryWithCreateOnly(@Nonnull final String name) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithCreateOnly", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
