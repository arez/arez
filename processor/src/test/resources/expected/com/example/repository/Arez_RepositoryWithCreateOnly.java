...
final class Arez_RepositoryWithCreateOnly extends RepositoryWithCreateOnly implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithCreateOnly(@Nonnull final String name) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithCreateOnly", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
