...
final class Arez_RepositoryWithExplicitNonStandardId extends RepositoryWithExplicitNonStandardId implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithExplicitNonStandardId(@Nonnull final String packageName,
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithExplicitNonStandardId", object_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'RepositoryWithExplicitNonStandardId'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'RepositoryWithExplicitNonStandardId'" );
    }
