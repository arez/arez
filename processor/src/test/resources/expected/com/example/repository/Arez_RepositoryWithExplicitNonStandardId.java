...
final class Arez_RepositoryWithExplicitNonStandardId extends RepositoryWithExplicitNonStandardId implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_RepositoryWithExplicitNonStandardId(@Nonnull final String packageName,
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithExplicitNonStandardId", object_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
