...
final class Arez_RepositoryWithCreateOrAttach extends RepositoryWithCreateOrAttach implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithCreateOrAttach(@Nonnull final String name) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithCreateOrAttach", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
