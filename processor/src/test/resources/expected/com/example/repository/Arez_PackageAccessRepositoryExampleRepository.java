...
final class Arez_PackageAccessRepositoryExampleRepository extends PackageAccessRepositoryExampleRepository implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  Arez_PackageAccessRepositoryExampleRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "PackageAccessRepositoryExampleRepository", $$arezi$$_id(), getRepositoryName(), () -> super.preDispose(), null ) : null;
  ...
  protected final String getRepositoryName() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getRepositoryName' invoked on uninitialized component of type 'PackageAccessRepositoryExampleRepository'" );
    }
