...
final class Arez_PackageAccessRepositoryExampleRepository extends PackageAccessRepositoryExampleRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_PackageAccessRepositoryExampleRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "PackageAccessRepositoryExampleRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> super.preDispose() ) : null;
