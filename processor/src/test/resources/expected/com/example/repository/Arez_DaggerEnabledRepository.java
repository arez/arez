...
final class Arez_DaggerEnabledRepository extends DaggerEnabledRepository implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  Arez_DaggerEnabledRepository(@Nonnull final String name) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "DaggerEnabledRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
