...
final class Arez_DaggerEnabledRepository extends DaggerEnabledRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_DaggerEnabledRepository(@Nonnull final String name) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "DaggerEnabledRepository." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "DaggerEnabledRepository", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
