...
@Singleton
final class Arez_DaggerDisabledRepositoryRepository extends DaggerDisabledRepositoryRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_DaggerDisabledRepositoryRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "DaggerDisabledRepositoryRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> super.preDispose() ) : null;
