...
final class Arez_PackageAccessRepositoryExample extends PackageAccessRepositoryExample implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeNotifier {
  ...
  Arez_PackageAccessRepositoryExample(@Nonnull final String packageName,
    ...
    this.$$arez$$_qualifiedName = $$arezv$$_context.computable( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".qualifiedName" : null, () -> super.getQualifiedName(), Flags.AREZ_DEPENDENCIES | Flags.RUN_LATER );
