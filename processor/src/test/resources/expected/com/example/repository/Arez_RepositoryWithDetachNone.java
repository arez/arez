...
final class Arez_RepositoryWithDetachNone extends RepositoryWithDetachNone implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithDetachNone(@Nonnull final String name) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithDetachNone", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
