...
public final class Arez_RepositoryWithInitializerModel extends RepositoryWithInitializerModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_RepositoryWithInitializerModel(final long time) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithInitializerModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
