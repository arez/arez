...
final class Arez_RepositoryWithProtectedConstructorRepository extends RepositoryWithProtectedConstructorRepository implements Disposable, Identifiable<Long> {
  ...
  Arez_RepositoryWithProtectedConstructorRepository() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "RepositoryWithProtectedConstructorRepository", $$arez$$_id(), $$arez$$_name(), () -> super.preDispose(), null ) : null;
