...
final class Arez_RepositoryWithProtectedConstructorRepository extends RepositoryWithProtectedConstructorRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithProtectedConstructorRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithProtectedConstructorRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithProtectedConstructorRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
