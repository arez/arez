...
final class Arez_DaggerDisabledRepository extends DaggerDisabledRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_DaggerDisabledRepository(@Nonnull final String name) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "DaggerDisabledRepository." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "DaggerDisabledRepository", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
