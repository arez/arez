...
final class Arez_InjectDisabledRepositoryRepository extends InjectDisabledRepositoryRepository implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  Arez_InjectDisabledRepositoryRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "InjectDisabledRepositoryRepository", $$arezi$$_id(), getRepositoryName(), () -> super.preDispose(), null ) : null;
  ...
  protected final String getRepositoryName() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getRepositoryName' invoked on uninitialized component of type 'InjectDisabledRepositoryRepository'" );
    }
