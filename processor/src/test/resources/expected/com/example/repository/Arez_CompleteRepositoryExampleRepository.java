...
@Singleton
final class Arez_CompleteRepositoryExampleRepository extends CompleteRepositoryExampleRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_CompleteRepositoryExampleRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "CompleteRepositoryExampleRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
