...
final class Arez_RepositoryWithInitializerNameCollisionModel extends RepositoryWithInitializerNameCollisionModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_RepositoryWithInitializerNameCollisionModel(final int time, final long $$arezip$$_time) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithInitializerNameCollisionModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
