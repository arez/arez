...
@Singleton
final class Arez_RepositoryWithExplicitNonStandardIdRepository extends RepositoryWithExplicitNonStandardIdRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithExplicitNonStandardIdRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithExplicitNonStandardIdRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> super.preDispose() ) : null;
