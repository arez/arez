...
final class Arez_RepositoryWithExplicitNonStandardIdRepository extends RepositoryWithExplicitNonStandardIdRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithExplicitNonStandardIdRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithExplicitNonStandardIdRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithExplicitNonStandardIdRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
