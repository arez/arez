...
final class Arez_RepositoryWithExplicitNonStandardIdRepository extends RepositoryWithExplicitNonStandardIdRepository implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  Arez_RepositoryWithExplicitNonStandardIdRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithExplicitNonStandardIdRepository", $$arezi$$_id(), getContainerName(), () -> super.preDispose() ) : null;
