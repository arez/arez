...
@Singleton
final class Arez_RepositoryWithMultipleCtorsRepository extends RepositoryWithMultipleCtorsRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  @Nonnull
  private final Observable<Stream<RepositoryWithMultipleCtors>> $$arez$$_entities;
  ...
  Arez_RepositoryWithMultipleCtorsRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithMultipleCtorsRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  public RepositoryWithMultipleCtors create() {
    ...
    try {
      return $$arezi$$_context().safeAction(Arez.areNamesEnabled() ? $$arezi$$_name() + ".create" : null, true, () -> super.create() );
    } catch( final RuntimeException | Error $$arez_exception$$ ) {
      throw $$arez_exception$$;
    } catch( final Throwable $$arez_exception$$ ) {
      throw new IllegalStateException( $$arez_exception$$ );
