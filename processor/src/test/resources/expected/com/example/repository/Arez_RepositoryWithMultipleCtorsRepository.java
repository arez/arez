...
final class Arez_RepositoryWithMultipleCtorsRepository extends RepositoryWithMultipleCtorsRepository implements Disposable, Identifiable<Long> {
  ...
  Arez_RepositoryWithMultipleCtorsRepository() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithMultipleCtorsRepository", $$arez$$_id(), $$arez$$_name(), () -> super.preDispose(), null ) : null;
  ...
  RepositoryWithMultipleCtors create(@Nonnull final String packageName,
    ...
    Guards.invariant( () -> !this.$$arez$$_disposed, () -> "Method invoked on invalid component '" + $$arez$$_name() + "'" );
    try {
      return getContext().safeAction(Arez.areNamesEnabled() ? $$arez$$_name() + ".create_packageName_name" : null, true, () -> super.create(packageName,name), packageName, name );
    } catch( final RuntimeException $$arez$$_e ) {
      throw $$arez$$_e;
    } catch( final Exception $$arez$$_e ) {
      throw new IllegalStateException( $$arez$$_e );
