...
final class Arez_RepositoryWithMultipleCtorsRepository extends RepositoryWithMultipleCtorsRepository implements Disposable, Identifiable<Long> {
  ...
  Arez_RepositoryWithMultipleCtorsRepository() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "RepositoryWithMultipleCtorsRepository", $$arez$$_id(), $$arez$$_name(), () -> super.preDispose(), null ) : null;
