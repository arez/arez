...
final class Arez_RepositoryWithDestroyAndDetach extends RepositoryWithDestroyAndDetach implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithDestroyAndDetach(@Nonnull final String name) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithDestroyAndDetach", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'RepositoryWithDestroyAndDetach'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'RepositoryWithDestroyAndDetach'" );
    }
    return "RepositoryWithDestroyAndDetach." + $$arezi$$_id();
  }
  ...
  public final boolean equals(final Object o) {
    if ( this == o ) {
      return true;
    } else if ( null == o || !(o instanceof Arez_RepositoryWithDestroyAndDetach) ) {
      return false;
    } else {
