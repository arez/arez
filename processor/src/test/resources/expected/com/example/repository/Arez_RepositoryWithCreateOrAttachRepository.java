...
@Singleton
final class Arez_RepositoryWithCreateOrAttachRepository extends RepositoryWithCreateOrAttachRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  @Nonnull
  private final Observable<Stream<RepositoryWithCreateOrAttach>> $$arez$$_entities;
  ...
  Arez_RepositoryWithCreateOrAttachRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithCreateOrAttachRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  public void attach(@Nonnull final RepositoryWithCreateOrAttach entity) {
    ...
    try {
      $$arezi$$_context().safeAction(Arez.areNamesEnabled() ? $$arezi$$_name() + ".attach" : null, true, () -> super.attach(entity) );
