...
@Singleton
final class Arez_RepositoryWithCreateOrAttachRepository extends RepositoryWithCreateOrAttachRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithCreateOrAttachRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithCreateOrAttachRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> super.preDispose() ) : null;
