...
final class Arez_RepositoryWithCreateOrAttachRepository extends RepositoryWithCreateOrAttachRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithCreateOrAttachRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithCreateOrAttachRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithCreateOrAttachRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
  ...
  public void attach(@Nonnull final RepositoryWithCreateOrAttach entity) {
    ...
    this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".attach" : null, () -> super.attach( entity ), Flags.READ_WRITE | Flags.VERIFY_ACTION_REQUIRED, null );
  }
