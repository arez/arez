...
@Singleton
final class Arez_RepositoryWithCreateOrAttachRepository extends RepositoryWithCreateOrAttachRepository implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  Arez_RepositoryWithCreateOrAttachRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithCreateOrAttachRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getContainerName() : null, () -> super.preDispose() ) : null;
  ...
  protected final ArezContext getContext() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getContext' invoked on uninitialized component of type 'RepositoryWithCreateOrAttachRepository'" );
    }
  ...
  protected final Component component() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'component' invoked on uninitialized component of type 'RepositoryWithCreateOrAttachRepository'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  protected final String getContainerName() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getContainerName' invoked on uninitialized component of type 'RepositoryWithCreateOrAttachRepository'" );
    }
  ...
  public void attach(@Nonnull final RepositoryWithCreateOrAttach entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.isActive( this.$$arezi$$_state ), () -> "Method named 'attach' invoked on " + ComponentState.describe( this.$$arezi$$_state ) + " component named '" + getContainerName() + "'" );
    }
    try {
      getContext().safeAction(Arez.areNamesEnabled() ? getContainerName() + ".attach" : null, true, () -> super.attach(entity) );
