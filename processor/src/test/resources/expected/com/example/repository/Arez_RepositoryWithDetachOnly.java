...
final class Arez_RepositoryWithDetachOnly extends RepositoryWithDetachOnly implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithDetachOnly(@Nonnull final String name) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithDetachOnly", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
