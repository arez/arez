...
@Singleton
final class Arez_InjectEnabledRepositoryRepository extends InjectEnabledRepositoryRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  @Nonnull
  private final Observable<Stream<InjectEnabledRepository>> $$arez$$_entities;
  ...
  Arez_InjectEnabledRepositoryRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "InjectEnabledRepositoryRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
