...
final class Arez_InjectEnabledRepositoryRepository extends InjectEnabledRepositoryRepository implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  Arez_InjectEnabledRepositoryRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "InjectEnabledRepositoryRepository", $$arezi$$_id(), getRepositoryName(), () -> super.preDispose() ) : null;
