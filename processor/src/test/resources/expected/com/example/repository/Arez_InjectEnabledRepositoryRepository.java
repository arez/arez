...
final class Arez_InjectEnabledRepositoryRepository extends InjectEnabledRepositoryRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_InjectEnabledRepositoryRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "InjectEnabledRepositoryRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  protected final String getName() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getName' invoked on uninitialized component of type 'InjectEnabledRepositoryRepository'" );
    }
