...
final class Arez_InjectEnabledRepositoryRepository extends InjectEnabledRepositoryRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_InjectEnabledRepositoryRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "InjectEnabledRepositoryRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "InjectEnabledRepositoryRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
