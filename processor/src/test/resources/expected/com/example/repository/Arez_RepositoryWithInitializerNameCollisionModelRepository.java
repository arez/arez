...
final class Arez_RepositoryWithInitializerNameCollisionModelRepository extends RepositoryWithInitializerNameCollisionModelRepository implements Disposable, Identifiable<Integer> {
  ...
  public RepositoryWithInitializerNameCollisionModel create(final int time,
    ...
    try {
      return this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".create_time" : null, () -> super.create( time, $$arezip$$_time ), Flags.READ_WRITE | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { time, $$arezip$$_time } : null );
    } catch( final RuntimeException | Error $$arez_exception$$ ) {
      throw $$arez_exception$$;
    } catch( final Throwable $$arez_exception$$ ) {
      throw new IllegalStateException( $$arez_exception$$ );
