...
final class Arez_RepositoryWithInitializerNameCollisionModelRepository extends RepositoryWithInitializerNameCollisionModelRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithInitializerNameCollisionModelRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithInitializerNameCollisionModelRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithInitializerNameCollisionModelRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
  ...
  public RepositoryWithInitializerNameCollisionModel create(final int time,
    ...
    return this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".create_time" : null, () -> super.create( time, $$arezip$$_time ), Flags.READ_WRITE | Flags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { time, $$arezip$$_time } : null );
  }
