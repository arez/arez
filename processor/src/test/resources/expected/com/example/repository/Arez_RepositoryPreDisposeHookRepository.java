...
final class Arez_RepositoryPreDisposeHookRepository extends RepositoryPreDisposeHookRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_RepositoryPreDisposeHookRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryPreDisposeHookRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  protected final String getName() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getName' invoked on uninitialized component of type 'RepositoryPreDisposeHookRepository'" );
    }
