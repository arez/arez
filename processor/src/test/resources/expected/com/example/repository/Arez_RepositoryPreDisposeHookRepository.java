...
final class Arez_RepositoryPreDisposeHookRepository extends RepositoryPreDisposeHookRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryPreDisposeHookRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryPreDisposeHookRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryPreDisposeHookRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
