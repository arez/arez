...
final class Arez_RepositoryWithDetachOnlyRepository extends RepositoryWithDetachOnlyRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_RepositoryWithDetachOnlyRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithDetachOnlyRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  protected final String getName() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getName' invoked on uninitialized component of type 'RepositoryWithDetachOnlyRepository'" );
    }
  ...
  public void detach(@Nonnull final RepositoryWithDetachOnly entity) {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.isActive( this.$$arezi$$_state ), () -> "Method named 'detach' invoked on " + ComponentState.describe( this.$$arezi$$_state ) + " component named '" + getName() + "'" );
    }
    try {
      getContext().safeAction(Arez.areNamesEnabled() ? getName() + ".detach" : null, true, () -> super.detach(entity) );
