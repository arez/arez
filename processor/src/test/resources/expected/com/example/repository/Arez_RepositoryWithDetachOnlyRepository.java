...
@Singleton
final class Arez_RepositoryWithDetachOnlyRepository extends RepositoryWithDetachOnlyRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithDetachOnlyRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithDetachOnlyRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> super.preDispose() ) : null;
