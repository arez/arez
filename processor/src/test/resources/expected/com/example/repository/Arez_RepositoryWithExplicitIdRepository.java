...
final class Arez_RepositoryWithExplicitIdRepository extends RepositoryWithExplicitIdRepository implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  Arez_RepositoryWithExplicitIdRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithExplicitIdRepository", $$arezi$$_id(), getRepositoryName(), () -> super.preDispose(), null ) : null;
  ...
  protected final String getRepositoryName() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getRepositoryName' invoked on uninitialized component of type 'RepositoryWithExplicitIdRepository'" );
    }
