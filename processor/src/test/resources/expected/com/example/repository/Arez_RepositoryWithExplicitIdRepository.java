...
public final class Arez_RepositoryWithExplicitIdRepository extends RepositoryWithExplicitIdRepository implements Disposable {
  ...
  Arez_RepositoryWithExplicitIdRepository() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "RepositoryWithExplicitIdRepository", $$arez$$_id(), $$arez$$_name(), () -> super.preDispose(), null ) : null;
