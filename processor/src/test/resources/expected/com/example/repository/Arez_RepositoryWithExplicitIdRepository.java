...
final class Arez_RepositoryWithExplicitIdRepository extends RepositoryWithExplicitIdRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithExplicitIdRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryWithExplicitIdRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryWithExplicitIdRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
