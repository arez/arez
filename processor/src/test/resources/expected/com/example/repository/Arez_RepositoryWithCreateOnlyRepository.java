...
final class Arez_RepositoryWithCreateOnlyRepository extends RepositoryWithCreateOnlyRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithCreateOnlyRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithCreateOnlyRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> super.preDispose() ) : null;
