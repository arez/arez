...
@Singleton
final class Arez_RepositoryWithCreateOnlyRepository extends RepositoryWithCreateOnlyRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  @Nonnull
  private final Observable<Stream<RepositoryWithCreateOnly>> $$arez$$_entities;
  ...
  Arez_RepositoryWithCreateOnlyRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithCreateOnlyRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
