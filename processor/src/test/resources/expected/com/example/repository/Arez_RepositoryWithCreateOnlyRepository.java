...
@Singleton
final class Arez_RepositoryWithCreateOnlyRepository extends RepositoryWithCreateOnlyRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_RepositoryWithCreateOnlyRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithCreateOnlyRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> super.preDispose() ) : null;
