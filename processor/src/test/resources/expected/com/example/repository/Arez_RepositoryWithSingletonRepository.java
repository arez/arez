...
@Singleton
final class Arez_RepositoryWithSingletonRepository extends RepositoryWithSingletonRepository implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_RepositoryWithSingletonRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithSingletonRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
