...
final class Arez_RepositoryWithSingletonRepository extends RepositoryWithSingletonRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithSingletonRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithSingletonRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> super.preDispose() ) : null;
