...
@Singleton
final class Arez_RepositoryWithInitializerModelRepository extends RepositoryWithInitializerModelRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  @Nonnull
  private final Observable<Stream<RepositoryWithInitializerModel>> $$arez$$_entities;
  ...
  Arez_RepositoryWithInitializerModelRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithInitializerModelRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  public RepositoryWithInitializerModel create(final long time) {
    ...
    try {
      return $$arezi$$_context().safeAction(Arez.areNamesEnabled() ? $$arezi$$_name() + ".create" : null, true, () -> super.create(time), time );
    } catch( final RuntimeException | Error $$arez_exception$$ ) {
      throw $$arez_exception$$;
    } catch( final Throwable $$arez_exception$$ ) {
      throw new IllegalStateException( $$arez_exception$$ );
