...
final class Arez_RepositoryWithInitializerModelRepository extends RepositoryWithInitializerModelRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryWithInitializerModelRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RepositoryWithInitializerModelRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> super.preDispose() ) : null;
