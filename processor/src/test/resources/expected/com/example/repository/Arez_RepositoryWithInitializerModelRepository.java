...
@Singleton
final class Arez_RepositoryWithInitializerModelRepository extends RepositoryWithInitializerModelRepository implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  Arez_RepositoryWithInitializerModelRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "RepositoryWithInitializerModelRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getContainerName() : null, () -> super.preDispose() ) : null;
  ...
  protected final ArezContext getContext() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getContext' invoked on uninitialized component of type 'RepositoryWithInitializerModelRepository'" );
    }
  ...
  protected final Component component() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'component' invoked on uninitialized component of type 'RepositoryWithInitializerModelRepository'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  protected final String getContainerName() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getContainerName' invoked on uninitialized component of type 'RepositoryWithInitializerModelRepository'" );
    }
  ...
  @Override
  public void destroy(@Nonnull final RepositoryWithInitializerModel arg0) {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public RepositoryWithInitializerModel create(final long time) {
    ...
    try {
      return getContext().safeAction(Arez.areNamesEnabled() ? getContainerName() + ".create" : null, true, () -> super.create(time), time );
    } catch( final RuntimeException | Error $$arez_exception$$ ) {
      throw $$arez_exception$$;
    } catch( final Throwable $$arez_exception$$ ) {
      throw new IllegalStateException( $$arez_exception$$ );
