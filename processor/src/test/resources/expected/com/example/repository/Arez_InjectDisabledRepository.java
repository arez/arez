...
final class Arez_InjectDisabledRepository extends InjectDisabledRepository implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_InjectDisabledRepository(@Nonnull final String name) {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "InjectDisabledRepository." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "InjectDisabledRepository", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
