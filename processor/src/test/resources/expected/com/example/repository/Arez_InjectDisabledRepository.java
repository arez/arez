...
final class Arez_InjectDisabledRepository extends InjectDisabledRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_InjectDisabledRepository(@Nonnull final String name) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "InjectDisabledRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
