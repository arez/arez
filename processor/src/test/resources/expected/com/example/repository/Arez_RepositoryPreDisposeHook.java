...
final class Arez_RepositoryPreDisposeHook extends RepositoryPreDisposeHook implements Disposable {
  ...
  Arez_RepositoryPreDisposeHook(@Nonnull final String name) {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "RepositoryPreDisposeHook", $$arez$$_id(), $$arez$$_name(), () -> $$arez$$_preDispose(), () -> super.myPostDispose() ) : null;
