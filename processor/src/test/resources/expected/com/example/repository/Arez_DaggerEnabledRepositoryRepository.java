...
@Singleton
final class Arez_DaggerEnabledRepositoryRepository extends DaggerEnabledRepositoryRepository implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_DaggerEnabledRepositoryRepository() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "DaggerEnabledRepositoryRepository", $$arezi$$_id(), Arez.areNamesEnabled() ? getName() : null, () -> super.preDispose() ) : null;
