...
final class Arez_DaggerEnabledRepositoryRepository extends DaggerEnabledRepositoryRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_DaggerEnabledRepositoryRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "DaggerEnabledRepositoryRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "DaggerEnabledRepositoryRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
