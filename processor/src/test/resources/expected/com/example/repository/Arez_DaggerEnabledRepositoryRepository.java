...
final class Arez_DaggerEnabledRepositoryRepository extends DaggerEnabledRepositoryRepository implements Disposable, Identifiable<Long> {
  ...
  Arez_DaggerEnabledRepositoryRepository() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? getContext().createComponent( "DaggerEnabledRepositoryRepository", $$arez$$_id(), $$arez$$_name(), () -> super.preDispose(), null ) : null;
