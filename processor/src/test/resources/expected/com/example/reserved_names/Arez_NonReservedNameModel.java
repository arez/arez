...
public final class Arez_NonReservedNameModel extends NonReservedNameModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_NonReservedNameModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "NonReservedNameModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
