...
public final class Arez_ComputedNonnullMapModel extends ComputedNonnullMapModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ComputedNonnullMapModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ComputedNonnullMapModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
