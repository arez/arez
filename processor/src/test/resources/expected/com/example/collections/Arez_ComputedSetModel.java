...
public final class Arez_ComputedSetModel extends ComputedSetModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ComputedSetModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ComputedSetModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
