...
public final class Arez_ObservableNonnullSetModel extends ObservableNonnullSetModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ObservableNonnullSetModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservableNonnullSetModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
