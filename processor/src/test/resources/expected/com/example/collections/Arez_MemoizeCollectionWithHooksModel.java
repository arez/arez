...
public final class Arez_MemoizeCollectionWithHooksModel extends MemoizeCollectionWithHooksModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_MemoizeCollectionWithHooksModel() {
    super();
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "MemoizeCollectionWithHooksModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
    this.$$arezi$$_disposeNotifier = new DisposeNotifier();
    this.$$arez$$_time = $$arezi$$_context().computable( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".time" : null, () -> super.getTime(), this::$$arezi$$_onActivate_time, this::$$arezi$$_onDeactivate_time, this::$$arezi$$_onStale_time, Flags.PRIORITY_NORMAL | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.AREZ_DEPENDENCIES | Flags.RUN_LATER );
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'MemoizeCollectionWithHooksModel'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'MemoizeCollectionWithHooksModel'" );
    }
    return "MemoizeCollectionWithHooksModel." + $$arezi$$_id();
  }
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( this == o ) {
        return true;
      } else if ( null == o || !(o instanceof Arez_MemoizeCollectionWithHooksModel) ) {
        return false;
      } else {
