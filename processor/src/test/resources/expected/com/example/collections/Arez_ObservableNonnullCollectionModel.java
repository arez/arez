...
public final class Arez_ObservableNonnullCollectionModel extends ObservableNonnullCollectionModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ObservableNonnullCollectionModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservableNonnullCollectionModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
