...
public final class Arez_AbstractCollectionObservableModel extends AbstractCollectionObservableModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_AbstractCollectionObservableModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "AbstractCollectionObservableModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_AbstractCollectionObservableModel ) {
