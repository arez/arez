...
public final class Arez_ComputedMapModel extends ComputedMapModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ComputedMapModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ComputedMapModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
