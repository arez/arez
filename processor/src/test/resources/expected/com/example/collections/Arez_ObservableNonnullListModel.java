...
public final class Arez_ObservableNonnullListModel extends ObservableNonnullListModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ObservableNonnullListModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservableNonnullListModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
