...
public final class Arez_AbstractMapObservableModel extends AbstractMapObservableModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_AbstractMapObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractMapObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
