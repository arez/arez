...
public final class Arez_ComputedCollectionModel extends ComputedCollectionModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ComputedCollectionModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ComputedCollectionModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
