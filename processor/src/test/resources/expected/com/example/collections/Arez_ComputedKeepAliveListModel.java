...
public final class Arez_ComputedKeepAliveListModel extends ComputedKeepAliveListModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ComputedKeepAliveListModel() {
    ...
    this.$$arez$$_myValue = Arez.areCollectionsPropertiesUnmodifiable() ? $$arezi$$_context().computed( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".myValue" : null, () -> super.getMyValue(), this::$$arezi$$_onActivate_myValue, this::$$arezi$$_onDeactivate_myValue, this::$$arezi$$_onStale_myValue, Flags.DEFER_REACT | Flags.KEEPALIVE ) : $$arezi$$_context().computed( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".myValue" : null, () -> super.getMyValue(), Flags.DEFER_REACT | Flags.KEEPALIVE );
    if ( Arez.shouldCheckApiInvariants() ) {
