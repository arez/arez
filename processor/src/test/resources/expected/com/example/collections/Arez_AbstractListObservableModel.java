...
public final class Arez_AbstractListObservableModel extends AbstractListObservableModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_AbstractListObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractListObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
