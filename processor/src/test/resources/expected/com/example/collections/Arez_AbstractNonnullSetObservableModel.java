...
public final class Arez_AbstractNonnullSetObservableModel extends AbstractNonnullSetObservableModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_AbstractNonnullSetObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractNonnullSetObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
