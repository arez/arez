...
public final class Arez_AbstractNonnullSetObservableModel extends AbstractNonnullSetObservableModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_AbstractNonnullSetObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "AbstractNonnullSetObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
