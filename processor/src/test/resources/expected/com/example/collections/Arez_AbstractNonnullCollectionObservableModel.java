...
public final class Arez_AbstractNonnullCollectionObservableModel extends AbstractNonnullCollectionObservableModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_AbstractNonnullCollectionObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "AbstractNonnullCollectionObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
