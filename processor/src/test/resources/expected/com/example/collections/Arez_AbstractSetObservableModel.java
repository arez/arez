...
public final class Arez_AbstractSetObservableModel extends AbstractSetObservableModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_AbstractSetObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractSetObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
