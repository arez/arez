...
public final class Arez_AbstractSetObservableModel extends AbstractSetObservableModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_AbstractSetObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "AbstractSetObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
