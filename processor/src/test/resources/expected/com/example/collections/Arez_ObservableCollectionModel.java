...
public final class Arez_ObservableCollectionModel extends ObservableCollectionModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ObservableCollectionModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservableCollectionModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
