...
public final class Arez_ObservableSetModel extends ObservableSetModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ObservableSetModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservableSetModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
