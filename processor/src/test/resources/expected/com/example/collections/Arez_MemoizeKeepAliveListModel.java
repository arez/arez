...
public final class Arez_MemoizeKeepAliveListModel extends MemoizeKeepAliveListModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_MemoizeKeepAliveListModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "MemoizeKeepAliveListModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'MemoizeKeepAliveListModel'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'MemoizeKeepAliveListModel'" );
    }
    return "MemoizeKeepAliveListModel." + $$arezi$$_id();
  }
