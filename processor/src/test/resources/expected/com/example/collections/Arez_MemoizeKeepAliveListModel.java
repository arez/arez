...
public final class Arez_MemoizeKeepAliveListModel extends MemoizeKeepAliveListModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public Arez_MemoizeKeepAliveListModel() {
    ...
    this.$$arez$$_myValue = Arez.areCollectionsPropertiesUnmodifiable() ? $$arezv$$_context.computable( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".myValue" : null, () -> super.getMyValue(), this::$$arezi$$_onActivate_myValue, this::$$arezi$$_onDeactivate_myValue, this::$$arezi$$_onStale_myValue, Flags.AREZ_DEPENDENCIES | Flags.RUN_LATER | Flags.KEEPALIVE ) : $$arezv$$_context.computable( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".myValue" : null, () -> super.getMyValue(), Flags.AREZ_DEPENDENCIES | Flags.RUN_LATER | Flags.KEEPALIVE );
