...
public final class Arez_GenericObservableRefModel extends GenericObservableRefModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_GenericObservableRefModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "GenericObservableRefModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
