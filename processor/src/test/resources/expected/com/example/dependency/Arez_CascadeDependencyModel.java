...
public final class Arez_CascadeDependencyModel extends CascadeDependencyModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_CascadeDependencyModel() {
    super();
    this.$$arezi$$_context = Arez.areZonesEnabled() ? Arez.context() : null;
    this.$$arezi$$_id = $$arezi$$_nextId++;
    this.$$arezi$$_state = ComponentState.COMPONENT_INITIALIZED;
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "CascadeDependencyModel", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method invoked on uninitialized component of type 'CascadeDependencyModel'" );
    }
  ...
  String $$arezi$$_name() {
    ...
    return "CascadeDependencyModel." + $$arezi$$_id();
  }
