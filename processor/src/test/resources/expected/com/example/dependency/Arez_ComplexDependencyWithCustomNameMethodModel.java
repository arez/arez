...
public final class Arez_ComplexDependencyWithCustomNameMethodModel extends ComplexDependencyWithCustomNameMethodModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_ComplexDependencyWithCustomNameMethodModel() {
    ...
    this.$$arez$$_value2 = $$arezi$$_context().createComputedValue( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? getComponentName() + ".value2" : null, () -> super.getValue2(), EqualityComparator.defaultComparator(), null, null, null, null, false, false, false );
