...
public final class Arez_AbstractObservableDependency extends AbstractObservableDependency implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_AbstractObservableDependency() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractObservableDependency", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method invoked on uninitialized component of type 'AbstractObservableDependency'" );
    }
  ...
  String $$arezi$$_name() {
    ...
    return "AbstractObservableDependency." + $$arezi$$_id();
  }
