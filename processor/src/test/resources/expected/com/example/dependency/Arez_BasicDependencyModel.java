...
public final class Arez_BasicDependencyModel extends BasicDependencyModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_BasicDependencyModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "BasicDependencyModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
