...
public final class Arez_ComplexDependencyModel extends ComplexDependencyModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_ComplexDependencyModel() {
    ...
    this.$$arez$$_value2 = $$arezi$$_context().createComputedValue( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".value2" : null, super::getValue2, EqualityComparator.defaultComparator(), null, null, null, null );
