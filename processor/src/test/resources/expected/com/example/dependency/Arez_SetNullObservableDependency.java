...
public final class Arez_SetNullObservableDependency extends SetNullObservableDependency implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_SetNullObservableDependency() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "SetNullObservableDependency", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
