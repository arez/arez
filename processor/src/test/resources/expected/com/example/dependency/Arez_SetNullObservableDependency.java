...
public final class Arez_SetNullObservableDependency extends SetNullObservableDependency implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  public Arez_SetNullObservableDependency() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "SetNullObservableDependency", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  private final void $$arezi$$_setNullOnDispose() {
    final DisposeTrackable dependency1 = getValue();
