...
public final class Arez_ObservablePairAnnotatedDependency extends ObservablePairAnnotatedDependency implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ObservablePairAnnotatedDependency() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservablePairAnnotatedDependency", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
