...
public final class Arez_ObservablePairAnnotatedDependency extends ObservablePairAnnotatedDependency implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ObservablePairAnnotatedDependency() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "ObservablePairAnnotatedDependency", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
