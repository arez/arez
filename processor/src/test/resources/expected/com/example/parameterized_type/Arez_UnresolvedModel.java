...
final class Arez_UnresolvedModel<X extends Number> extends UnresolvedModel<X> implements Disposable, Identifiable<Long> {
  ...
  Arez_UnresolvedModel() {
    ...
    this.$$arez$$_state = 1;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "UnresolvedModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    ...
    return "UnresolvedModel." + $$arez$$_id();
  }
