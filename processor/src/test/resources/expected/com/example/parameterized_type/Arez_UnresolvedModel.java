...
final class Arez_UnresolvedModel<X extends Number> extends UnresolvedModel<X> implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_UnresolvedModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "UnresolvedModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
