...
final class Arez_ResolvedModel extends ResolvedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_ResolvedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "ResolvedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
