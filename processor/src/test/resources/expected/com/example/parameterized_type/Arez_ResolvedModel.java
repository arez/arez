...
final class Arez_ResolvedModel extends ResolvedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_ResolvedModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ResolvedModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
