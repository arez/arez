...
final class Arez_MyModel extends MyModel implements Disposable, Identifiable<Long> {
  ...
  Arez_MyModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "MyModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  public void doOtherStuff() {
    ...
    try {
      $$arez$$_context().safeAction(Arez.areNamesEnabled() ? $$arez$$_name() + ".doOtherStuff" : null, true, () -> super.doOtherStuff() );
