...
final class Arez_MyModel extends MyModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_MyModel() {
    ...
    this.$$arez$$_myComputed = $$arezi$$_context().computed( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".myComputed" : null, () -> super.myComputed(), Flags.RUN_LATER );
    if ( Arez.shouldCheckApiInvariants() ) {
