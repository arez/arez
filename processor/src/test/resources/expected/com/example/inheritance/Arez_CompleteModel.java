...
public final class Arez_CompleteModel extends CompleteModel implements Disposable, Identifiable<Byte>, Verifiable, DisposeTrackable {
  ...
  public Arez_CompleteModel() {
    ...
    this.$$arez$$_myWatcher = getContext().observer( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? getComponentName() + ".myWatcher" : null, () -> super.myWatcher(), Flags.RUN_LATER | Flags.AREZ_DEPENDENCIES_ONLY );
    this.$$arez$$_render = getContext().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? getComponentName() + ".render" : null, () -> super.onRenderDepsChanged(), Flags.RUN_LATER | Flags.AREZ_DEPENDENCIES_ONLY );
  ...
  public void render(final long time, final float someOtherParameter) {
    ...
    try {
      getContext().safeObserve( this.$$arez$$_render, () -> super.render(time,someOtherParameter), time, someOtherParameter );
