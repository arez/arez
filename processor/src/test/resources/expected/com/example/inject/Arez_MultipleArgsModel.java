...
public final class Arez_MultipleArgsModel extends MultipleArgsModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_MultipleArgsModel(final int i, final String foo) {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "MultipleArgsModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "MultipleArgsModel." + $$arez$$_id();
  }
