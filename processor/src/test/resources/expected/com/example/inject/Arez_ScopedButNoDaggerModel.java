...
@Singleton
public final class Arez_ScopedButNoDaggerModel extends ScopedButNoDaggerModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ScopedButNoDaggerModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ScopedButNoDaggerModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
