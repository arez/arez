...
public final class Arez_ScopedButNoDaggerModel extends ScopedButNoDaggerModel implements Disposable, Identifiable<Integer> {
  ...
  public Arez_ScopedButNoDaggerModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "ScopedButNoDaggerModel" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ScopedButNoDaggerModel", $$arezv$$_id, $$arezv$$_name ) : null;
