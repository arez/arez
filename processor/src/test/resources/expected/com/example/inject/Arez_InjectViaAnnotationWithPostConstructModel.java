...
public final class Arez_InjectViaAnnotationWithPostConstructModel extends InjectViaAnnotationWithPostConstructModel implements Disposable, Identifiable<Integer> {
  ...
  Arez_InjectViaAnnotationWithPostConstructModel(@Nonnull final Enhancer $$arezi$$_enhancer) {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ( Arez.areRegistriesEnabled() || Arez.areNativeComponentsEnabled() ) ? ++$$arezi$$_nextId : 0;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "InjectViaAnnotationWithPostConstructModel" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "InjectViaAnnotationWithPostConstructModel", $$arezv$$_id, $$arezv$$_name ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_InjectViaAnnotationWithPostConstructModel ) {
        final Arez_InjectViaAnnotationWithPostConstructModel that = (Arez_InjectViaAnnotationWithPostConstructModel) o;
  ...
  interface Enhancer {
    void enhance(Arez_InjectViaAnnotationWithPostConstructModel component);
  }
}
