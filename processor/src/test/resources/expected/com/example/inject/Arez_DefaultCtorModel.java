...
public final class Arez_DefaultCtorModel extends DefaultCtorModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_DefaultCtorModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "DefaultCtorModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
