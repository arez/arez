...
@Singleton
public final class Arez_EnhancerNeededForConsumerModel extends EnhancerNeededForConsumerModel implements Disposable, Identifiable<Integer> {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  Arez_EnhancerNeededForConsumerModel(@Nonnull final Enhancer $$arezi$$_enhancer) {
    super();
    final ArezContext $$arezv$$_context = Arez.context();
    final int $$arezv$$_id = ( Arez.areRegistriesEnabled() || Arez.areNativeComponentsEnabled() ) ? ++$$arezi$$_nextId : 0;
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "EnhancerNeededForConsumerModel" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "EnhancerNeededForConsumerModel", $$arezv$$_id, $$arezv$$_name ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_EnhancerNeededForConsumerModel ) {
        final Arez_EnhancerNeededForConsumerModel that = (Arez_EnhancerNeededForConsumerModel) o;
  ...
  interface Enhancer {
    void enhance(Arez_EnhancerNeededForConsumerModel component);
  }
}
