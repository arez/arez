...
@Singleton
final class Arez_CtorInjectWithTrackingObserveModel extends CtorInjectWithTrackingObserveModel implements Disposable, Identifiable<Integer> {
  ...
  Arez_CtorInjectWithTrackingObserveModel(@Nonnull final Runnable action) {
    ...
    this.$$arez$$_autorun = $$arezv$$_context.tracker( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".autorun" : null, () -> super.onAutorunDepsChange(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_DISALLOWED | Flags.AREZ_DEPENDENCIES );
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_CtorInjectWithTrackingObserveModel ) {
        final Arez_CtorInjectWithTrackingObserveModel that = (Arez_CtorInjectWithTrackingObserveModel) o;
