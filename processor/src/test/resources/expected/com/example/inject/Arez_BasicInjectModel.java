...
public final class Arez_BasicInjectModel extends BasicInjectModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_BasicInjectModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "BasicInjectModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicInjectModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
