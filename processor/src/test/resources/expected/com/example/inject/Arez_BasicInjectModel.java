...
public final class Arez_BasicInjectModel extends BasicInjectModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_BasicInjectModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "BasicInjectModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "BasicInjectModel." + $$arez$$_id();
  }
