...
public final class Arez_ComponentNameOnSingletonModel extends ComponentNameOnSingletonModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ComponentNameOnSingletonModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ComponentNameOnSingletonModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
