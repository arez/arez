...
public final class Arez_CascadeDependencyModel extends CascadeDependencyModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_CascadeDependencyModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "CascadeDependencyModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
