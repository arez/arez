...
public final class Arez_NoDisposeTrackableModel extends NoDisposeTrackableModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_NoDisposeTrackableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "NoDisposeTrackableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
