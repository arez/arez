...
public final class Arez_DisposeTrackableModel extends DisposeTrackableModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_DisposeTrackableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "DisposeTrackableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  public void someValue() {
    ...
    try {
      $$arezi$$_context().safeAction(Arez.areNamesEnabled() ? $$arezi$$_name() + ".someValue" : null, () -> super.someValue(), Flags.READ_WRITE | Flags.VERIFY_ACTION_REQUIRED, null );
