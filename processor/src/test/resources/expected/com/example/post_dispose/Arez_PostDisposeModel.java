...
public final class Arez_PostDisposeModel extends PostDisposeModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  private static volatile int $$arezi$$_nextId;

  private final ComponentKernel $$arezi$$_kernel;

  public Arez_PostDisposeModel() {
    super();
