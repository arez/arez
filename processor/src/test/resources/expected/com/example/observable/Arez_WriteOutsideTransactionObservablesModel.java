...
public final class Arez_WriteOutsideTransactionObservablesModel extends WriteOutsideTransactionObservablesModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_WriteOutsideTransactionObservablesModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "WriteOutsideTransactionObservablesModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "WriteOutsideTransactionObservablesModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
