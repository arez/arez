...
public final class Arez_AbstractObservablesModel extends AbstractObservablesModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_AbstractObservablesModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "AbstractObservablesModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
