...
public final class Arez_AbstractObservablesModel extends AbstractObservablesModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_AbstractObservablesModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractObservablesModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
