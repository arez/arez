...
public final class Arez_ReadOutsideTransactionObservableModel extends ReadOutsideTransactionObservableModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ReadOutsideTransactionObservableModel(@Nonnull final Date time) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "ReadOutsideTransactionObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'ReadOutsideTransactionObservableModel'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'ReadOutsideTransactionObservableModel'" );
    }
    return "ReadOutsideTransactionObservableModel." + $$arezi$$_id();
  }
