...
public final class Arez_NullableInitializerModel extends NullableInitializerModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_NullableInitializerModel(@Nullable final Date time) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "NullableInitializerModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
