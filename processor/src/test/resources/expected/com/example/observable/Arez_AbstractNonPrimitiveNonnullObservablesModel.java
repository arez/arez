...
public final class Arez_AbstractNonPrimitiveNonnullObservablesModel extends AbstractNonPrimitiveNonnullObservablesModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_AbstractNonPrimitiveNonnullObservablesModel(@Nonnull final Date time) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractNonPrimitiveNonnullObservablesModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
