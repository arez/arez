...
public final class Arez_AbstractNonPrimitiveNonnullObservablesModel extends AbstractNonPrimitiveNonnullObservablesModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_AbstractNonPrimitiveNonnullObservablesModel(@Nonnull final Date time) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "AbstractNonPrimitiveNonnullObservablesModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
