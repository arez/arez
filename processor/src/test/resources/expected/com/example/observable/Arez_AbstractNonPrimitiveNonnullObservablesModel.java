...
public final class Arez_AbstractNonPrimitiveNonnullObservablesModel extends AbstractNonPrimitiveNonnullObservablesModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_AbstractNonPrimitiveNonnullObservablesModel(@Nonnull final Date time) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractNonPrimitiveNonnullObservablesModel", $$arezi$$_id(), $$arezi$$_name() ) : null;
