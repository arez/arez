...
public final class Arez_GenericObservableModel extends GenericObservableModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_GenericObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "GenericObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
