...
public final class Arez_AbstractPrimitiveObservablesWithInitializerModel extends AbstractPrimitiveObservablesWithInitializerModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_AbstractPrimitiveObservablesWithInitializerModel(final long time) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractPrimitiveObservablesWithInitializerModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
