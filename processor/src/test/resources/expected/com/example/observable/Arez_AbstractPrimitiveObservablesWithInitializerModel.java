...
public final class Arez_AbstractPrimitiveObservablesWithInitializerModel extends AbstractPrimitiveObservablesWithInitializerModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_AbstractPrimitiveObservablesWithInitializerModel(final long time) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "AbstractPrimitiveObservablesWithInitializerModel", $$arezi$$_id(), $$arezi$$_name() ) : null;
