...
public final class Arez_ObservableWithNoSetter extends ObservableWithNoSetter implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ObservableWithNoSetter() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObservableWithNoSetter", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
