...
public final class Arez_ObservableWithNoSetter extends ObservableWithNoSetter implements Disposable {
  ...
  public Arez_ObservableWithNoSetter() {
    ...
    this.$$arez$$_time = this.$$arez$$_context.createObservable( Arez.areNamesEnabled() ? $$arez$$_name() + ".time" : null, Arez.arePropertyIntrospectorsEnabled() ? () -> super.getTime() : null, null );
  }
