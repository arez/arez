...
public final class Arez_ObservableWithNoSetter extends ObservableWithNoSetter implements Disposable, Identifiable<Long> {
  ...
  public Arez_ObservableWithNoSetter() {
    ...
    this.$$arez$$_state = 1;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "ObservableWithNoSetter", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
    ...
    this.$$arez$$_time = $$arez$$_context().createObservable( Arez.areNativeComponentsEnabled() ? this.$$arez$$_component : null, Arez.areNamesEnabled() ? $$arez$$_name() + ".time" : null, Arez.arePropertyIntrospectorsEnabled() ? () -> super.getTime() : null, null );
