...
final class Arez_InitializerAndConstructorParamNameCollisionModel extends InitializerAndConstructorParamNameCollisionModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_InitializerAndConstructorParamNameCollisionModel(final int time,
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "InitializerAndConstructorParamNameCollisionModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'InitializerAndConstructorParamNameCollisionModel'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'InitializerAndConstructorParamNameCollisionModel'" );
    }
    return "InitializerAndConstructorParamNameCollisionModel." + $$arezi$$_id();
  }
