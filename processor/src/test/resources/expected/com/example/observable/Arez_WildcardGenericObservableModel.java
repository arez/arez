...
public final class Arez_WildcardGenericObservableModel<T> extends WildcardGenericObservableModel<T> implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_WildcardGenericObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "WildcardGenericObservableModel", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
