...
public final class Arez_WildcardGenericObservableModel<T> extends WildcardGenericObservableModel<T> implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_WildcardGenericObservableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "WildcardGenericObservableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  private void $$arezi$$_setMyValue(final WildcardGenericObservableModel.MyValue<T> time) {
    if ( Arez.shouldCheckApiInvariants() ) {
