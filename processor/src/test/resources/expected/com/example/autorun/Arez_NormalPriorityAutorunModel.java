...
public final class Arez_NormalPriorityAutorunModel extends NormalPriorityAutorunModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_NormalPriorityAutorunModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "NormalPriorityAutorunModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
