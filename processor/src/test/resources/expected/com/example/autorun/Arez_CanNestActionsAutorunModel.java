...
public final class Arez_CanNestActionsAutorunModel extends CanNestActionsAutorunModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_CanNestActionsAutorunModel() {
    ...
    this.$$arez$$_doStuff = $$arezi$$_context().autorun( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".doStuff" : null, false, () -> super.doStuff(), Priority.NORMAL, false, false, true );
    if ( Arez.shouldCheckApiInvariants() ) {
