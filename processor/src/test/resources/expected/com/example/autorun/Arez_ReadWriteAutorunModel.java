...
public final class Arez_ReadWriteAutorunModel extends ReadWriteAutorunModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_ReadWriteAutorunModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ReadWriteAutorunModel", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
    ...
    this.$$arez$$_doStuff = $$arezi$$_context().autorun( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".doStuff" : null, true, () -> super.doStuff(), false );
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method invoked on uninitialized component of type 'ReadWriteAutorunModel'" );
    }
  ...
  String $$arezi$$_name() {
    ...
    return "ReadWriteAutorunModel." + $$arezi$$_id();
  }
  ...
  public boolean observe() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.areSpiesEnabled() )  {
      Guards.apiInvariant( () -> $$arezi$$_context().isTransactionActive() && $$arezi$$_context().getSpy().getTransaction().isTracking(), () -> "observe method invoked outside a tracking transaction on component of type 'ReadWriteAutorunModel'" );
    }
    if ( !isDisposed )  {
