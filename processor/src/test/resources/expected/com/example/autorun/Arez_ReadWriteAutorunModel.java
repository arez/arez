...
public final class Arez_ReadWriteAutorunModel extends ReadWriteAutorunModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ReadWriteAutorunModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ReadWriteAutorunModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
