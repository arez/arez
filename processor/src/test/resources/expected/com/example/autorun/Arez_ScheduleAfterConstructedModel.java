...
public final class Arez_ScheduleAfterConstructedModel extends ScheduleAfterConstructedModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_ScheduleAfterConstructedModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "ScheduleAfterConstructedModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "ScheduleAfterConstructedModel." + $$arez$$_id();
  }
