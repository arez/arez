...
public final class Arez_ScheduleAfterConstructedModel extends ScheduleAfterConstructedModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ScheduleAfterConstructedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ScheduleAfterConstructedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
