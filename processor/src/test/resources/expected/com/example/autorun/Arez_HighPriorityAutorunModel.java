...
public final class Arez_HighPriorityAutorunModel extends HighPriorityAutorunModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_HighPriorityAutorunModel() {
    ...
    this.$$arez$$_doStuff = $$arezi$$_context().observer( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".doStuff" : null, () -> super.doStuff(), Flags.DEFER_REACT | Flags.PRIORITY_HIGH );
    if ( Arez.shouldCheckApiInvariants() ) {
