...
public final class Arez_ToStringPresentInParent extends ToStringPresentInParent implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ToStringPresentInParent() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ToStringPresentInParent", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
