...
public final class Arez_ToStringPresent extends ToStringPresent implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ToStringPresent() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ToStringPresent", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
