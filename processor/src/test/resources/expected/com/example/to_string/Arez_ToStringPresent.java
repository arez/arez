...
public final class Arez_ToStringPresent extends ToStringPresent implements Disposable, Identifiable<Long> {
  ...
  public Arez_ToStringPresent() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "ToStringPresent", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "ToStringPresent." + $$arez$$_id();
  }
