...
public final class Arez_NoToStringPresent extends NoToStringPresent implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_NoToStringPresent() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "NoToStringPresent", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
