...
public final class Arez_BasicTrackedModel extends BasicTrackedModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_BasicTrackedModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "BasicTrackedModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
