...
public final class Arez_BasicTrackedWithExceptionsModel extends BasicTrackedWithExceptionsModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_BasicTrackedWithExceptionsModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "BasicTrackedWithExceptionsModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  public void render() throws ParseException {
    ...
    try {
      $$arez$$_context().track( this.$$arez$$_render, () -> super.render() );
