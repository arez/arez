...
public final class Arez_DeriveOnDepsChangedModel extends DeriveOnDepsChangedModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_DeriveOnDepsChangedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "DeriveOnDepsChangedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
