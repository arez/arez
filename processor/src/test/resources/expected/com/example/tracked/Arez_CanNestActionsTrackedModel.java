...
public final class Arez_CanNestActionsTrackedModel extends CanNestActionsTrackedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_CanNestActionsTrackedModel() {
    ...
    this.$$arez$$_render = $$arezi$$_context().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".render" : null, () -> super.onRenderDepsChanged(), Options.DEFER_REACT | Options.NESTED_ACTIONS_ALLOWED );
    if ( Arez.shouldCheckApiInvariants() ) {
