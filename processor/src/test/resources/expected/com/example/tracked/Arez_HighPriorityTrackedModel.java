...
public final class Arez_HighPriorityTrackedModel extends HighPriorityTrackedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_HighPriorityTrackedModel() {
    ...
    this.$$arez$$_render = $$arezi$$_context().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".render" : null, () -> super.onRenderDepsChanged(), Flags.DEFER_REACT | Flags.PRIORITY_HIGH );
    if ( Arez.shouldCheckApiInvariants() ) {
