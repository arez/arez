...
public final class Arez_InheritProtectedAccessTrackedModel extends InheritProtectedAccessTrackedModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_InheritProtectedAccessTrackedModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "InheritProtectedAccessTrackedModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
