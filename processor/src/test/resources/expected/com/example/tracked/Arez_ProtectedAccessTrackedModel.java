...
public final class Arez_ProtectedAccessTrackedModel extends ProtectedAccessTrackedModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_ProtectedAccessTrackedModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "ProtectedAccessTrackedModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "ProtectedAccessTrackedModel." + $$arez$$_id();
  }
