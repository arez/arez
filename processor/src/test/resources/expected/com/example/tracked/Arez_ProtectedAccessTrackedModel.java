...
public final class Arez_ProtectedAccessTrackedModel extends ProtectedAccessTrackedModel implements Disposable {
  ...
  public Arez_ProtectedAccessTrackedModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "ProtectedAccessTrackedModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
