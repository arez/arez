...
public final class Arez_DeriveFinalOnDepsChangedModel extends DeriveFinalOnDepsChangedModel implements Disposable {
  ...
  public Arez_DeriveFinalOnDepsChangedModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeriveFinalOnDepsChangedModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "DeriveFinalOnDepsChangedModel." + $$arez$$_id();
  }
