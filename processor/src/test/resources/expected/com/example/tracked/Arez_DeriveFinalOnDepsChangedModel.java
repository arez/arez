...
public final class Arez_DeriveFinalOnDepsChangedModel extends DeriveFinalOnDepsChangedModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_DeriveFinalOnDepsChangedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "DeriveFinalOnDepsChangedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
