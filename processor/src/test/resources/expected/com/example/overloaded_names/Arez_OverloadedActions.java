...
public final class Arez_OverloadedActions extends OverloadedActions implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_OverloadedActions() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "OverloadedActions", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
