...
public final class Arez_OverloadedActions extends OverloadedActions implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public void myAction(final int i) {
    ...
    this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".myAction2" : null, () -> super.myAction( i ), Flags.READ_WRITE | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { i } : null );
  }
  ...
  public void myAction(final float i) {
    ...
    this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".myAction3" : null, () -> super.myAction( i ), Flags.READ_WRITE | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { i } : null );
  }
