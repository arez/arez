...
public final class Arez_ShortComponentIdRequireEquals extends ShortComponentIdRequireEquals implements Disposable, Identifiable<Short>, ComponentObservable {
  ...
  public Arez_ShortComponentIdRequireEquals() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ShortComponentIdRequireEquals", getId(), $$arezi$$_name(), null, null ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method invoked on uninitialized component of type 'ShortComponentIdRequireEquals'" );
    }
