...
public final class Arez_ShortComponentIdRequireEquals extends ShortComponentIdRequireEquals implements Disposable, Identifiable<Short>, ComponentObservable, DisposeTrackable {
  ...
  public Arez_ShortComponentIdRequireEquals() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ShortComponentIdRequireEquals", getId(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
