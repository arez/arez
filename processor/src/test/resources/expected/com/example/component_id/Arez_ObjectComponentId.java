...
public final class Arez_ObjectComponentId extends ObjectComponentId implements Disposable, Identifiable<String>, ComponentObservable {
  ...
  public Arez_ObjectComponentId() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObjectComponentId", getId(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
