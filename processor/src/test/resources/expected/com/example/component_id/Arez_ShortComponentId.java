...
public final class Arez_ShortComponentId extends ShortComponentId implements Disposable, Identifiable<Short>, ComponentObservable {
  ...
  public Arez_ShortComponentId() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ShortComponentId", getId(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
