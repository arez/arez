...
public final class Arez_ByteComponentId extends ByteComponentId implements Disposable, Identifiable<Byte>, DisposeTrackable {
  ...
  public Arez_ByteComponentId() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "ByteComponentId", getId(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
