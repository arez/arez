...
public final class Arez_FloatComponentIdRequireEquals extends FloatComponentIdRequireEquals implements Disposable, Identifiable<Float>, ComponentObservable {
  ...
  public Arez_FloatComponentIdRequireEquals() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "FloatComponentIdRequireEquals", getId(), $$arezi$$_name(), null, null ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method invoked on uninitialized component of type 'FloatComponentIdRequireEquals'" );
    }
