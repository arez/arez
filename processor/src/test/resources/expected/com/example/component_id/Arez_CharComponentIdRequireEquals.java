...
public final class Arez_CharComponentIdRequireEquals extends CharComponentIdRequireEquals implements Disposable, Identifiable<Character>, ComponentObservable {
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method invoked on uninitialized component of type 'CharComponentIdRequireEquals'" );
    }
