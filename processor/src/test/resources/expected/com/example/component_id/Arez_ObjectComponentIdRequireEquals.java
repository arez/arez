...
public final class Arez_ObjectComponentIdRequireEquals extends ObjectComponentIdRequireEquals implements Disposable, Identifiable<String>, ComponentObservable, DisposeTrackable {
  ...
  public Arez_ObjectComponentIdRequireEquals() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ObjectComponentIdRequireEquals", getId(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'ObjectComponentIdRequireEquals'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'ObjectComponentIdRequireEquals'" );
    }
    return "ObjectComponentIdRequireEquals." + getId();
  }
