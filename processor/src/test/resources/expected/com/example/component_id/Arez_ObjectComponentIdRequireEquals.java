...
public final class Arez_ObjectComponentIdRequireEquals extends ObjectComponentIdRequireEquals implements Disposable, Identifiable<String>, DisposeTrackable {
  ...
  public Arez_ObjectComponentIdRequireEquals() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ObjectComponentIdRequireEquals", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
