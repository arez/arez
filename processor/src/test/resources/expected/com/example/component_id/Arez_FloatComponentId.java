...
public final class Arez_FloatComponentId extends FloatComponentId implements Disposable, Identifiable<Float>, ComponentObservable {
  ...
  public Arez_FloatComponentId() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "FloatComponentId", getId(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
