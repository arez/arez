...
public final class Arez_FloatComponentId extends FloatComponentId implements Disposable, Identifiable<Float>, DisposeTrackable {
  ...
  public Arez_FloatComponentId() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "FloatComponentId", getId(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
