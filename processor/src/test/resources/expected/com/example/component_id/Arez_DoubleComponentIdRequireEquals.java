...
public final class Arez_DoubleComponentIdRequireEquals extends DoubleComponentIdRequireEquals implements Disposable, Identifiable<Double>, ComponentObservable {
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method invoked on uninitialized component of type 'DoubleComponentIdRequireEquals'" );
    }
