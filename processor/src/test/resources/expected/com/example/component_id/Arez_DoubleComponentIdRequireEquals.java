...
public final class Arez_DoubleComponentIdRequireEquals extends DoubleComponentIdRequireEquals implements Disposable, Identifiable<Double>, DisposeTrackable {
  ...
  public Arez_DoubleComponentIdRequireEquals() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "DoubleComponentIdRequireEquals", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
