...
public final class Arez_RequireEnvironmentActionModel extends RequireEnvironmentActionModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_RequireEnvironmentActionModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RequireEnvironmentActionModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RequireEnvironmentActionModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public void doStuff(final long time, final float someOtherParameter) {
    ...
    this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".doStuff" : null, () -> super.doStuff( time, someOtherParameter ), Flags.READ_WRITE | Flags.ENVIRONMENT_REQUIRED | Flags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { time, someOtherParameter } : null );
  }
