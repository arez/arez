...
public final class Arez_NewTypeParametersModel extends NewTypeParametersModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_NewTypeParametersModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "NewTypeParametersModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  public <T extends Integer> T doStuff() {
    ...
    try {
      return $$arez$$_context().safeAction(Arez.areNamesEnabled() ? $$arez$$_name() + ".doStuff" : null, true, () -> super.doStuff() );
