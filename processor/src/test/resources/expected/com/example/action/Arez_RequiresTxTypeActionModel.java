...
public final class Arez_RequiresTxTypeActionModel extends RequiresTxTypeActionModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_RequiresTxTypeActionModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RequiresTxTypeActionModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
