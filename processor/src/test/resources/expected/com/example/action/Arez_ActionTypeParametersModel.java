...
public final class Arez_ActionTypeParametersModel<T extends Integer> extends ActionTypeParametersModel<T> implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_ActionTypeParametersModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ActionTypeParametersModel", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method invoked on uninitialized component of type 'ActionTypeParametersModel'" );
    }
  ...
  public boolean observe() {
    ...
    if ( Arez.shouldCheckApiInvariants() && Arez.areSpiesEnabled() )  {
      Guards.apiInvariant( () -> $$arezi$$_context().isTransactionActive() && $$arezi$$_context().getSpy().getTransaction().isTracking(), () -> "observe method invoked outside a tracking transaction on component of type 'ActionTypeParametersModel'" );
    }
    if ( !isDisposed )  {
