...
public final class Arez_NoReportParametersModel extends NoReportParametersModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_NoReportParametersModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "NoReportParametersModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
