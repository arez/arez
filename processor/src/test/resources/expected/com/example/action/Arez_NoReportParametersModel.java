...
public final class Arez_NoReportParametersModel extends NoReportParametersModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_NoReportParametersModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "NoReportParametersModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  public void doStuff(final long time, final float someOtherParameter) {
    ...
    try {
      $$arez$$_context().safeAction(Arez.areNamesEnabled() ? $$arez$$_name() + ".doStuff" : null, true, () -> super.doStuff(time,someOtherParameter) );
