...
public final class Arez_NoReportParametersModel extends NoReportParametersModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public void doStuff(final long time, final float someOtherParameter) {
    ...
    this.$$arezi$$_kernel.getContext().safeAction(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".doStuff" : null, () -> super.doStuff( time, someOtherParameter ), Flags.READ_WRITE | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.VERIFY_ACTION_REQUIRED, null );
  }
