...
public final class Arez_BasicFunctionActionModel extends BasicFunctionActionModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_BasicFunctionActionModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "BasicFunctionActionModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
