...
public final class Arez_BasicFunctionActionModel extends BasicFunctionActionModel implements Disposable {
  ...
  public Arez_BasicFunctionActionModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "BasicFunctionActionModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  public int doStuff(final long time) {
    ...
    try {
      return this.$$arez$$_context.safeAction(Arez.areNamesEnabled() ? $$arez$$_name() + ".doStuff" : null, true, () -> super.doStuff(time), time );
