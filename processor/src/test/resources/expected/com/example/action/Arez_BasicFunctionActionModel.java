...
public final class Arez_BasicFunctionActionModel extends BasicFunctionActionModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_BasicFunctionActionModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "BasicFunctionActionModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  public int doStuff(final long time) {
    ...
    try {
      return $$arez$$_context().safeAction(Arez.areNamesEnabled() ? $$arez$$_name() + ".doStuff" : null, true, () -> super.doStuff(time), time );
