...
public final class Arez_MultiThrowAction extends MultiThrowAction implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_MultiThrowAction() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "MultiThrowAction", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
