...
public final class Arez_MultiThrowAction extends MultiThrowAction implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  void myAction() throws ParseException, IOException {
    ...
    try {
      this.$$arezi$$_kernel.getContext().action(Arez.areNamesEnabled() ? this.$$arezi$$_kernel.getName() + ".myAction" : null, () -> super.myAction(), Flags.READ_WRITE | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.VERIFY_ACTION_REQUIRED, null );
