...
public final class Arez_ReadOnlyActionModel extends ReadOnlyActionModel implements Disposable {
  ...
  public Arez_ReadOnlyActionModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "ReadOnlyActionModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  public int queryStuff(final long time) {
    ...
    try {
      return this.$$arez$$_context.safeAction(Arez.areNamesEnabled() ? $$arez$$_name() + ".queryStuff" : null, false, () -> super.queryStuff(time), time );
