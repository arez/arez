...
public final class Arez_ReadOnlyActionModel extends ReadOnlyActionModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_ReadOnlyActionModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ReadOnlyActionModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
