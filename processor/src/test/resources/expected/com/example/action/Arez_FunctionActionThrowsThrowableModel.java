...
public final class Arez_FunctionActionThrowsThrowableModel extends FunctionActionThrowsThrowableModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_FunctionActionThrowsThrowableModel() {
    ...
    this.$$arez$$_state = 1;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "FunctionActionThrowsThrowableModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
