...
public final class Arez_FunctionActionThrowsThrowableModel extends FunctionActionThrowsThrowableModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  public Arez_FunctionActionThrowsThrowableModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "FunctionActionThrowsThrowableModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
