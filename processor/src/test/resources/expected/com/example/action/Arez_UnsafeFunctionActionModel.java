...
public final class Arez_UnsafeFunctionActionModel extends UnsafeFunctionActionModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_UnsafeFunctionActionModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "UnsafeFunctionActionModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
