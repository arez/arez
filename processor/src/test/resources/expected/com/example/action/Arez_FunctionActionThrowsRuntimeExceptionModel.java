...
public final class Arez_FunctionActionThrowsRuntimeExceptionModel extends FunctionActionThrowsRuntimeExceptionModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_FunctionActionThrowsRuntimeExceptionModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "FunctionActionThrowsRuntimeExceptionModel", $$arezi$$_id(), $$arezi$$_name() ) : null;
