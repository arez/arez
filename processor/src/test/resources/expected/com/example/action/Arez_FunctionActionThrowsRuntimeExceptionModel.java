...
public final class Arez_FunctionActionThrowsRuntimeExceptionModel extends FunctionActionThrowsRuntimeExceptionModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_FunctionActionThrowsRuntimeExceptionModel() {
    ...
    this.$$arez$$_state = 1;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "FunctionActionThrowsRuntimeExceptionModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
