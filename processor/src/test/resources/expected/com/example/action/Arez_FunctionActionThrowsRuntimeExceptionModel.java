...
public final class Arez_FunctionActionThrowsRuntimeExceptionModel extends FunctionActionThrowsRuntimeExceptionModel implements Disposable {
  ...
  public Arez_FunctionActionThrowsRuntimeExceptionModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "FunctionActionThrowsRuntimeExceptionModel", $$arez$$_id(), $$arez$$_name() ) : null;
