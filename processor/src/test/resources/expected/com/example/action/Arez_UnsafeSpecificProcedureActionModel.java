...
public final class Arez_UnsafeSpecificProcedureActionModel extends UnsafeSpecificProcedureActionModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  public Arez_UnsafeSpecificProcedureActionModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "UnsafeSpecificProcedureActionModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  public void doStuff(final long time) throws ParseException {
    ...
    try {
      $$arezi$$_context().action(Arez.areNamesEnabled() ? $$arezi$$_name() + ".doStuff" : null, true, () -> super.doStuff(time), time );
