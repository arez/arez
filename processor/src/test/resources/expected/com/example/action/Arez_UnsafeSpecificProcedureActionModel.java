...
public final class Arez_UnsafeSpecificProcedureActionModel extends UnsafeSpecificProcedureActionModel implements Disposable {
  ...
  public Arez_UnsafeSpecificProcedureActionModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "UnsafeSpecificProcedureActionModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  public void doStuff(final long time) throws ParseException {
    ...
    try {
      this.$$arez$$_context.action(Arez.areNamesEnabled() ? $$arez$$_name() + ".doStuff" : null, true, () -> super.doStuff(time), time );
