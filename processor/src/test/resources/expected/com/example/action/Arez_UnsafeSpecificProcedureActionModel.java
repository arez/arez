...
public final class Arez_UnsafeSpecificProcedureActionModel extends UnsafeSpecificProcedureActionModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_UnsafeSpecificProcedureActionModel() {
    ...
    this.$$arez$$_state = 1;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "UnsafeSpecificProcedureActionModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
