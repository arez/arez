...
public final class Arez_ComputedWithNameVariationsModel extends ComputedWithNameVariationsModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ComputedWithNameVariationsModel() {
    ...
    this.$$arez$$_ready = $$arezi$$_context().computable( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".ready" : null, () -> super.isReady(), Flags.RUN_LATER | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.AREZ_DEPENDENCIES );
    this.$$arez$$_helper = $$arezi$$_context().computable( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".helper" : null, () -> super.helper(), Flags.RUN_LATER | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.AREZ_DEPENDENCIES );
    this.$$arez$$_foo = $$arezi$$_context().computable( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".foo" : null, () -> super.myFooHelperMethod(), Flags.RUN_LATER | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.AREZ_DEPENDENCIES );
    if ( Arez.shouldCheckApiInvariants() ) {
