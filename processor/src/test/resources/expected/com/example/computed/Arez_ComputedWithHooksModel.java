...
public final class Arez_ComputedWithHooksModel extends ComputedWithHooksModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_ComputedWithHooksModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ComputedWithHooksModel", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
