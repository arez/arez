...
public final class Arez_KeepAliveComputedModel extends KeepAliveComputedModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_KeepAliveComputedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "KeepAliveComputedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
