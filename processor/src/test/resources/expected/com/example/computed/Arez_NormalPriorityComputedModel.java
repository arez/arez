...
public final class Arez_NormalPriorityComputedModel extends NormalPriorityComputedModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_NormalPriorityComputedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "NormalPriorityComputedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
