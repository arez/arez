...
public final class Arez_ArezOrNoneDependenciesComputedModel extends ArezOrNoneDependenciesComputedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ArezOrNoneDependenciesComputedModel() {
    ...
    this.$$arez$$_time = $$arezi$$_context().computed( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".time" : null, () -> super.getTime(), Flags.RUN_LATER | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.AREZ_OR_NO_DEPENDENCIES );
    if ( Arez.shouldCheckApiInvariants() ) {
