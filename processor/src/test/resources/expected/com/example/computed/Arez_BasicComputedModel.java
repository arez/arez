...
public final class Arez_BasicComputedModel extends BasicComputedModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_BasicComputedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "BasicComputedModel", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
