...
public final class Arez_BasicComputedModel extends BasicComputedModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_BasicComputedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "BasicComputedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
