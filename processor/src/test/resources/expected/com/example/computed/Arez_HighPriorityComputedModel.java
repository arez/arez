...
public final class Arez_HighPriorityComputedModel extends HighPriorityComputedModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  public Arez_HighPriorityComputedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "HighPriorityComputedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
    ...
    this.$$arez$$_time = $$arezi$$_context().createComputedValue( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".time" : null, () -> super.getTime(), null, null, null, null, Priority.HIGH );
    if ( Arez.shouldCheckInvariants() ) {
