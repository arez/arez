...
public final class Arez_HighPriorityComputedModel extends HighPriorityComputedModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_HighPriorityComputedModel() {
    ...
    this.$$arez$$_time = $$arezi$$_context().createComputedValue( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".time" : null, () -> super.getTime(), EqualityComparator.defaultComparator(), null, null, null, null, true );
