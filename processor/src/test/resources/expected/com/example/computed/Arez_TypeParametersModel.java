...
public final class Arez_TypeParametersModel extends TypeParametersModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_TypeParametersModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "TypeParametersModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
