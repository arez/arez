...
public final class Arez_TypeParametersModel extends TypeParametersModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_TypeParametersModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "TypeParametersModel", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
