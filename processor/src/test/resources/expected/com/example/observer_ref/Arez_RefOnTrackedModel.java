...
public final class Arez_RefOnTrackedModel extends RefOnTrackedModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_RefOnTrackedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RefOnTrackedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
