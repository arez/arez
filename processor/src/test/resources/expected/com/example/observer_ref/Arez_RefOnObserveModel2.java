...
public final class Arez_RefOnObserveModel2 extends RefOnObserveModel2 implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_RefOnObserveModel2() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RefOnObserveModel2." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RefOnObserveModel2", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( o instanceof Arez_RefOnObserveModel2 ) {
