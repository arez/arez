...
public final class Arez_RefOnAutorunModel extends RefOnAutorunModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_RefOnAutorunModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RefOnAutorunModel", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
