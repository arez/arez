...
public final class Arez_CustomNameRefOnAutorunModel extends CustomNameRefOnAutorunModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_CustomNameRefOnAutorunModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "CustomNameRefOnAutorunModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
