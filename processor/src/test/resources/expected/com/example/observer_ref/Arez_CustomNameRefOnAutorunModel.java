...
public final class Arez_CustomNameRefOnAutorunModel extends CustomNameRefOnAutorunModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  public Arez_CustomNameRefOnAutorunModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "CustomNameRefOnAutorunModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
