...
public final class Arez_CustomNameRefOnAutorunModel extends CustomNameRefOnAutorunModel implements Disposable {
  ...
  public Arez_CustomNameRefOnAutorunModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "CustomNameRefOnAutorunModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
