...
public final class Arez_CustomNameRefOnTrackedModel extends CustomNameRefOnTrackedModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_CustomNameRefOnTrackedModel() {
    ...
    this.$$arez$$_state = 1;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "CustomNameRefOnTrackedModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    ...
    return "CustomNameRefOnTrackedModel." + $$arez$$_id();
  }
