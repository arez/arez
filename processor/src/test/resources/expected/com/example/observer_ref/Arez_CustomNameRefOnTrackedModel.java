...
public final class Arez_CustomNameRefOnTrackedModel extends CustomNameRefOnTrackedModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_CustomNameRefOnTrackedModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "CustomNameRefOnTrackedModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
