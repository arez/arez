...
public final class Arez_CustomNameRefOnObserveModel2 extends CustomNameRefOnObserveModel2 implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_CustomNameRefOnObserveModel2() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "CustomNameRefOnObserveModel2." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "CustomNameRefOnObserveModel2", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
