...
final class Arez_ProtectedAccessComponent extends ProtectedAccessComponent implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  Arez_ProtectedAccessComponent() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ProtectedAccessComponent", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'ProtectedAccessComponent'" );
    }
  ...
  protected final Component getComponent() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named 'getComponent' invoked on uninitialized component of type 'ProtectedAccessComponent'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
