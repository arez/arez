...
final class Arez_ProtectedAccessComponent extends ProtectedAccessComponent implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_ProtectedAccessComponent() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "ProtectedAccessComponent", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
