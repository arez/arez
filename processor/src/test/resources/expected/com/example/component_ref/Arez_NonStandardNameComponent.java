...
final class Arez_NonStandardNameComponent extends NonStandardNameComponent implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  final Component getComponent() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != this.$$arezi$$_kernel && this.$$arezi$$_kernel.hasBeenInitialized(), () -> "Method named 'getComponent' invoked on uninitialized component of type 'NonStandardNameComponent'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
