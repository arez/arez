...
final class Arez_AnnotatedComponent extends AnnotatedComponent implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_AnnotatedComponent() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "AnnotatedComponent", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
