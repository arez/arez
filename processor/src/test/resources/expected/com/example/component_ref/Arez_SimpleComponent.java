...
final class Arez_SimpleComponent extends SimpleComponent implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_SimpleComponent() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "SimpleComponent", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
