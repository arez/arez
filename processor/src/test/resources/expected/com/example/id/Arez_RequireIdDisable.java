...
final class Arez_RequireIdDisable extends RequireIdDisable implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_RequireIdDisable() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RequireIdDisable", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
