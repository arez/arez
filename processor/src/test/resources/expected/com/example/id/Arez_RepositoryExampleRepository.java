...
final class Arez_RepositoryExampleRepository extends RepositoryExampleRepository implements Disposable, Identifiable<Integer> {
  ...
  Arez_RepositoryExampleRepository() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "RepositoryExampleRepository" : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "RepositoryExampleRepository", $$arezv$$_id, $$arezv$$_name, () -> super.preDispose() ) : null;
