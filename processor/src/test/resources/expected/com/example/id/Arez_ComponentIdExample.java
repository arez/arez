...
final class Arez_ComponentIdExample extends ComponentIdExample implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_ComponentIdExample() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ComponentIdExample", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
