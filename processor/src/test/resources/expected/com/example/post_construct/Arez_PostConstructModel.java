...
public final class Arez_PostConstructModel extends PostConstructModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_PostConstructModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "PostConstructModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
