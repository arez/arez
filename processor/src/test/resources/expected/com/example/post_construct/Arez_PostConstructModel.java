...
public final class Arez_PostConstructModel extends PostConstructModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_PostConstructModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "PostConstructModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
