...
final class NonObservableNullableManyReferenceModel_Arez_Element extends NonObservableNullableManyReferenceModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  NonObservableNullableManyReferenceModel getNonObservableNullableManyReferenceModel() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.isActive( this.$$arezi$$_state ), () -> "Method named 'getNonObservableNullableManyReferenceModel' invoked on " + ComponentState.describe( this.$$arezi$$_state ) + " component named '" + $$arezi$$_name() + "'" );
    }
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_nonObservableNullableManyReferenceModel || null == getNonObservableNullableManyReferenceModelId(), () -> "Nullable reference method named 'getNonObservableNullableManyReferenceModel' invoked on component named '" + $$arezi$$_name() + "' and reference has not been resolved yet is not lazy. Id = " + getNonObservableNullableManyReferenceModelId() );
    }
  ...
  private void $$arezi$$_link_nonObservableNullableManyReferenceModel() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.isActive( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_link_nonObservableNullableManyReferenceModel' invoked on " + ComponentState.describe( this.$$arezi$$_state ) + " component named '" + $$arezi$$_name() + "'" );
    }
    ...
    if ( null != id ) {
      ...
      if ( Arez.shouldCheckApiInvariants() ) {
        Guards.apiInvariant( () -> null != $$arezr$$_nonObservableNullableManyReferenceModel, () -> "Reference method named 'getNonObservableNullableManyReferenceModel' invoked on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type com.example.inverse.NonObservableNullableManyReferenceModel and id = " + getNonObservableNullableManyReferenceModelId() );
      }
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( this == o ) {
        return true;
      } else if ( null == o || !(o instanceof NonObservableNullableManyReferenceModel_Arez_Element) ) {
        return false;
      } else {
