...
final class Arez_NonObservableCollectionInverseModel extends NonObservableCollectionInverseModel implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  Arez_NonObservableCollectionInverseModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "NonObservableCollectionInverseModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
