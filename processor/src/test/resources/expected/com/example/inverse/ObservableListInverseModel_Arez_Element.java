...
final class ObservableListInverseModel_Arez_Element extends ObservableListInverseModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  private void $$arezi$$_link_observableListInverseModel() {
    ...
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_observableListInverseModel, () -> "Reference method named 'getObservableListInverseModel' invoked on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type " + ObservableListInverseModel.class + " and id = " + getObservableListInverseModelId() );
    }
