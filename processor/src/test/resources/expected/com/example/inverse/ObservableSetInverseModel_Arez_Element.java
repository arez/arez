...
final class ObservableSetInverseModel_Arez_Element extends ObservableSetInverseModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  @Nullable
  private ObservableSetInverseModel $$arezr$$_other;
  ...
  @Override
  ObservableSetInverseModel getOther() {
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  private void $$arezi$$_link_other() {
    ...
    this.$$arezr$$_other = this.$$arezi$$_locator().findById( ObservableSetInverseModel.class, id );
    if ( Arez.shouldCheckApiInvariants() ) {
    ...
    ( (Arez_ObservableSetInverseModel) this.$$arezr$$_other ).$$arezir$$_elements_add( this );
  }
  ...
  private void $$arezi$$_delink_other() {
    ...
    if ( null != $$arezr$$_other ) {
      ( (Arez_ObservableSetInverseModel) this.$$arezr$$_other ).$$arezir$$_elements_remove( this );
      this.$$arezr$$_other = null;
    }
  }
