...
final class ObservableOneReferenceModel_Arez_Element extends ObservableOneReferenceModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  @Nonnull
  private final Observable<Integer> $$arez$$_observableOneReferenceModelId;
  ...
  private void $$arezi$$_link_observableOneReferenceModel() {
    ...
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_observableOneReferenceModel, () -> "Reference method named 'getObservableOneReferenceModel' invoked on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type com.example.inverse.ObservableOneReferenceModel and id = " + getObservableOneReferenceModelId() );
    }
    ( (Arez_ObservableOneReferenceModel) this.$$arezr$$_observableOneReferenceModel ).$$arezir$$_element_set( this );
  }

  private void $$arezi$$_delink_observableOneReferenceModel() {
  ...
  public final boolean equals(final Object o) {
    if ( Arez.areNativeComponentsEnabled() ) {
      if ( this == o ) {
        return true;
      } else if ( null == o || !(o instanceof ObservableOneReferenceModel_Arez_Element) ) {
        return false;
      } else {
