...
final class ZeroOrOneMultiplicityInverseModel_Arez_Element extends ZeroOrOneMultiplicityInverseModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  private void $$arezi$$_link_zeroOrOneMultiplicityInverseModel() {
    ...
    Guards.apiInvariant( () -> null != $$arezr$$_zeroOrOneMultiplicityInverseModel, () -> "Reference named 'zeroOrOneMultiplicityInverseModel' on component named '" + $$arezi$$_name() + "' is unable to resolve entity of type com.example.inverse.ZeroOrOneMultiplicityInverseModel and id = " + getZeroOrOneMultiplicityInverseModelId() );
    if ( Arez.shouldCheckApiInvariants() ) {
    }
