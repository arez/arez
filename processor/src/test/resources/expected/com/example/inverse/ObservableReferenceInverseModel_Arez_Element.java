...
final class ObservableReferenceInverseModel_Arez_Element extends ObservableReferenceInverseModel.Element implements Disposable, Identifiable<Integer>, Verifiable, DisposeTrackable {
  ...
  @Nonnull
  private final Observable<Integer> $$arez$$_observableReferenceInverseModelId;
  ...
  private void $$arezi$$_link_observableReferenceInverseModel() {
    ...
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> null != $$arezr$$_observableReferenceInverseModel, () -> "Reference method named 'getObservableReferenceInverseModel' invoked on component named '" + $$arezi$$_name() + "' missing related entity. Id = " + getObservableReferenceInverseModelId() );
    }
