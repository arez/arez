...
final class Arez_AnnotatedLocatorModel extends AnnotatedLocatorModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_AnnotatedLocatorModel() {
    ...
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> Arez.areReferencesEnabled(), () -> "Attempted to create instance of component of type 'AnnotatedLocatorModel' that contains references but Arez.areReferencesEnabled() returns false. References need to be enabled to use this component" );
    }
