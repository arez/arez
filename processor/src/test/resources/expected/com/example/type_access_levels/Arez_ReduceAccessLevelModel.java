...
final class Arez_ReduceAccessLevelModel extends ReduceAccessLevelModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_ReduceAccessLevelModel(final int foo) {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ReduceAccessLevelModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
