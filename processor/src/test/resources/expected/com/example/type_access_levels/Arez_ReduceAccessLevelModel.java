...
final class Arez_ReduceAccessLevelModel extends ReduceAccessLevelModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  Arez_ReduceAccessLevelModel(final int foo) {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "ReduceAccessLevelModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
