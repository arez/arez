...
public final class Arez_ParametersComputableValueModel extends ParametersComputableValueModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ParametersComputableValueModel() {
    ...
    this.$$arez$$_time = new MemoizeCache<>( Arez.areZonesEnabled() ? $$arezv$$_context : null, Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".time" : null, args -> super.getTime((int) args[ 0 ], (String) args[ 1 ], (Object) args[ 2 ]), 3, Flags.PRIORITY_NORMAL | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.AREZ_DEPENDENCIES );
