...
public final class Arez_BasicTrackedModel extends BasicTrackedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_BasicTrackedModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "BasicTrackedModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
