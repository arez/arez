...
public final class Arez_DeriveTrackedModel extends DeriveTrackedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_DeriveTrackedModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "DeriveTrackedModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
