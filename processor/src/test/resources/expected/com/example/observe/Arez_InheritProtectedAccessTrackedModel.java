...
public final class Arez_InheritProtectedAccessTrackedModel extends InheritProtectedAccessTrackedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_InheritProtectedAccessTrackedModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "InheritProtectedAccessTrackedModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
