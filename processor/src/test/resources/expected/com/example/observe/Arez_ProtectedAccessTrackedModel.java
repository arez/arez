...
public final class Arez_ProtectedAccessTrackedModel extends ProtectedAccessTrackedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ProtectedAccessTrackedModel() {
    ...
    final String $$arezv$$_name = Arez.areNamesEnabled() ? "ProtectedAccessTrackedModel." + $$arezv$$_id : null;
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ProtectedAccessTrackedModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
