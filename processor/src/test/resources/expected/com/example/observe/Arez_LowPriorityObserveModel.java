...
public final class Arez_LowPriorityObserveModel extends LowPriorityObserveModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_LowPriorityObserveModel() {
    ...
    this.$$arez$$_doStuff = $$arezv$$_context.observer( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".doStuff" : null, () -> super.doStuff(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_DISALLOWED | Flags.AREZ_DEPENDENCIES | Flags.ENVIRONMENT_REQUIRED | Flags.PRIORITY_LOW );
