...
public final class Arez_NestedActionsAllowedTrackedModel extends NestedActionsAllowedTrackedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_NestedActionsAllowedTrackedModel() {
    ...
    this.$$arez$$_render = $$arezi$$_context().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".render" : null, () -> super.onRenderDepsChange(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_ALLOWED | Flags.AREZ_DEPENDENCIES | Flags.ENVIRONMENT_NOT_REQUIRED );
    if ( Arez.shouldCheckApiInvariants() ) {
