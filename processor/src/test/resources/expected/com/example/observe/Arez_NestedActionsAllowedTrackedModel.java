...
public final class Arez_NestedActionsAllowedTrackedModel extends NestedActionsAllowedTrackedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_NestedActionsAllowedTrackedModel() {
    ...
    this.$$arez$$_render = $$arezv$$_context.tracker( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".render" : null, () -> super.onRenderDepsChange(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_ALLOWED | Flags.AREZ_DEPENDENCIES );
