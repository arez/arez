...
public final class Arez_NestedActionsAllowedObserveModel extends NestedActionsAllowedObserveModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_NestedActionsAllowedObserveModel() {
    ...
    this.$$arez$$_doStuff = $$arezv$$_context.observer( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".doStuff" : null, () -> super.doStuff(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_ALLOWED | Flags.AREZ_DEPENDENCIES | Flags.ENVIRONMENT_REQUIRED );
