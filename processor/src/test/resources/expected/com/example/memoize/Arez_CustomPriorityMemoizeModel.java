...
public final class Arez_CustomPriorityMemoizeModel extends CustomPriorityMemoizeModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_CustomPriorityMemoizeModel() {
    ...
    this.$$arez$$_count = new MemoizeCache<>( Arez.areZonesEnabled() ? $$arezi$$_context() : null, Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".count" : null, args -> super.count((long) args[ 0 ], (float) args[ 1 ]), 2, Priority.LOWEST,false );
    if ( Arez.shouldCheckApiInvariants() ) {
