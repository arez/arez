...
public final class Arez_LocalTypeParamModel extends LocalTypeParamModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_LocalTypeParamModel() {
    ...
    this.$$arez$$_count = new MemoizeCache<>( Arez.areZonesEnabled() ? $$arezv$$_context : null, Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".count" : null, args -> super.count((String) args[ 0 ]), 1, Flags.PRIORITY_NORMAL | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.AREZ_DEPENDENCIES );
