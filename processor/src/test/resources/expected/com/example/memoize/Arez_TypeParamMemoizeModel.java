...
public final class Arez_TypeParamMemoizeModel<T> extends TypeParamMemoizeModel<T> implements Disposable {
  ...
  public Arez_TypeParamMemoizeModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "TypeParamMemoizeModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "TypeParamMemoizeModel." + $$arez$$_id();
  }
