...
public final class Arez_ReadOutsideTransactionModel extends ReadOutsideTransactionModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public Arez_ReadOutsideTransactionModel() {
    ...
    this.$$arez$$_time = $$arezv$$_context.computable( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".time" : null, () -> super.getTime(), Flags.READ_OUTSIDE_TRANSACTION | Flags.AREZ_DEPENDENCIES | Flags.RUN_LATER );
