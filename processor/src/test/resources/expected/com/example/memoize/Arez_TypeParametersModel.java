...
public final class Arez_TypeParametersModel extends TypeParametersModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_TypeParametersModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "TypeParametersModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
