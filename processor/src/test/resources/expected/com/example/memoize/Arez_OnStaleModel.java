...
public final class Arez_OnStaleModel extends OnStaleModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public Arez_OnStaleModel() {
    ...
    this.$$arez$$_time = $$arezv$$_context.computable( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".time" : null, () -> super.getTime(), null, null, this::onTimeStale, Flags.AREZ_DEPENDENCIES | Flags.RUN_LATER );
