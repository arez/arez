...
public final class Arez_ArezOrNoneDependenciesModel extends ArezOrNoneDependenciesModel implements Disposable, Identifiable<Integer>, DisposeNotifier {
  ...
  public Arez_ArezOrNoneDependenciesModel() {
    ...
    this.$$arez$$_time = $$arezv$$_context.computable( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".time" : null, () -> super.getTime(), Flags.AREZ_OR_NO_DEPENDENCIES | Flags.RUN_LATER );
