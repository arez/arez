...
public final class Arez_ArezOrNoneDependenciesModel extends ArezOrNoneDependenciesModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ArezOrNoneDependenciesModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "ArezOrNoneDependenciesModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
    ...
    this.$$arez$$_time = $$arezv$$_context.computable( Arez.areNativeComponentsEnabled() ? $$arezv$$_component : null, Arez.areNamesEnabled() ? $$arezv$$_name + ".time" : null, () -> super.getTime(), Flags.PRIORITY_NORMAL | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.AREZ_OR_NO_DEPENDENCIES | Flags.RUN_LATER );
