...
public final class Arez_MyArezReactComponent_ extends MyArezReactComponent_ implements Disposable, Identifiable<Long> {
  ...
  public Arez_MyArezReactComponent_() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "MyArezReactComponent_", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "MyArezReactComponent_." + $$arez$$_id();
  }
