...
public final class Arez_GenericsModel extends GenericsModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_GenericsModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "GenericsModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
