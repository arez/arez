...
public final class Arez_LeafModel extends LeafModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_LeafModel() {
    ...
    this.$$arez$$_state = 1;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "LeafModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
