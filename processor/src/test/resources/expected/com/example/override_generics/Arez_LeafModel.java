...
public final class Arez_LeafModel extends LeafModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_LeafModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "LeafModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
