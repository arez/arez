...
public final class Arez_MyArezReactComponent extends MyArezReactComponent implements Disposable, Identifiable<Long> {
  ...
  public Arez_MyArezReactComponent() {
    super();
    this.$$arez$$_context = Arez.areZonesEnabled() ? Arez.context() : null;
    this.$$arez$$_id = $$arez$$_nextId++;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "MyArezReactComponent", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "MyArezReactComponent." + $$arez$$_id();
  }
  ...
  public final boolean equals(final Object o) {
    if ( this == o ) {
      return true;
    } else if ( null == o || !(o instanceof Arez_MyArezReactComponent) ) {
      return false;
    } else {
      final Arez_MyArezReactComponent that = (Arez_MyArezReactComponent) o;;
