...
public final class Arez_TrackedAllTypesModel extends TrackedAllTypesModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_TrackedAllTypesModel() {
    ...
    this.$$arez$$_render1 = $$arezi$$_context().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".render1" : null, () -> super.onRender1DepsChanged(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_DISALLOWED | Flags.AREZ_DEPENDENCIES | Flags.ENVIRONMENT_NOT_REQUIRED );
    this.$$arez$$_render2 = $$arezi$$_context().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".render2" : null, () -> super.onRender2DepsChanged(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_DISALLOWED | Flags.AREZ_DEPENDENCIES | Flags.ENVIRONMENT_NOT_REQUIRED );
    this.$$arez$$_render3 = $$arezi$$_context().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".render3" : null, () -> super.onRender3DepsChanged(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_DISALLOWED | Flags.AREZ_DEPENDENCIES | Flags.ENVIRONMENT_NOT_REQUIRED );
    this.$$arez$$_render4 = $$arezi$$_context().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".render4" : null, () -> super.onRender4DepsChanged(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_DISALLOWED | Flags.AREZ_DEPENDENCIES | Flags.ENVIRONMENT_NOT_REQUIRED );
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void render1() {
    ...
    try {
      $$arezi$$_context().safeObserve( this.$$arez$$_render1, () -> super.render1(), null );
  ...
  public void render2() throws ParseException {
    ...
    try {
      $$arezi$$_context().observe( this.$$arez$$_render2, () -> super.render2(), null );
  ...
  protected int render3() {
    ...
    try {
      return $$arezi$$_context().safeObserve( this.$$arez$$_render3, () -> super.render3(), null );
    } catch( final RuntimeException | Error $$arez_exception$$ ) {
      throw $$arez_exception$$;
    } catch( final Throwable $$arez_exception$$ ) {
      throw new IllegalStateException( $$arez_exception$$ );
  ...
  int render4() throws ParseException {
    ...
    try {
      return $$arezi$$_context().observe( this.$$arez$$_render4, () -> super.render4(), null );
    } catch( final ParseException | RuntimeException | Error $$arez_exception$$ ) {
      throw $$arez_exception$$;
    } catch( final Throwable $$arez_exception$$ ) {
      throw new IllegalStateException( $$arez_exception$$ );
