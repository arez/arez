...
public final class Arez_LowestPriorityObservedModel extends LowestPriorityObservedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_LowestPriorityObservedModel() {
    ...
    this.$$arez$$_doStuff = $$arezi$$_context().observer( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".doStuff" : null, () -> super.doStuff(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_DISALLOWED | Flags.AREZ_DEPENDENCIES_ONLY | Flags.PRIORITY_LOWEST );
    if ( Arez.shouldCheckApiInvariants() ) {
