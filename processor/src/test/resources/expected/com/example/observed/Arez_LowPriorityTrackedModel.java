...
public final class Arez_LowPriorityTrackedModel extends LowPriorityTrackedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_LowPriorityTrackedModel() {
    ...
    this.$$arez$$_render = $$arezi$$_context().tracker( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".render" : null, () -> super.onRenderDepsChanged(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_DISALLOWED | Flags.AREZ_DEPENDENCIES | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.PRIORITY_LOW );
    if ( Arez.shouldCheckApiInvariants() ) {
