...
public final class Arez_ReadWriteObservedModel extends ReadWriteObservedModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ReadWriteObservedModel() {
    ...
    this.$$arez$$_doStuff = $$arezi$$_context().observer( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".doStuff" : null, () -> super.doStuff(), Flags.RUN_LATER | Flags.NESTED_ACTIONS_DISALLOWED | Flags.AREZ_DEPENDENCIES_ONLY | Flags.READ_WRITE );
    if ( Arez.shouldCheckApiInvariants() ) {
