...
final class Arez_PublicCtorNonPublicModel extends PublicCtorNonPublicModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  Arez_PublicCtorNonPublicModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "PublicCtorNonPublicModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
