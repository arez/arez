...
public final class Arez_DisposeOnDeactivateModel extends DisposeOnDeactivateModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  public Arez_DisposeOnDeactivateModel() {
    ...
    this.$$arezi$$_disposeOnDeactivate = $$arezi$$_context().computed( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".disposeOnDeactivate" : null, () -> $$arezi$$_observe(), null, () -> $$arezi$$_context().scheduleDispose( this ), null, Options.PRIORITY_HIGHEST );
    if ( Arez.shouldCheckApiInvariants() ) {
