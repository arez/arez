...
public final class Arez_DisposeOnDeactivateModel extends DisposeOnDeactivateModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  @Nonnull
  private final ComputedValue<Boolean> $$arezi$$_disposeOnDeactivate;
  ...
  public Arez_DisposeOnDeactivateModel() {
    ...
    this.$$arezi$$_disposeOnDeactivate = $$arezi$$_context().computed( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".disposeOnDeactivate" : null, () -> $$arezi$$_observe(), null, () -> $$arezi$$_context().scheduleDispose( this ), null, Flags.PRIORITY_HIGHEST );
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  final ArezContext $$arezi$$_context() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_context' invoked on uninitialized component of type 'DisposeOnDeactivateModel'" );
    }
  ...
  String $$arezi$$_name() {
    if ( Arez.shouldCheckApiInvariants() ) {
      Guards.apiInvariant( () -> ComponentState.hasBeenInitialized( this.$$arezi$$_state ), () -> "Method named '$$arezi$$_name' invoked on uninitialized component of type 'DisposeOnDeactivateModel'" );
    }
    return "DisposeOnDeactivateModel." + $$arezi$$_id();
  }
  ...
  public void doStuff(final long time, final float someOtherParameter) {
    ...
    try {
      $$arezi$$_context().safeAction(Arez.areNamesEnabled() ? $$arezi$$_name() + ".doStuff" : null, () -> super.doStuff( time, someOtherParameter ), Flags.READ_WRITE | Flags.ENVIRONMENT_NOT_REQUIRED | Flags.VERIFY_ACTION_REQUIRED, Arez.areSpiesEnabled() ? new Object[] { time, someOtherParameter } : null );
