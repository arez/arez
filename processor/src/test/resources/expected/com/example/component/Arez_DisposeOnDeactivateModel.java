...
public final class Arez_DisposeOnDeactivateModel extends DisposeOnDeactivateModel implements Disposable, Identifiable<Integer>, ComponentObservable, DisposeTrackable {
  ...
  public Arez_DisposeOnDeactivateModel() {
    ...
    this.$$arezi$$_disposeOnDeactivate = $$arezi$$_context().computedValue( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".disposeOnDeactivate" : null, () -> $$arezi$$_observe(), null, () -> $$arezi$$_context().scheduleDispose( this ), null, null, Priority.HIGHEST );
    if ( Arez.shouldCheckApiInvariants() ) {
  ...
  public void doStuff(final long time, final float someOtherParameter) {
    ...
    try {
      $$arezi$$_context().safeAction(Arez.areNamesEnabled() ? $$arezi$$_name() + ".doStuff" : null, true, false, false, () -> super.doStuff(time,someOtherParameter), time, someOtherParameter );
