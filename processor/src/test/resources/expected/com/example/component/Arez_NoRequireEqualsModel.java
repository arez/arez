...
public final class Arez_NoRequireEqualsModel extends NoRequireEqualsModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_NoRequireEqualsModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "NoRequireEqualsModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_preDispose() ) : null;
