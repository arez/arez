...
public final class Arez_NoRequireEqualsModel extends NoRequireEqualsModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_NoRequireEqualsModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "NoRequireEqualsModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
