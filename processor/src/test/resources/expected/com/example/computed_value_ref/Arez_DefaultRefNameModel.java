...
public final class Arez_DefaultRefNameModel extends DefaultRefNameModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_DefaultRefNameModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "DefaultRefNameModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
