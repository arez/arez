...
public final class Arez_RawComputedValueModel extends RawComputedValueModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_RawComputedValueModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RawComputedValueModel", $$arezi$$_id(), $$arezi$$_name(), null, null ) : null;
