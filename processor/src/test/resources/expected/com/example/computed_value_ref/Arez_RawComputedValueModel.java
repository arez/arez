...
public final class Arez_RawComputedValueModel extends RawComputedValueModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_RawComputedValueModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "RawComputedValueModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
