...
public final class Arez_RawComputedValueModel extends RawComputedValueModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_RawComputedValueModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "RawComputedValueModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "RawComputedValueModel." + $$arez$$_id();
  }
