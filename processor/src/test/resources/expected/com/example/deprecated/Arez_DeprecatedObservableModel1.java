...
public final class Arez_DeprecatedObservableModel1 extends DeprecatedObservableModel1 implements Disposable, Identifiable<Long> {
  ...
  public Arez_DeprecatedObservableModel1() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedObservableModel1", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "DeprecatedObservableModel1." + $$arez$$_id();
  }
