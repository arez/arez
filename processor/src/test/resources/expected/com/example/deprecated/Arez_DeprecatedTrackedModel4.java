...
public final class Arez_DeprecatedTrackedModel4 extends DeprecatedTrackedModel4 implements Disposable, Identifiable<Long> {
  ...
  public Arez_DeprecatedTrackedModel4() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedTrackedModel4", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "DeprecatedTrackedModel4." + $$arez$$_id();
  }
