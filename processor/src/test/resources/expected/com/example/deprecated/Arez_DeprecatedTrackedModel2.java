...
public final class Arez_DeprecatedTrackedModel2 extends DeprecatedTrackedModel2 implements Disposable, Identifiable<Long> {
  ...
  public Arez_DeprecatedTrackedModel2() {
    ...
    this.$$arez$$_state = 1;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedTrackedModel2", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    ...
    return "DeprecatedTrackedModel2." + $$arez$$_id();
  }
