...
public final class Arez_DeprecatedTrackedModel1 extends DeprecatedTrackedModel1 implements Disposable {
  ...
  public Arez_DeprecatedTrackedModel1() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedTrackedModel1", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "DeprecatedTrackedModel1." + $$arez$$_id();
  }
