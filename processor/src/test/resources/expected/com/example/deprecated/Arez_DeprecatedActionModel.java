...
public final class Arez_DeprecatedActionModel extends DeprecatedActionModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_DeprecatedActionModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedActionModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "DeprecatedActionModel." + $$arez$$_id();
  }
  ...
  public void doStuff(final long time, final float someOtherParameter) {
    ...
    try {
      $$arez$$_context().safeAction(Arez.areNamesEnabled() ? $$arez$$_name() + ".doStuff" : null, true, () -> super.doStuff(time,someOtherParameter), time, someOtherParameter );
