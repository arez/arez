...
public final class Arez_DeprecatedAutorunModel extends DeprecatedAutorunModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_DeprecatedAutorunModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedAutorunModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "DeprecatedAutorunModel." + $$arez$$_id();
  }
