...
public final class Arez_DeprecatedTrackedModel3 extends DeprecatedTrackedModel3 implements Disposable, Identifiable<Long> {
  ...
  public Arez_DeprecatedTrackedModel3() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedTrackedModel3", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "DeprecatedTrackedModel3." + $$arez$$_id();
  }
