...
public final class Arez_DeprecatedComputedModel3 extends DeprecatedComputedModel3 implements Disposable, Identifiable<Long> {
  ...
  public Arez_DeprecatedComputedModel3() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedComputedModel3", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
    ...
    this.$$arez$$_time = $$arez$$_context().createComputedValue( Arez.areNativeComponentsEnabled() ? this.$$arez$$_component : null, Arez.areNamesEnabled() ? $$arez$$_name() + ".time" : null, super::getTime, Objects::equals, this::onTimeActivate, this::onTimeDeactivate, this::onTimeStale, this::onTimeDispose );
  ...
  String $$arez$$_name() {
    return "DeprecatedComputedModel3." + $$arez$$_id();
  }
