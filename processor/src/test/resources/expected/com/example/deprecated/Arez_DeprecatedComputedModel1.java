...
public final class Arez_DeprecatedComputedModel1 extends DeprecatedComputedModel1 implements Disposable, Identifiable<Long> {
  ...
  public Arez_DeprecatedComputedModel1() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedComputedModel1", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "DeprecatedComputedModel1." + $$arez$$_id();
  }
