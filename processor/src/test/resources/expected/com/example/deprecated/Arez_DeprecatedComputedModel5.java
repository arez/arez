...
public final class Arez_DeprecatedComputedModel5 extends DeprecatedComputedModel5 implements Disposable, Identifiable<Long> {
  ...
  public Arez_DeprecatedComputedModel5() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "DeprecatedComputedModel5", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
  ...
  String $$arez$$_name() {
    return "DeprecatedComputedModel5." + $$arez$$_id();
  }
