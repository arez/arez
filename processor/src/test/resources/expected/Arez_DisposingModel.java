...
public final class Arez_DisposingModel extends DisposingModel implements Disposable, Identifiable<Long>, ComponentObservable {
  ...
  public Arez_DisposingModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "DisposingModel", $$arezi$$_id(), $$arezi$$_name(), () -> super.preDispose(), () -> super.postDispose() ) : null;
    ...
    this.$$arez$$_someValue = $$arezi$$_context().createComputedValue( Arez.areNativeComponentsEnabled() ? this.$$arezi$$_component : null, Arez.areNamesEnabled() ? $$arezi$$_name() + ".someValue" : null, () -> super.someValue(), EqualityComparator.defaultComparator(), null, null, null, null, false, false, false );
