...
public final class Arez_SingletonModel extends SingletonModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_SingletonModel() {
    ...
    final Component $$arezv$$_component = Arez.areNativeComponentsEnabled() ? $$arezv$$_context.component( "SingletonModel", $$arezv$$_id, $$arezv$$_name, () -> $$arezi$$_nativeComponentPreDispose() ) : null;
