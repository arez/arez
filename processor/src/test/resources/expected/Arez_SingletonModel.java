...
public final class Arez_SingletonModel extends SingletonModel implements Disposable {
  ...
  public Arez_SingletonModel() {
    ...
    this.$$arez$$_someValue = this.$$arez$$_context.createComputedValue( this.$$arez$$_context.areNamesEnabled() ? "SingletonModel.someValue" : null, super::someValue, Objects::equals, null, null, null );
  }
  ...
  public void doStuff(final long time) {
    ...
    try {
      ...
      if ( this.$$arez$$_context.areSpiesEnabled() && this.$$arez$$_context.getSpy().willPropagateSpyEvents() ) {
        ...
        this.$$arez$$_context.getSpy().reportSpyEvent( new ActionCompletedEvent( "SingletonModel.doStuff", new Object[]{time}, false, null, $$arez$$_throwable, $$arez$$_duration ) );
      }
