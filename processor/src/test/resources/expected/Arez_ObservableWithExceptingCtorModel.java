...
public final class Arez_ObservableWithExceptingCtorModel extends ObservableWithExceptingCtorModel implements Disposable, Identifiable<Long> {
  ...
  public Arez_ObservableWithExceptingCtorModel() throws Exception {
    ...
    this.$$arez$$_state = 1;
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? $$arez$$_context().createComponent( "ObservableWithExceptingCtorModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
