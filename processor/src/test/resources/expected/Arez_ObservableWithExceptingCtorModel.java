...
public final class Arez_ObservableWithExceptingCtorModel extends ObservableWithExceptingCtorModel implements Disposable, Identifiable<Integer>, DisposeTrackable {
  ...
  public Arez_ObservableWithExceptingCtorModel() throws Exception {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().component( "ObservableWithExceptingCtorModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null, () -> $$arezi$$_preDispose() ) : null;
