...
public final class Arez_EmptyModel extends EmptyModel implements Disposable, Identifiable<Integer>, ComponentObservable {
  ...
  public Arez_EmptyModel() {
    ...
    this.$$arezi$$_component = Arez.areNativeComponentsEnabled() ? $$arezi$$_context().createComponent( "EmptyModel", $$arezi$$_id(), Arez.areNamesEnabled() ? $$arezi$$_name() : null ) : null;
