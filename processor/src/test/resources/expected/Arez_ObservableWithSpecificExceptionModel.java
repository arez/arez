...
public final class Arez_ObservableWithSpecificExceptionModel extends ObservableWithSpecificExceptionModel implements Disposable {
  ...
  public Arez_ObservableWithSpecificExceptionModel() {
    ...
    this.$$arez$$_component = Arez.areNativeComponentsEnabled() ? this.$$arez$$_context.createComponent( "ObservableWithSpecificExceptionModel", $$arez$$_id(), $$arez$$_name(), null, null ) : null;
