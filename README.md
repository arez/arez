...
[![Build Status](https://secure.travis-ci.org/arez/arez-testng.svg?branch=master)](http://travis-ci.org/arez/arez-testng)
...
This library provides utilities to make writing TestNG tests for Arez-based applications.
