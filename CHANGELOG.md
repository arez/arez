...
* Remove support for annotating fields of Arez components with `@Inject`. The annotation processor has been updated to generate an error when field injections are present. The recommended approach is to use constructor injection instead. 
