 ...
 * constant and unique (enough) to identify component. It is used when generating
 * debug names for observables nested within the component. If this annotation is
