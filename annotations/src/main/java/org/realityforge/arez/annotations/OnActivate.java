...
/**
 * Identifies method that is called when ComputedValue changes from the INACTIVE state to any other state.
 *
 * <p>The method must also conform to the following constraints:</p>
 * <ul>
 * <li>Must not be annotated with {@link Autorun}, {@link ContainerId}, {@link Observable}, {@link Computed}, {@link Action}, {@link javax.annotation.PostConstruct}, {@link PreDispose}, {@link PostDispose}, {@link OnDeactivate} or {@link OnStale}</li>
