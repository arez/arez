 ...
 * should be derived from other Observables within the Arez system and the value
 * returned by the method should not change unless the state of the other Observables
 * changes. The method should NOT modify other state in the system.</p>
 *
