...
define 'arez' do
  ...
  define 'downstream-test' do
    ...
    compile.enhance do
      projects_to_upload = projects(%w(core processor arez:extras:dom arez:extras:promise arez:extras:spytools arez:extras:testng))
  ...
  ipr.add_testng_configuration('persist_processor',
                               ...
                               :jvm_args => "-ea #{FORMATTER_JDK_EXPORTS.join(' ')} -Darez.persist.output_fixture_data=true -Darez.persist.fixture_dir=src/test/fixtures")
