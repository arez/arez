  ...
  extends AbstractArezExtrasTest
{
    ...
    throws Throwable
  {
    ...
    assertEquals( exception.getMessage(),
                  "Attempting to call AbstractSpyEventProcessor.on() to register a processor for type class org.realityforge.arez.spy.ObserverCreatedEvent but an existing processor already exists for type" );
  }
}
