...
abstract class BasicPersistIdModel_PersistSidecar {
  ...
  BasicPersistIdModel_PersistSidecar(@Nonnull final Scope scope,
      @Nonnull final BasicPersistIdModel peer, @Nonnull final Store appStore) {
  ...
  private static final class Keys {
    @Nonnull
    private static final String TYPE = Arez.areNamesEnabled() ? "BasicPersistIdModel" : BasicPersistIdModel.class.getName();
