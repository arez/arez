...
abstract class BasicPersistModel_PersistSidecar {
  ...
  @Nonnull
  static BasicPersistModel_PersistSidecar attach(@Nonnull final Scope scope,
  ...
  static void scheduleAttach(@Nonnull final Scope scope, @Nonnull final BasicPersistModel peer) {
    assert Disposable.isNotDisposed( scope );
    assert Disposable.isNotDisposed( peer );
    Arez.context().task( Arez.areNamesEnabled() ? "BasicPersistModel_PersistSidecar.attach." + ( ++c_nextTaskId ) : null, () -> maybeAttach( scope, peer ) );
  }
