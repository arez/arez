...
abstract class CustomNamePersistTypeModel_PersistSidecar {
  ...
  @Nonnull
  static CustomNamePersistTypeModel_PersistSidecar attach(@Nonnull final Scope scope,
  ...
  static void scheduleAttach(@Nonnull final Scope scope,
    ...
    assert Disposable.isNotDisposed( scope );
    assert Disposable.isNotDisposed( peer );
    Arez.context().task( Arez.areNamesEnabled() ? "cn_PersistSidecar.attach." + ( ++c_nextTaskId ) : null, () -> maybeAttach( scope, peer ) );
  }
