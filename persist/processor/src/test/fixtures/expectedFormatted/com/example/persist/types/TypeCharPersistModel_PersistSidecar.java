...
abstract class TypeCharPersistModel_PersistSidecar {
  ...
  TypeCharPersistModel_PersistSidecar(
  ...
  @Nonnull
  static TypeCharPersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final TypeCharPersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "TypeCharPersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE =
        Arez.areNamesEnabled() ? "TypeCharPersistModel" : TypeCharPersistModel.class.getName();
