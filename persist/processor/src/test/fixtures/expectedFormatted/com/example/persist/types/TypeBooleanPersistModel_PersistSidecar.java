...
abstract class TypeBooleanPersistModel_PersistSidecar {
  ...
  TypeBooleanPersistModel_PersistSidecar(
  ...
  @Nonnull
  static TypeBooleanPersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final TypeBooleanPersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "TypeBooleanPersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE = Arez.areNamesEnabled()
        ? "TypeBooleanPersistModel"
        : TypeBooleanPersistModel.class.getName();
