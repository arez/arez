...
abstract class ObjectTypePersistModel_PersistSidecar {
  ...
  ObjectTypePersistModel_PersistSidecar(
  ...
  @Nonnull
  static ObjectTypePersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final ObjectTypePersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "ObjectTypePersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE =
        Arez.areNamesEnabled() ? "ObjectTypePersistModel" : ObjectTypePersistModel.class.getName();
  ...
  private static final class Converters {
    @Nonnull
    private static final Converter CONVERTER_java__lang__Object =
        ArezPersist.getConverter(Object.class);
