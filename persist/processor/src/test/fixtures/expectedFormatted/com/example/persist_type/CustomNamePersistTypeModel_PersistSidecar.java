...
abstract class CustomNamePersistTypeModel_PersistSidecar {
  ...
  CustomNamePersistTypeModel_PersistSidecar(
      @Nonnull final Scope scope,
      @Nonnull final CustomNamePersistTypeModel peer,
  ...
  @Nonnull
  static CustomNamePersistTypeModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final CustomNamePersistTypeModel peer) {
    assert Disposable.isNotDisposed(scope);
    assert Disposable.isNotDisposed(peer);
    final Store appStore = ArezPersist.getStore("app");
    return new Arez_CustomNamePersistTypeModel_PersistSidecar(scope, peer, appStore);
  }
  ...
  static void scheduleAttach(
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled() ? "cn_PersistSidecar.attach." + (++c_nextTaskId) : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE =
        Arez.areNamesEnabled() ? "cn" : CustomNamePersistTypeModel.class.getName();
