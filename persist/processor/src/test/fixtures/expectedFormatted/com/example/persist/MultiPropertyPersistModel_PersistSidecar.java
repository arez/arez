...
abstract class MultiPropertyPersistModel_PersistSidecar {
  ...
  MultiPropertyPersistModel_PersistSidecar(
  ...
  @Nonnull
  static MultiPropertyPersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final MultiPropertyPersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "MultiPropertyPersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    @Nonnull
    private static final String TYPE = Arez.areNamesEnabled()
        ? "MultiPropertyPersistModel"
        : MultiPropertyPersistModel.class.getName();
