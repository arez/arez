...
abstract class BasicPersistModel_PersistSidecar {
  ...
  BasicPersistModel_PersistSidecar(
      @Nonnull final Scope scope,
      @Nonnull final BasicPersistModel peer,
  ...
  @Nonnull
  static BasicPersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final BasicPersistModel peer) {
    assert Disposable.isNotDisposed(scope);
    assert Disposable.isNotDisposed(peer);
    final Store appStore = ArezPersist.getStore("app");
    return new Arez_BasicPersistModel_PersistSidecar(scope, peer, appStore);
  }
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "BasicPersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE =
        Arez.areNamesEnabled() ? "BasicPersistModel" : BasicPersistModel.class.getName();
