...
abstract class CustomSetterPersistModel_PersistSidecar {
  ...
  CustomSetterPersistModel_PersistSidecar(
  ...
  @Nonnull
  static CustomSetterPersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final CustomSetterPersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "CustomSetterPersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE = Arez.areNamesEnabled()
        ? "CustomSetterPersistModel"
        : CustomSetterPersistModel.class.getName();
