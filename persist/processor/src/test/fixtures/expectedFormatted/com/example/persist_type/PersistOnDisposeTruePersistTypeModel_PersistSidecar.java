...
abstract class PersistOnDisposeTruePersistTypeModel_PersistSidecar {
  ...
  PersistOnDisposeTruePersistTypeModel_PersistSidecar(
  ...
  @Nonnull
  static PersistOnDisposeTruePersistTypeModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final PersistOnDisposeTruePersistTypeModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "PersistOnDisposeTruePersistTypeModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE = Arez.areNamesEnabled()
        ? "PersistOnDisposeTruePersistTypeModel"
        : PersistOnDisposeTruePersistTypeModel.class.getName();
