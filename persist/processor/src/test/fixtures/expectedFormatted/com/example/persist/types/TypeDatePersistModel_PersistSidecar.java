...
abstract class TypeDatePersistModel_PersistSidecar {
  ...
  @ComponentDependency
  @Nonnull
  final TypeDatePersistModel _peer;

  @Nonnull
  private final Store _appStore;

  TypeDatePersistModel_PersistSidecar(
  ...
  @Nonnull
  static TypeDatePersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final TypeDatePersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "TypeDatePersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE =
        Arez.areNamesEnabled() ? "TypeDatePersistModel" : TypeDatePersistModel.class.getName();
  ...
  private static final class Converters {
    @Nonnull
    private static final Converter CONVERTER_java__util__Date =
        ArezPersist.getConverter(Date.class);
    ...
    private static TypeConverter createTypeConverter() {
      ...
      converters.put("value", CONVERTER_java__util__Date);
