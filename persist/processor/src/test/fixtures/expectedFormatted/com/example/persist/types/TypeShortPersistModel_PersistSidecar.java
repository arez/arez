...
abstract class TypeShortPersistModel_PersistSidecar {
  ...
  TypeShortPersistModel_PersistSidecar(
  ...
  @Nonnull
  static TypeShortPersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final TypeShortPersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "TypeShortPersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE =
        Arez.areNamesEnabled() ? "TypeShortPersistModel" : TypeShortPersistModel.class.getName();
