...
abstract class BasicPersistIdModel_PersistSidecar {
  ...
  @ComponentDependency
  @Nonnull
  final BasicPersistIdModel _peer;

  @Nonnull
  private final Store _appStore;

  BasicPersistIdModel_PersistSidecar(
  ...
  @Nonnull
  static BasicPersistIdModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final BasicPersistIdModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "BasicPersistIdModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private String getComponentId() {
    return String.valueOf(Objects.<Object>requireNonNull(_peer.getId()));
  }
  ...
  private static final class Keys {
    ...
    private static final String TYPE =
        Arez.areNamesEnabled() ? "BasicPersistIdModel" : BasicPersistIdModel.class.getName();
