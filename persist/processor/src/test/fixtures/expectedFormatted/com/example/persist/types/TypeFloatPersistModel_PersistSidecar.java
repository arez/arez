...
abstract class TypeFloatPersistModel_PersistSidecar {
  ...
  TypeFloatPersistModel_PersistSidecar(
  ...
  @Nonnull
  static TypeFloatPersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final TypeFloatPersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "TypeFloatPersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE =
        Arez.areNamesEnabled() ? "TypeFloatPersistModel" : TypeFloatPersistModel.class.getName();
