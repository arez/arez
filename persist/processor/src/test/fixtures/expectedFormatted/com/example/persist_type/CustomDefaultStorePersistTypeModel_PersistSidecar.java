...
abstract class CustomDefaultStorePersistTypeModel_PersistSidecar {
  ...
  @Nonnull
  static CustomDefaultStorePersistTypeModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final CustomDefaultStorePersistTypeModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "CustomDefaultStorePersistTypeModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  void restoreState() {
    ...
    if (!_dsStore.isDisposed() && Disposable.isNotDisposed(_scope)) {
      final Map<String, Object> state =
          _dsStore.get(_scope, Keys.TYPE, $ap$_id, Converters.TYPE_CONVERTER);
      if (null != state) {
  ...
  private static final class Keys {
    ...
    private static final String TYPE = Arez.areNamesEnabled()
        ? "CustomDefaultStorePersistTypeModel"
        : CustomDefaultStorePersistTypeModel.class.getName();
