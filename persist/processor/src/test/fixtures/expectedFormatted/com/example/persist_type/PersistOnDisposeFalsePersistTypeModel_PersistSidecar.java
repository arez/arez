...
abstract class PersistOnDisposeFalsePersistTypeModel_PersistSidecar {
  ...
  @ComponentDependency
  @Nonnull
  final PersistOnDisposeFalsePersistTypeModel _peer;

  @Nonnull
  private final Store _appStore;

  PersistOnDisposeFalsePersistTypeModel_PersistSidecar(
  ...
  @Nonnull
  static PersistOnDisposeFalsePersistTypeModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final PersistOnDisposeFalsePersistTypeModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "PersistOnDisposeFalsePersistTypeModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE = Arez.areNamesEnabled()
        ? "PersistOnDisposeFalsePersistTypeModel"
        : PersistOnDisposeFalsePersistTypeModel.class.getName();
