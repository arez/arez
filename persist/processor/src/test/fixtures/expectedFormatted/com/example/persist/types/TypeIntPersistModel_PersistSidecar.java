...
abstract class TypeIntPersistModel_PersistSidecar {
  ...
  TypeIntPersistModel_PersistSidecar(
  ...
  @Nonnull
  static TypeIntPersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final TypeIntPersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "TypeIntPersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE =
        Arez.areNamesEnabled() ? "TypeIntPersistModel" : TypeIntPersistModel.class.getName();
