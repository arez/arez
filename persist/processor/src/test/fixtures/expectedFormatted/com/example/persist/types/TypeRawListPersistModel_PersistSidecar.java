...
abstract class TypeRawListPersistModel_PersistSidecar {
  ...
  TypeRawListPersistModel_PersistSidecar(
  ...
  @Nonnull
  static TypeRawListPersistModel_PersistSidecar attach(
      @Nonnull final Scope scope, @Nonnull final TypeRawListPersistModel peer) {
    ...
    Arez.context()
        .task(
            Arez.areNamesEnabled()
                ? "TypeRawListPersistModel_PersistSidecar.attach." + (++c_nextTaskId)
                : null,
  ...
  private static final class Keys {
    ...
    private static final String TYPE = Arez.areNamesEnabled()
        ? "TypeRawListPersistModel"
        : TypeRawListPersistModel.class.getName();
  ...
  private static final class Converters {
    @Nonnull
    private static final Converter CONVERTER_java__util__List =
        ArezPersist.getConverter(List.class);
