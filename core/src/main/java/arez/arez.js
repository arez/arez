...
jre.addSystemPropertyFromGoogDefine('arez.environment', arez.environment);

/** @define {string} */
arez.enable_names = goog.define('arez.enable_names', 'false');
jre.addSystemPropertyFromGoogDefine('arez.enable_names', arez.enable_names);

/** @define {string} */
arez.enable_references = goog.define('arez.enable_references', 'true');
jre.addSystemPropertyFromGoogDefine('arez.enable_references', arez.enable_references);

/** @define {string} */
arez.enable_property_introspection = goog.define('arez.enable_property_introspection', 'false');
jre.addSystemPropertyFromGoogDefine('arez.enable_property_introspection', arez.enable_property_introspection);

/** @define {string} */
arez.enable_verify = goog.define('arez.enable_verify', 'false');
jre.addSystemPropertyFromGoogDefine('arez.enable_verify', arez.enable_verify);

/** @define {string} */
arez.enforce_transaction_type = goog.define('arez.enforce_transaction_type', 'false');
jre.addSystemPropertyFromGoogDefine('arez.enforce_transaction_type', arez.enforce_transaction_type);
...
jre.addSystemPropertyFromGoogDefine('arez.enable_zones', arez.enable_zones);

/** @define {string} */
arez.enable_spies = goog.define('arez.enable_spies', 'false');
jre.addSystemPropertyFromGoogDefine('arez.enable_spies', arez.enable_spies);

/** @define {string} */
arez.enable_native_components = goog.define('arez.enable_native_components', 'false');
jre.addSystemPropertyFromGoogDefine('arez.enable_native_components', arez.enable_native_components);

/** @define {string} */
arez.enable_registries = goog.define('arez.enable_registries', 'false');
jre.addSystemPropertyFromGoogDefine('arez.enable_registries', arez.enable_registries);
...
jre.addSystemPropertyFromGoogDefine('arez.enable_task_interceptor', arez.enable_task_interceptor);

/** @define {string} */
arez.check_invariants = goog.define('arez.check_invariants', 'false');
jre.addSystemPropertyFromGoogDefine('arez.check_invariants', arez.check_invariants);
...
jre.addSystemPropertyFromGoogDefine('arez.check_api_invariants', arez.check_api_invariants);

/** @define {string} */
arez.logger = goog.define('arez.logger', 'none');
jre.addSystemPropertyFromGoogDefine('arez.logger', arez.logger);
