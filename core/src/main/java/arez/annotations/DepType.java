...
public enum DepType
{
   ...
   * This means that the <code>computable</code> or <code>observed</code> method must invoke
   ...
   * Using this dependency type also allows for the scenario where the <code>computable</code> or
   * <code>observed</code> does not invoke {@link arez.ObservableValue#reportObserved()} within the scope
   * of the method. The <code>computable</code> or <code>observed</code> will not be re-scheduled by the
