...
public class ComputableValueActivatedEventTest
  extends AbstractArezTest
{
  ...
  public void basicOperation()
  {
    ...
    final ComputableValueActivatedEvent event = new ComputableValueActivatedEvent( info );
    ...
    assertEquals( data.get( "type" ), "ComputableValueActivated" );
