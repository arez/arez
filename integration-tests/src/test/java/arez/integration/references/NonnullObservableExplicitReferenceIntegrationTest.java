...
public final class NonnullObservableExplicitReferenceIntegrationTest
  extends AbstractArezIntegrationTest
{
  ...
  public void scenario()
  {
    ...
    assertInvariant( () -> safeAction( model1::getModel2 ),
                     "Nonnull reference method named 'getModel2' invoked on component named 'arez_integration_references_NonnullObservableExplicitReferenceIntegrationTest_Model1.1' but reference has not been resolved yet is not lazy. Id = 1" );

    assertEquals( findCallCount.get(), 0 );

    safeAction( () -> Linkable.link( model1 ) );
    ...
    assertInvariant( model1::getModel2,
                     "Method named 'getModel2' invoked on disposed component named 'arez_integration_references_NonnullObservableExplicitReferenceIntegrationTest_Model1.1'" );
  }
  ...
  static abstract class Model1
  {
    ...
    {
      return new NonnullObservableExplicitReferenceIntegrationTest_Arez_Model1( model2Id );
    }
    ...
    extends AbstractRepository<Integer, Model2, Model2Repository>
  {
    ...
    {
      return new NonnullObservableExplicitReferenceIntegrationTest_Arez_Model2Repository();
    }

    @Action
    Model2 create()
    {
      final NonnullObservableExplicitReferenceIntegrationTest_Arez_Model2 entity =
        new NonnullObservableExplicitReferenceIntegrationTest_Arez_Model2();
      attach( entity );
      return entity;
    }
