  ...
  extends AbstractArezIntegrationTest
{
  ...
  public void scenario()
  {
    ...
    assertInvariant( model1::getModel2,
                     "Method named 'getModel2' invoked on disposed component named 'arez_integration_references_NullableObservableEagerReferenceIntegrationTest_Model1.1'" );
  }
    ...
    extends AbstractRepository<Integer, Model2, Model2Repository>
  {
    ...
    {
      return new NullableObservableEagerReferenceIntegrationTest_Arez_Model2Repository();
    }

    @Action
    Model2 create()
    {
      final NullableObservableEagerReferenceIntegrationTest_Arez_Model2 entity =
        new NullableObservableEagerReferenceIntegrationTest_Arez_Model2();
      attach( entity );
      return entity;
    }
