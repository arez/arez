  ...
  extends AbstractArezIntegrationTest
{
    ...
    throws Throwable
  {
    ...
    final ComputableValue<Integer> computableValue2 =
      context.computable( f2, ComputableValue.Flags.OBSERVE_LOWER_PRIORITY_DEPENDENCIES );

    // f3 observes same priority
    final SafeFunction<Integer> f3 = () -> computableValue2.get() + 42;
    final ComputableValue<Integer> computableValue3 =
      context.computable( f3, ComputableValue.Flags.OBSERVE_LOWER_PRIORITY_DEPENDENCIES );
    ...
    context.observer( "AR1", computableValue1::get, Observer.Flags.PRIORITY_LOWEST );
    // Observes lower priority
    context.observer( "AR4",
                      computableValue4::get,
                      Observer.Flags.PRIORITY_HIGH | Observer.Flags.OBSERVE_LOWER_PRIORITY_DEPENDENCIES );
    // Observes higher priority
    context.observer( "AR3", computableValue3::get, Observer.Flags.PRIORITY_LOW );
