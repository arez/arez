...
public final class CtorInjectSchedulesPostConstructTest
  extends AbstractArezIntegrationTest
{
  ...
  @Singleton
  @Component( modules = CtorInjectSchedulesPostConstructTest_MyComponentDaggerModule.class )
  interface TestDaggerComponent
  {
    ...
    {
      return DaggerCtorInjectSchedulesPostConstructTest_TestDaggerComponent.create();
    }
  }
