...
public class CtorOnlyInjectIntegrationTest
  extends AbstractArezIntegrationTest
{
  ...
  public static abstract class TestComponent
  {
    ...
    TestComponent( final MyDependency myDependency, @PerInstance final Map<String, String> props )
    {
  ...
  interface TestDaggerComponent
    extends CtorOnlyInjectIntegrationTest_TestComponentDaggerComponentExtension
  {
  }
