...
public final class ManyMultiplicityExplicitLoadInverseIntegrationTest
  extends AbstractArezIntegrationTest
{
  ...
  public void scenario()
  {
    ...
    safeAction( () -> Linkable.link( wheel1 ) );
  ...
  static abstract class Wheel
  {
    ...
    {
      return new ManyMultiplicityExplicitLoadInverseIntegrationTest_Arez_Wheel( carId );
    }

    @Reference( inverse = Feature.ENABLE, load = LinkType.EXPLICIT )
    abstract Car getCar();
